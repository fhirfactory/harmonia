...
/**
 * Service interface for managing FHIR Task (Pragma) lifecycle and operations within gateway services.
 * <p>
...
public interface TaskService {
    ...
    List<Task> search(String id, String status, String priority, String patient, String identifier, String text);
