...
import net.fhirfactory.harmonia.mllpgatewaycli.client.MllpResult;
import net.fhirfactory.harmonia.mllpgatewaycli.template.AdtMessageBuilder;
import net.fhirfactory.harmonia.mllpgatewaycli.template.AdtMessageParameters;
import net.fhirfactory.harmonia.mllpgatewaycli.template.AdtTemplateRegistry;
import net.fhirfactory.harmonia.mllpgatewaycli.template.AdtTemplateType;
...
@Command(
        ...
        version = "pylai-mllp-cli 1.0.0",
        description = "Sends HL7 v2.4 ADT messages over MLLP to the Harmonia Pylai MLLP Gateway instance with pre-defined templates and parameter overrides."
)
