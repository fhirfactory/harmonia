...
class MfnResourceTest {
    ...
    void setUp() {
        ...
        IncomingMfnMessageProcessor transformer = new IncomingMfnMessageProcessor(taskService, communicationService);
    ...
    void testIngestMfnSuccess() {
        ...
        assertThat(taskService.getById("MSG-MFN-REST-01")).isPresent();
    }
