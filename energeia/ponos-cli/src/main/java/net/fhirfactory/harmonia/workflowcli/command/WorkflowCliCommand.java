...
import net.fhirfactory.harmonia.workflowcli.client.WorkflowHttpClient;
import net.fhirfactory.harmonia.workflowcli.formatter.WorkflowOutputFormatter;
...
@Command(
        ...
        version = "ponos-cli 1.0.0",
        description = "Command-line tool for connecting to Ponos task-sequence-processor, triggering reload/synchronization, and validating queue names and task-sequence definitions.",
        subcommands = {
