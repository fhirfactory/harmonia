...
package net.fhirfactory.harmonia.workflowcli;

import net.fhirfactory.harmonia.workflowcli.command.WorkflowCliCommand;
...
/**
 * Main application entry point for the Harmonia Workflow CLI.
 */
public class WorkflowCliMain {
