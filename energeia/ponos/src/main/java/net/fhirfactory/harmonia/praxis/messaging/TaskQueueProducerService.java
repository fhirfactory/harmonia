...
public class TaskQueueProducerService {
    ...
    public void sendTask(Task task) throws Exception {
        ...
        if (ponosProducer != null) {
            ponosProducer.sendTask(task);
            return;
        }
    ...
    public void sendTaskJson(String jsonPayload) throws Exception {
        ...
        if (ponosProducer != null) {
            ponosProducer.sendTaskJson(jsonPayload);
            return;
        }
    ...
    public void sendTaskEvent(ErgonEvent event) throws Exception {
        ...
        if (ponosProducer != null) {
            ponosProducer.sendTaskEvent(event);
            return;
        }
    ...
    public void sendTaskEventJson(String jsonPayload) throws Exception {
        ...
        if (ponosProducer != null) {
            ponosProducer.sendTaskEventJson(jsonPayload);
            return;
        }
    ...
    private void sendTaskEvent(ErgonEvent event, String jsonPayload) throws Exception {
        ...
        if (ponosProducer != null) {
            ponosProducer.sendTaskEvent(event, jsonPayload);
            return;
        }
        String queueName;
