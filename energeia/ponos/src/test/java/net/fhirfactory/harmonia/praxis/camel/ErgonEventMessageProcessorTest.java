...
class ErgonEventMessageProcessorTest {
    ...
    void testProcessTaskEventWithExistingCachedTask() throws Exception {
        ...
        ErgonEvent event = new ErgonEvent("event-test-1", "PROCESS_COMPLETED", "completed", "mllp-gateway", "Event triggered completion");
    ...
    void testProcessTaskEventJsonString() throws Exception {
        ErgonEvent event = new ErgonEvent("event-test-2", "DISPATCH", "in-progress", "befe", "Task dispatched to worker");
    ...
    void testProcessEnhancedTaskEvent() throws Exception {
        ErgonEvent event = new ErgonEvent("event-test-3", "VALIDATE", "requested", "pas-gw",
