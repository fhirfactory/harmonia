...
class PatientIdentityUpdateErgonTest {

    private CamelContext camelContext;
    private ProducerTemplate producerTemplate;
    private PatientIdentityUpdateErgon activity;
    ...
    void setUp() {
        ...
        activity = new PatientIdentityUpdateErgon();
    ...
    void testActivityMetadataAndInheritance() {
        ...
        assertThat(activity.getActivityId()).isEqualTo(PatientIdentityUpdateErgon.DEFAULT_ACTIVITY_ID);
        assertThat(activity.getActivityName()).isEqualTo(PatientIdentityUpdateErgon.DEFAULT_ACTIVITY_NAME);
    ...
    void testProcessPatientIdentityInCamelRoute() throws Exception {
        ...
        assertThat(resultExchange.getMessage().getHeader(PatientIdentityUpdateErgon.HEADER_PATIENT_ID)).isEqualTo("MRN-ROUTE-123");
        assertThat(resultExchange.getMessage().getHeader(PatientIdentityUpdateErgon.HEADER_PATIENT_MRN)).isEqualTo("MRN-ROUTE-123");
        assertThat(resultExchange.getMessage().getHeader(PatientIdentityUpdateErgon.HEADER_PATIENT_NAME)).isEqualTo("MS JANE M TAYLOR");
        assertThat(resultExchange.getMessage().getHeader(PatientIdentityUpdateErgon.HEADER_PATIENT_UPDATED)).isEqualTo(true);

        ErgonEvent ergonEvent = resultExchange.getMessage().getBody(ErgonEvent.class);
        assertThat(ergonEvent).isNotNull();
        assertThat(ergonEvent.getAction()).isEqualTo("PROCESS");
        assertThat(ergonEvent.getStatus()).isEqualTo("requested");
        assertThat(ergonEvent.getDescription()).contains("MS JANE M TAYLOR");
        ...
        org.hl7.fhir.r5.model.Provenance prov = (org.hl7.fhir.r5.model.Provenance) resultExchange.getProperty(ErgonBase.PROPERTY_PROVENANCE);
