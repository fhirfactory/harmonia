...
class MessageQueueToExchangeConduitTest {
    ...
    void testPropertiesAndInheritance() {
        ...
        assertThat(conduit).isInstanceOf(ErgonBase.class);
    ...
    void testProcessTaskEventObject() throws Exception {
        ...
        ergonEvent.setTaskId("TASK-98765");
        ergonEvent.setGatewayInstanceId("pas-gw");
        ergonEvent.setTriggerType("ADT^A01");
        ergonEvent.setMessageType("ADT");
        ergonEvent.setControlId("MSG-12345");
        ergonEvent.setAction("PROCESS");
        ergonEvent.setStatus("REQUESTED");

        producerTemplate.sendBody("direct:conduit-taskevent-in", ergonEvent);
