...
/**
 * Lightweight event notification representing an action or status transition on a FHIR Task (Pragma).
 * <p>
...
public class ErgonEvent implements Serializable {
    ...
    public ErgonEvent(String taskId, String action, String status) {
        this();
        this.taskId = taskId;
        this.action = action;
        this.status = status;
    ...
    public ErgonEvent(String taskId, String action, String status, String source, String description) {
        this(taskId, action, status);
        this.source = source;
        this.description = description;
    }

    public ErgonEvent(String taskId, String action, String status, Topic topic, String controlId, String description) {
        this(taskId, action, status);
    ...
    public ErgonEvent(String taskId, String action, String status, String gatewayInstanceId,
    ...
    public boolean equals(Object o) {
        ...
        ErgonEvent ergonEvent = (ErgonEvent) o;
        return Objects.equals(taskId, ergonEvent.taskId) &&
                Objects.equals(action, ergonEvent.action) &&
                Objects.equals(status, ergonEvent.status) &&
                Objects.equals(getGatewayInstanceId(), ergonEvent.getGatewayInstanceId()) &&
                Objects.equals(getMessageType(), ergonEvent.getMessageType()) &&
                Objects.equals(getTriggerType(), ergonEvent.getTriggerType()) &&
                Objects.equals(controlId, ergonEvent.controlId);
    }
