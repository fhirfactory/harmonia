...
public class Topic implements Serializable {
    ...
    /**
     * Creates a Topic for an outbound/egress HL7 message.
     *
     * @param messageType  HL7 message code (e.g., "ADT", "MFN", "ORU")
     * @param triggerEvent HL7 trigger event code (e.g., "A01", "M02", "R01")
     * @param source       Sending gateway / emitter ID (e.g., "harmonia", "mllp-sender-default")
     * @param target       Target subsystem or channel identifier
     * @param destination  Receiving application / facility (e.g., "EXTERNAL_EMR", "HIS_NORTH")
     * @return populated Topic
     */
    public static Topic forEgress(String messageType, String triggerEvent, String source, String target, String destination) {
        return fromHl7(DEFAULT_HL7_VERSION, messageType, triggerEvent, source, target, null, destination);
    }
