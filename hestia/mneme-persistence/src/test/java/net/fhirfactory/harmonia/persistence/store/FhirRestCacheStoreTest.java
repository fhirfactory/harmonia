...
class FhirRestCacheStoreTest {
    ...
    void testCoordinateResolution() {
        ...
        assertThat(FhirRestCacheStore.mapCacheNameToResourceType("provenance-cache")).isEqualTo("Provenance");
        assertThat(FhirRestCacheStore.mapCacheNameToResourceType("auditevent-cache")).isEqualTo("AuditEvent");
        assertThat(FhirRestCacheStore.mapCacheNameToResourceType("consent-cache")).isEqualTo("Consent");
        assertThat(FhirRestCacheStore.mapCacheNameToResourceType("task-cache")).isEqualTo("Task");
        assertThat(FhirRestCacheStore.mapCacheNameToResourceType("communication-cache")).isEqualTo("Communication");
        assertThat(FhirRestCacheStore.mapCacheNameToResourceType("documentreference-cache")).isEqualTo("DocumentReference");
