...
/**
 * Orchestrates transforming inbound HL7 ADT messages into FHIR R5 resources (Communication, Patient,
 * RelatedPerson, Practitioner, Encounter, Bundle, Task, Provenance), caching them, and dispatching TaskEvents.
 */
@ApplicationScoped
public class IncomingAdtMessageProcessor {
    ...
    public IncomingAdtMessageProcessor() {
        ...
        this.patientBuilder = new AdtPatientResourceBuilder(this.extractor);
        this.relatedPersonBuilder = new AdtRelatedPersonResourceBuilder(this.extractor);
        this.practitionerBuilder = new AdtPractitionerResourceBuilder(this.extractor);
        this.encounterBuilder = new AdtEncounterResourceBuilder(this.extractor);
        ...
        this.provenanceBuilder = new AdtProvenanceResourceBuilder(this.extractor);
    }
    ...
    public IncomingAdtMessageProcessor(TaskService taskService, CommunicationService communicationService,
                                       ...
                                       AdtRelatedPersonResourceBuilder relatedPersonBuilder,
                                       AdtPractitionerResourceBuilder practitionerBuilder,
                                       AdtEncounterResourceBuilder encounterBuilder,
                                       AdtBundleResourceBuilder bundleBuilder,
                                       AdtCommunicationResourceBuilder communicationBuilder,
                                       AdtTaskResourceBuilder taskBuilder,
                                       AdtProvenanceResourceBuilder provenanceBuilder) {
        this.hapiContext = new DefaultHapiContext();
        this.hapiContext.getParserConfiguration().setIdGenerator(new NanoTimeGenerator());
        this.pipeParser = hapiContext.getPipeParser();
        ...
        this.patientBuilder = patientBuilder != null ? patientBuilder : new AdtPatientResourceBuilder(this.extractor);
        this.relatedPersonBuilder = relatedPersonBuilder != null ? relatedPersonBuilder : new AdtRelatedPersonResourceBuilder(this.extractor);
        this.practitionerBuilder = practitionerBuilder != null ? practitionerBuilder : new AdtPractitionerResourceBuilder(this.extractor);
        this.encounterBuilder = encounterBuilder != null ? encounterBuilder : new AdtEncounterResourceBuilder(this.extractor);
        this.bundleBuilder = bundleBuilder != null ? bundleBuilder : new AdtBundleResourceBuilder();
        ...
        this.provenanceBuilder = provenanceBuilder != null ? provenanceBuilder : new AdtProvenanceResourceBuilder(this.extractor);
    }
    ...
    public void setPatientBuilder(AdtPatientResourceBuilder patientBuilder) {
        this.patientBuilder = patientBuilder;
    }

    public AdtRelatedPersonResourceBuilder getRelatedPersonBuilder() {
        return relatedPersonBuilder;
    }

    public void setRelatedPersonBuilder(AdtRelatedPersonResourceBuilder relatedPersonBuilder) {
        this.relatedPersonBuilder = relatedPersonBuilder;
    }

    public AdtPractitionerResourceBuilder getPractitionerBuilder() {
        return practitionerBuilder;
    }

    public void setPractitionerBuilder(AdtPractitionerResourceBuilder practitionerBuilder) {
    ...
    public void setEncounterBuilder(AdtEncounterResourceBuilder encounterBuilder) {
        this.encounterBuilder = encounterBuilder;
    }

    public AdtBundleResourceBuilder getBundleBuilder() {
        return bundleBuilder;
    }

    public void setBundleBuilder(AdtBundleResourceBuilder bundleBuilder) {
    ...
    public AdtProvenanceResourceBuilder getProvenanceBuilder() {
        return provenanceBuilder;
    }

    public void setProvenanceBuilder(AdtProvenanceResourceBuilder provenanceBuilder) {
    ...
    public AdtProcessingResult processAdtMessage(String hl7MessageString) {
        ...
        try {
            ...
            Patient patient = patientBuilder.buildPatient(terser, hl7MessageString, patientId);
            List<RelatedPerson> relatedPersons = relatedPersonBuilder.buildRelatedPersons(terser, hl7MessageString, patientId);
            List<Practitioner> practitioners = practitionerBuilder.buildPractitioners(terser, hl7MessageString);
            Encounter encounter = encounterBuilder.buildEncounter(terser, hl7MessageString, messageControlId, triggerEvent, patientId, visitNumber, patientClass, practitioners);

            // 4. Bundle all transformed clinical resources
            Bundle bundle = bundleBuilder.buildBundle(messageControlId, patient, relatedPersons, practitioners, encounter);
            ...
            Task task = taskBuilder.buildTask(terser, topic, messageControlId, patientId, patientFullName,
                    ...
                    attendingDocId, attendingDocName, sendingApp, sendingFacility, messageTimestamp, bundle, savedCommunication);
            ...
            if (savedTask != null) {
                Provenance provenance = provenanceBuilder.buildProvenance(terser, topic, messageControlId,
                        patientId, patientFullName, sendingApp, sendingFacility, messageTimestamp,
                        assignedLocationPointOfCare, attendingDocId, attendingDocName,
            ...
            return AdtProcessingResult.success(messageControlId, triggerEvent, topic, patientId, patientFullName, savedCommunication, savedTask, savedProvenance, ackString);
    ...
    public Patient buildPatient(Terser terser, String rawMessage, String patientId) {
        return patientBuilder.buildPatient(terser, rawMessage, patientId);
    }

    public List<RelatedPerson> buildRelatedPersons(Terser terser, String rawMessage, String patientId) {
        return relatedPersonBuilder.buildRelatedPersons(terser, rawMessage, patientId);
    }

    public List<Practitioner> buildPractitioners(Terser terser, String rawMessage) {
        return practitionerBuilder.buildPractitioners(terser, rawMessage);
    }
    ...
    public Encounter buildEncounter(Terser terser, String rawMessage, String messageControlId,
        ...
        return encounterBuilder.buildEncounter(terser, rawMessage, messageControlId, triggerEvent, patientId, visitNumber, patientClass, practitioners);
    }
    ...
    public Bundle buildBundle(String messageControlId, Patient patient, List<RelatedPerson> relatedPersons,
        ...
        return bundleBuilder.buildBundle(messageControlId, patient, relatedPersons, practitioners, encounter);
    }
    ...
    public Task buildTask(Terser terser, String messageType, String triggerEvent, String messageControlId,
        ...
        return taskBuilder.buildTask(terser, messageType, triggerEvent, messageControlId, patientId, patientFullName,
                visitNumber, patientClass, assignedLocationPointOfCare, assignedLocationRoom, assignedLocationBed,
                attendingDocId, attendingDocName, sendingApp, sendingFacility, messageTimestamp, bundle);
    }
    ...
    public Provenance buildProvenance(Terser terser, Topic topic, String messageControlId,
                                      String patientId, String patientFullName,
                                      String sendingApp, String sendingFacility, String messageTimestamp,
                                      String assignedLocationPointOfCare, String attendingDocId, String attendingDocName,
                                      Task savedTask, Communication savedCommunication) {
        return provenanceBuilder.buildProvenance(terser, topic, messageControlId, patientId, patientFullName,
                sendingApp, sendingFacility, messageTimestamp, assignedLocationPointOfCare, attendingDocId, attendingDocName,
                savedTask, savedCommunication);
    }
    ...
    public Provenance buildProvenance(Terser terser, String messageControlId, String triggerEvent,
                                      ...
                                      String assignedLocationPointOfCare, String attendingDocId, String attendingDocName,
                                      Task savedTask, Communication savedCommunication) {
        return provenanceBuilder.buildProvenance(terser, messageControlId, triggerEvent, patientId, patientFullName,
                sendingApp, sendingFacility, messageTimestamp, assignedLocationPointOfCare, attendingDocId, attendingDocName,
                savedTask, savedCommunication);
    }
