...
import net.fhirfactory.hie.mllpgateway.hl7.MfnProcessingResult;
...
@ApplicationScoped
public class IncomingMfnMessageProcessorWrapper implements Processor {

    private static final Logger log = LoggerFactory.getLogger(IncomingMfnMessageProcessorWrapper.class);
    ...
    public static final String HEADER_PRACTITIONER_ID = "HiePractitionerId";
    ...
    public IncomingMfnMessageProcessorWrapper() {
    }

    @Inject
    public IncomingMfnMessageProcessorWrapper(IncomingMfnMessageProcessor transformer) {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        if (result.isSuccess()) {
            ...
            if (result.getTask() != null) {
                ...
                exchange.getMessage().setHeader(HEADER_PRACTITIONER_ID, result.getPractitionerId());
            }
