...
import net.fhirfactory.hie.mllpgateway.hl7.AdtProcessingResult;
...
public class AdtResource {
    ...
    private static final Logger log = LoggerFactory.getLogger(AdtResource.class);
    ...
    public AdtResource(IncomingAdtMessageProcessor transformer, IParser fhirParser) {
    ...
    @POST
    public Response ingestAdt(String hl7Payload) {
        ...
        AdtProcessingResult result = transformer.processAdtMessage(hl7Payload);
        ...
        responseMap.put("patientId", result.getPatientId());
        responseMap.put("patientName", result.getPatientName());
