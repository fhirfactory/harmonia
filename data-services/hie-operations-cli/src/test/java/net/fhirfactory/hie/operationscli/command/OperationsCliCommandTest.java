...
import net.fhirfactory.hie.operationscli.OperationsCliMain;
...
class OperationsCliCommandTest {
    ...
    void testHelpOption() {
        ...
        assertThat(out.toString()).contains("hie-operations-cli");
    ...
    void testListSequencesSubcommandJson() {
        ...
        assertThat(exitCode).isEqualTo(0);
        String output = out.toString();
        assertThat(output).contains("\"sequenceId\" : \"seq-orders\"");
    }
