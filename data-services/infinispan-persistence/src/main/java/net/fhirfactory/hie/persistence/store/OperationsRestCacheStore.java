...
import net.fhirfactory.hie.persistence.client.OperationsRestClient;
import net.fhirfactory.hie.persistence.config.OperationsStoreConfiguration;
...
public class OperationsRestCacheStore<K, V> implements NonBlockingStore<K, V> {
    ...
    public CompletionStage<Void> start(InitializationContext ctx) {
        ...
        String configuredServerUrl = configuration != null
                ...
                : "http://hie-operations-jpa-server-1:8080/api/operations";
