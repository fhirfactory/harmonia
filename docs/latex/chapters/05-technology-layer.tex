...
\begin{description}
    \item[\textbf{WildFly Jakarta EE 10 / Java 21}] Provides the enterprise container runtime for \texttt{iris-befe}, \texttt{ponos}, and \texttt{pylai-mllp-in}, delivering CDI dependency injection, JAX-RS REST endpoints, and managed thread pools.
