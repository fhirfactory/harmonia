...
\begin{enumerate}
    ...
    \item The console queries BEFE Port 8090 \newline (\texttt{GET /api/operations/sequences/seq-provider-registry-change-pipeline}) \newline to retrieve current runtime metrics and active route IDs.
    \item The operator clicks \textbf{Reload Sequence Pipeline}.
    \item The console dispatches to BEFE Port 8090 \newline (\texttt{POST /api/operations/sequences/seq-provider-registry-change-pipeline/reload}).
