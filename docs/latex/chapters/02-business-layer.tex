...
\subsection{Patient Admission \& Movement Service (\texttt{HL7-ADT})}
...
\subsection{Practitioner \& Staff Directory Service (\texttt{HL7-MFN})}
...
\subsection{FHIR R5 Clinical Data Discovery Service}
...
\subsection{Operations Telemetry \& Workflow Administration Service}
...
\subsection{Clinical Outbound Notification \& Egress Service (\texttt{HL7-MLLP-OUT})}
...
\subsection{FHIR R5 Provider Directory Management Service}
