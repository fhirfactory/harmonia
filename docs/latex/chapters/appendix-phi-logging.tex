...
Harmonia implements a decoupled, defence-in-depth logging architecture that enforces compile-time safety, runtime gate evaluation, and physical log destination isolation. Figure~\ref{fig:phi_logging_architecture} illustrates the end-to-end processing topology from component code down to physical Logback appenders.
