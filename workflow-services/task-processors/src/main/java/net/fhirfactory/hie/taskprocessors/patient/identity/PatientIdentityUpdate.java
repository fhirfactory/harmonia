...
package net.fhirfactory.hie.taskprocessors.patient.identity;
 ...
 */
@Dependent
public class PatientIdentityUpdate extends TaskProcessingActivity {

    private static final Logger log = LoggerFactory.getLogger(PatientIdentityUpdate.class);
    ...
    public PatientIdentityUpdate(CamelContext context) {
    ...
    public PatientIdentityUpdate(String activityId, String activityName) {
