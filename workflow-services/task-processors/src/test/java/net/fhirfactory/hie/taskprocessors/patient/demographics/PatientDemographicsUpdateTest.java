...
class PatientDemographicsUpdateTest {

    private CamelContext camelContext;
    private ProducerTemplate producerTemplate;
    private PatientDemographicsUpdate activity;
    ...
    void setUp() {
        ...
        activity = new PatientDemographicsUpdate();
    ...
    void testActivityMetadataAndInheritance() {
        ...
        assertThat(activity.getActivityId()).isEqualTo(PatientDemographicsUpdate.DEFAULT_ACTIVITY_ID);
        assertThat(activity.getActivityName()).isEqualTo(PatientDemographicsUpdate.DEFAULT_ACTIVITY_NAME);
    ...
    void testParseAndApplyHl7AdtDemographics() {
        ...
        assertThat(patient.getExtensionByUrl(PatientDemographicsUpdate.EXTENSION_RACE)).isNotNull();
        assertThat(patient.getExtensionByUrl(PatientDemographicsUpdate.EXTENSION_ETHNICITY)).isNotNull();
        assertThat(patient.getExtensionByUrl(PatientDemographicsUpdate.EXTENSION_RELIGION)).isNotNull();
    ...
    void testProcessPatientDemographicsRouteExecution() throws Exception {
        ...
        assertThat(exchange.getMessage().getHeader(PatientDemographicsUpdate.HEADER_PATIENT_ID)).isEqualTo("MRN-98765");
        assertThat(exchange.getMessage().getHeader(PatientDemographicsUpdate.HEADER_PATIENT_MRN)).isEqualTo("MRN-98765");
        assertThat(exchange.getMessage().getHeader(PatientDemographicsUpdate.HEADER_PATIENT_NAME)).isEqualTo("ROBERT D JOHNSON");
        assertThat(exchange.getMessage().getHeader(PatientDemographicsUpdate.HEADER_PATIENT_GENDER)).isEqualTo("male");
        assertThat(exchange.getMessage().getHeader(PatientDemographicsUpdate.HEADER_PATIENT_DOB)).isEqualTo("1970-08-20");
        assertThat(exchange.getMessage().getHeader(PatientDemographicsUpdate.HEADER_PATIENT_MARITAL_STATUS)).isEqualTo("Divorced");
        assertThat(exchange.getMessage().getHeader(PatientDemographicsUpdate.HEADER_PATIENT_UPDATED)).isEqualTo(true);
        assertThat(exchange.getMessage().getHeader(PatientDemographicsUpdate.HEADER_PATIENT_DEMOGRAPHICS_UPDATED)).isEqualTo(true);

        net.fhirfactory.hie.model.TaskEvent event = exchange.getMessage().getBody(net.fhirfactory.hie.model.TaskEvent.class);
    ...
    void testSequentialExecutionAfterPatientIdentityUpdate() throws Exception {
        ...
        assertThat(exchange.getMessage().getHeader(PatientIdentityUpdate.HEADER_PATIENT_ID)).isEqualTo("MRN-CHAIN-100");
        assertThat(exchange.getMessage().getHeader(PatientIdentityUpdate.HEADER_PATIENT_MRN)).isEqualTo("MRN-CHAIN-100");
        assertThat(exchange.getMessage().getHeader(PatientIdentityUpdate.HEADER_PATIENT_NAME)).isEqualTo("ALICE M TAYLOR MS");
        assertThat(exchange.getMessage().getHeader(PatientDemographicsUpdate.HEADER_PATIENT_GENDER)).isEqualTo("female");
        assertThat(exchange.getMessage().getHeader(PatientDemographicsUpdate.HEADER_PATIENT_DOB)).isEqualTo("1992-03-15");
        assertThat(exchange.getMessage().getHeader(PatientDemographicsUpdate.HEADER_PATIENT_MARITAL_STATUS)).isEqualTo("Never Married");
