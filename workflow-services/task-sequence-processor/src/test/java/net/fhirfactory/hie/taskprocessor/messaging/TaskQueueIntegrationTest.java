...
package net.fhirfactory.hie.taskprocessor.messaging;
...
import net.fhirfactory.hie.taskprocessor.camel.CamelContextManager;
import net.fhirfactory.hie.model.TaskEvent;
import net.fhirfactory.hie.model.topic.Topic;
import net.fhirfactory.hie.taskprocessor.camel.TaskEventMessageProcessor;
import net.fhirfactory.hie.taskprocessor.camel.TaskMessageProcessor;
import net.fhirfactory.hie.taskprocessor.camel.TaskProcessorRouteBuilder;
...
import net.fhirfactory.hie.taskprocessor.service.MessageQueueService;
...
class TaskQueueIntegrationTest {
    ...
    private static TaskSequenceService sequenceService;
    ...
    void testEndToEndTaskEventQueueToCacheProcessing() throws Exception {
        ...
        TaskEvent event = new TaskEvent("event-queue-task-700", "TRANSITION_COMPLETE", "completed", "gateway-service", "Event queue processed");
    ...
    void testEndToEndTaskEventQueueToTaskSequenceActivityExecution() throws Exception {
        ...
        TaskEvent event = new TaskEvent("seq-dispatch-task-888", "PROCESS", "completed",
