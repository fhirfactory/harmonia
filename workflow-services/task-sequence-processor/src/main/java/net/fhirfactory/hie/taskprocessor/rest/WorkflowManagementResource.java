...
import net.fhirfactory.hie.taskprocessor.service.ModuleStatusService;
...
public class WorkflowManagementResource {
    ...
    public Response reloadAll() {
        ...
        try {
            ...
            List<TaskSequence> loaded = taskSequenceLoader != null
            ...
            for (TaskSequence s : loaded) {
                if (s != null) {
                    seqIds.add(s.getSequenceId());
                }
            }
    ...
    public Response getStatus() {
        ...
        for (TaskSequence s : loaded) {
            if (s != null) {
                ...
                sm.put("sequenceId", s.getSequenceId());
                sm.put("sequenceName", s.getSequenceName());
