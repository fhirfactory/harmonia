...
public class MessageQueueDefinition implements Serializable {
    ...
    public MessageQueueDefinition() {
    }

    public MessageQueueDefinition(String queueName) {
    ...
    public MessageQueueDefinition(String queueName, String routingType, boolean durable, String description) {
        this.queueId = queueName;
        this.queueName = queueName;
        this.address = queueName;
    ...
    public MessageQueueDefinition(String queueId, String queueName, String address, String routingType, boolean durable, String description, String gatewayInstanceId) {
    ...
    public boolean equals(Object o) {
        ...
        MessageQueueDefinition that = (MessageQueueDefinition) o;
