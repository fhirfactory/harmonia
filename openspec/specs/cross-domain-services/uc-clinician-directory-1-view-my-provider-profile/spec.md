...
I can verify that my professional information is accurate

## Source Traceability

- **Source Use Case:** `UC-Clinician-Directory-1`
- **Source Scope:** Scope - Clinician Profile
- **User Story:** View my Provider Directory profile so that I can verify that my professional information is accurate.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View My Provider Profile
Harmonia SHALL support **View My Provider Profile** so that I can verify that my professional information is accurate.

#### Scenario: View My Provider Profile - successful outcome
...
- **WHEN** The actor needs to perform the 'View My Provider Profile' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Registered) initiates the 'View My Provider Profile' activity.
...
- **THEN** The 'View My Provider Profile' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
