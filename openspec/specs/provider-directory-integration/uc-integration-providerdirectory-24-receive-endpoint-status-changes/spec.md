# Receive Endpoint Status Changes
...
- **Source Use Case:** `UC-Integration-ProviderDirectory-24`
...
- **User Story:** Receive endpoint availability changes so that messages are routed correctly.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Endpoint Status Changes
Harmonia SHALL support **Receive Endpoint Status Changes** so that messages are routed correctly.

#### Scenario: Receive Endpoint Status Changes - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Endpoint Status Changes' activity, or an authorised business process initiates the activity.
- **THEN** Integration Service / Integration Platform initiates the 'Receive Endpoint Status Changes' activity.
...
- **THEN** The 'Receive Endpoint Status Changes' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
