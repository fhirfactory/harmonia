# Resolve Clinician Identifier

## Purpose

I can uniquely identify a provider across systems

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-29`
...
- **User Story:** Resolve a practitioner identifier so that I can uniquely identify a provider across systems.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Resolve Clinician Identifier
Harmonia SHALL support **Resolve Clinician Identifier** so that I can uniquely identify a provider across systems.

#### Scenario: Resolve Clinician Identifier - successful outcome
...
- **WHEN** The actor needs to perform the 'Resolve Clinician Identifier' activity, or an authorised business process initiates the activity.
- **THEN** Clinical / Healthcare Application initiates the 'Resolve Clinician Identifier' activity.
...
- **THEN** The 'Resolve Clinician Identifier' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
