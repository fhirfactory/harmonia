# Reconcile Identity Synchronisation Failures

## Purpose

connected systems remain aligned

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-30`
...
- **User Story:** Identify and reconcile failed identity synchronisations so that connected systems remain aligned.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Reconcile Identity Synchronisation Failures
Harmonia SHALL support **Reconcile Identity Synchronisation Failures** so that connected systems remain aligned.

#### Scenario: Reconcile Identity Synchronisation Failures - successful outcome
...
- **WHEN** The actor needs to perform the 'Reconcile Identity Synchronisation Failures' activity, or an authorised business process initiates the activity.
- **THEN** Integration Service / Integration Platform initiates the 'Reconcile Identity Synchronisation Failures' activity.
...
- **THEN** The 'Reconcile Identity Synchronisation Failures' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
