# Apply Industry-Standard API Practices

## Purpose

Enable the target-state Provider Directory to support the capability described by SR-41 so that it can be used by the broadest audience. The capability should operate as part of the governed Provider Directory service, with consistent identity, provenance, lifecycle, security, data-quality and audit controls applied irrespective of whether the activity is performed manually, through an API, or through system integration.

## Source Traceability

- **Source Use Case:** `SR-41`
- **Source Scope:** Additional Source Requirements – SR-26 to SR-58
- **Primary Actor:** Integration Administrator
- **Supporting Actors:** API Management Service; Security / Access Management Service; Provider Directory; Integration Service
- **User Story:** As an Integration Administrator, I want the Provider Directory to utilise industry standard practices, so that it can be used by the broadest audience.
...
### Requirement: Apply Industry-Standard API Practices
Harmonia SHALL support **Apply Industry-Standard API Practices** so that Enable the target-state Provider Directory to support the capability described by SR-41 so that it can be used by the broadest audience. The capability should operate as part of the governed Provider Directory service, with consistent identity, provenance, lifecycle, security, data-quality and audit controls applied irrespective of whether the activity is performed manually, through an API, or through system integration.

#### Scenario: Apply Industry-Standard API Practices - successful outcome
...
- **WHEN** The Integration Administrator initiates the activity, a relevant provider or reference-data change occurs, or an authorised scheduled/event-driven process triggers the requirement described by SR-41.
- **THEN** 1. The Integration Administrator initiates or receives the event associated with “Apply Industry-Standard API Practices”.
...
- **THEN** The requirement described by SR-41 is completed successfully so that it can be used by the broadest audience. The Provider Directory maintains an auditable and governed record of the activity and any exceptions are clearly identified for follow-up.
...
- **AND** supporting participation may be provided by API Management Service; Security / Access Management Service; Provider Directory; Integration Service
...
- **WHEN** The API conforms to industry-standard design practices.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 10
- **WHEN** REST APIs use standard resource-oriented URI and HTTP method conventions.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 11
- **WHEN** The API supports standard formats such as JSON or XML.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 12
- **WHEN** The API can use healthcare-relevant schemas such as HL7 or FHIR.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 13
- **WHEN** The API can use standard resource definitions such as Clinician, Organisation and Location.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 14
- **WHEN** The API can use national interoperability identifiers such as HPI-I, HPI-O and AHPRA numbers.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 15
- **WHEN** The API uses industry-standard authentication and authorisation methods such as OAuth and TLS.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 16
- **WHEN** The API is documented using an industry standard such as OpenAPI.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 17
- **WHEN** The API returns error codes and messages consistent with HTTP standards.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state
...
- **GIVEN** The API conforms to industry-standard design practices.
...
- **GIVEN** REST APIs use standard resource-oriented URI and HTTP method conventions.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint

#### Scenario: Business or data control 3
- **GIVEN** The API supports standard formats such as JSON or XML.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint

#### Scenario: Business or data control 4
- **GIVEN** The API can use healthcare-relevant schemas such as HL7 or FHIR.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint

#### Scenario: Business or data control 5
- **GIVEN** The API can use standard resource definitions such as Clinician, Organisation and Location.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint

#### Scenario: Business or data control 6
- **GIVEN** The API can use national interoperability identifiers such as HPI-I, HPI-O and AHPRA numbers.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint

#### Scenario: Business or data control 7
- **GIVEN** The API uses industry-standard authentication and authorisation methods such as OAuth and TLS.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint

#### Scenario: Business or data control 8
- **GIVEN** The API is documented using an industry standard such as OpenAPI.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint

#### Scenario: Business or data control 9
- **GIVEN** The API returns error codes and messages consistent with HTTP standards.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint
...
#### Scenario: Business or data control 11
...
#### Scenario: Business or data control 12
...
#### Scenario: Business or data control 13
...
#### Scenario: Business or data control 14
