# Retrieve Referral Contact Information
...
- **Source Use Case:** `UC-Integration-ProviderDirectory-18`
...
- **User Story:** Retrieve provider contact details so that referrals can be submitted electronically.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Retrieve Referral Contact Information
Harmonia SHALL support **Retrieve Referral Contact Information** so that referrals can be submitted electronically.

#### Scenario: Retrieve Referral Contact Information - successful outcome
...
- **WHEN** The actor needs to perform the 'Retrieve Referral Contact Information' activity, or an authorised business process initiates the activity.
- **THEN** Referral / Care Coordination System initiates the 'Retrieve Referral Contact Information' activity.
...
- **THEN** The 'Retrieve Referral Contact Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
