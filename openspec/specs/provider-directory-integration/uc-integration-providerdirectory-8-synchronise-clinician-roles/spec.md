# Synchronise Clinician Roles

## Purpose

provider responsibilities are accurately represented

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-8`
...
- **User Story:** Exchange practitioner role information so that provider responsibilities are accurately represented.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Synchronise Clinician Roles
Harmonia SHALL support **Synchronise Clinician Roles** so that provider responsibilities are accurately represented.

#### Scenario: Synchronise Clinician Roles - successful outcome
...
- **WHEN** The actor needs to perform the 'Synchronise Clinician Roles' activity, or an authorised business process initiates the activity.
- **THEN** Credential / Workforce Management System initiates the 'Synchronise Clinician Roles' activity.
...
- **THEN** The 'Synchronise Clinician Roles' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
