# Reconcile Provider Synchronisation Failures

## Purpose

Directory consistency can be maintained

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-36`
...
- **User Story:** Identify failed provider synchronisation transactions so that directory consistency can be maintained.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Reconcile Provider Synchronisation Failures
Harmonia SHALL support **Reconcile Provider Synchronisation Failures** so that Directory consistency can be maintained.

#### Scenario: Reconcile Provider Synchronisation Failures - successful outcome
...
- **WHEN** The actor needs to perform the 'Reconcile Provider Synchronisation Failures' activity, or an authorised business process initiates the activity.
- **THEN** Integration Service / Integration Platform initiates the 'Reconcile Provider Synchronisation Failures' activity.
...
- **THEN** The 'Reconcile Provider Synchronisation Failures' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
