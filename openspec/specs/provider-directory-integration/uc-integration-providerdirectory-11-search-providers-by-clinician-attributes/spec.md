# Search Providers by Clinician Attributes

## Purpose

suitable providers can be identified

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-11`
...
- **User Story:** Search providers using practitioner attributes so that suitable providers can be identified.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Search Providers by Clinician Attributes
Harmonia SHALL support **Search Providers by Clinician Attributes** so that suitable providers can be identified.

#### Scenario: Search Providers by Clinician Attributes - successful outcome
...
- **WHEN** The actor needs to perform the 'Search Providers by Clinician Attributes' activity, or an authorised business process initiates the activity.
- **THEN** Referral / Care Coordination System initiates the 'Search Providers by Clinician Attributes' activity.
...
- **THEN** The 'Search Providers by Clinician Attributes' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
