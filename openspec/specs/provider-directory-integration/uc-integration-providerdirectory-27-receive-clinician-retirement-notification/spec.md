# Receive Clinician Retirement Notification
...
- **Source Use Case:** `UC-Integration-ProviderDirectory-27`
...
- **User Story:** Receive practitioner retirement notifications so that provider availability is updated.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Clinician Retirement Notification
Harmonia SHALL support **Receive Clinician Retirement Notification** so that provider availability is updated.

#### Scenario: Receive Clinician Retirement Notification - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Clinician Retirement Notification' activity, or an authorised business process initiates the activity.
- **THEN** Downstream Consumer System System initiates the 'Receive Clinician Retirement Notification' activity.
...
- **THEN** The 'Receive Clinician Retirement Notification' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
