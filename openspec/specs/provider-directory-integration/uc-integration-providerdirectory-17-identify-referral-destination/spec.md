...
referrals can be routed correctly

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-17`
...
- **User Story:** Identify an appropriate provider destination so that referrals can be routed correctly.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identify Referral Destination
Harmonia SHALL support **Identify Referral Destination** so that referrals can be routed correctly.

#### Scenario: Identify Referral Destination - successful outcome
...
- **WHEN** The actor needs to perform the 'Identify Referral Destination' activity, or an authorised business process initiates the activity.
- **THEN** Referral / Care Coordination System initiates the 'Identify Referral Destination' activity.
...
- **THEN** The 'Identify Referral Destination' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
