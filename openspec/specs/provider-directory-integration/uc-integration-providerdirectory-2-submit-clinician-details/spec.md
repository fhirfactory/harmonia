# Submit Clinician Details

## Purpose

clinicians can be registered in the Provider Directory

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-2`
...
- **User Story:** Submit practitioner details so that clinicians can be registered in the Provider Directory.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Submit Clinician Details
Harmonia SHALL support **Submit Clinician Details** so that clinicians can be registered in the Provider Directory.

#### Scenario: Submit Clinician Details - successful outcome
...
- **WHEN** The actor needs to perform the 'Submit Clinician Details' activity, or an authorised business process initiates the activity.
- **THEN** Organisation / Location Management System initiates the 'Submit Clinician Details' activity.
...
- **THEN** The 'Submit Clinician Details' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
