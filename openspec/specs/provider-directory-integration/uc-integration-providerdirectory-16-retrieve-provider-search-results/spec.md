# Retrieve Provider Search Results

## Purpose

provider options can be displayed to users

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-16`
...
- **User Story:** Receive provider search results so that provider options can be displayed to users.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Retrieve Provider Search Results
Harmonia SHALL support **Retrieve Provider Search Results** so that provider options can be displayed to users.

#### Scenario: Retrieve Provider Search Results - successful outcome
...
- **WHEN** The actor needs to perform the 'Retrieve Provider Search Results' activity, or an authorised business process initiates the activity.
- **THEN** Downstream Consumer System System initiates the 'Retrieve Provider Search Results' activity.
...
- **THEN** The 'Retrieve Provider Search Results' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
