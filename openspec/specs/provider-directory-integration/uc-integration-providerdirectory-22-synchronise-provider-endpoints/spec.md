# Synchronise Provider Endpoints

## Purpose

connected systems can communicate reliably

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-22`
...
- **User Story:** Synchronise provider messaging and service endpoints so that connected systems can communicate reliably.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Synchronise Provider Endpoints
Harmonia SHALL support **Synchronise Provider Endpoints** so that connected systems can communicate reliably.

#### Scenario: Synchronise Provider Endpoints - successful outcome
...
- **WHEN** The actor needs to perform the 'Synchronise Provider Endpoints' activity, or an authorised business process initiates the activity.
- **THEN** Integration Service / Integration Platform initiates the 'Synchronise Provider Endpoints' activity.
...
- **THEN** The 'Synchronise Provider Endpoints' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
