# Retrieve Provider Communication Endpoints

## Purpose

clinical information can be securely exchanged

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-21`
- **Source Scope:** Scope - Electronic Communication and Endpoint Management
- **Primary Actor:** Integration Service / Integration Platform
- **Supporting Actors:** Provider Directory
- **User Story:** Retrieve provider communication endpoints so that clinical information can be securely exchanged.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Retrieve Provider Communication Endpoints
Harmonia SHALL support **Retrieve Provider Communication Endpoints** so that clinical information can be securely exchanged.

#### Scenario: Retrieve Provider Communication Endpoints - successful outcome
...
- **WHEN** The actor needs to perform the 'Retrieve Provider Communication Endpoints' activity, or an authorised business process initiates the activity.
- **THEN** Integration Service / Integration Platform initiates the 'Retrieve Provider Communication Endpoints' activity.
...
- **THEN** The 'Retrieve Provider Communication Endpoints' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
