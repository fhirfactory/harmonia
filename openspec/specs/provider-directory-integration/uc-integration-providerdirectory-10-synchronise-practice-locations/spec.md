# Synchronise Practice Locations

## Purpose

provider availability can be accurately discovered

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-10`
- **Source Scope:** Scope - Provider Profile Synchronisation
- **Primary Actor:** Organisation / Location Management System
- **Supporting Actors:** Provider Directory
- **User Story:** Exchange practitioner practice locations so that provider availability can be accurately discovered.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Synchronise Practice Locations
Harmonia SHALL support **Synchronise Practice Locations** so that provider availability can be accurately discovered.

#### Scenario: Synchronise Practice Locations - successful outcome
...
- **WHEN** The actor needs to perform the 'Synchronise Practice Locations' activity, or an authorised business process initiates the activity.
- **THEN** Organisation / Location Management System initiates the 'Synchronise Practice Locations' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Organisation / Location Management System enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Synchronise Practice Locations' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Organisation / Location Management System
