# Receive Provider Data Updates in a Usable Manual Format

## Purpose

Enable the target-state Provider Directory to support the capability described by SR-37 so that I can manually add the information into the system. The capability should operate as part of the governed Provider Directory service, with consistent identity, provenance, lifecycle, security, data-quality and audit controls applied irrespective of whether the activity is performed manually, through an API, or through system integration.

## Source Traceability

- **Source Use Case:** `SR-37`
- **Source Scope:** Additional Source Requirements – SR-26 to SR-58
- **Primary Actor:** System Administrator
- **Supporting Actors:** Provider Directory Administrator; Provider Directory; Integration Service
- **User Story:** As a System Administrator, I want to receive provider data updates in a usable format, so that I can manually add the information into the system.
...
### Requirement: Receive Provider Data Updates in a Usable Manual
Harmonia SHALL support **Receive Provider Data Updates in a Usable Manual Format** so that Enable the target-state Provider Directory to support the capability described by SR-37 so that I can manually add the information into the system. The capability should operate as part of the governed Provider Directory service, with consistent identity, provenance, lifecycle, security, data-quality and audit controls applied irrespective of whether the activity is performed manually, through an API, or through system integration.

#### Scenario: Receive Provider Data Updates in a Usable Manual Format - successful outcome
...
- **WHEN** The System Administrator initiates the activity, a relevant provider or reference-data change occurs, or an authorised scheduled/event-driven process triggers the requirement described by SR-37.
- **THEN** 1. The System Administrator initiates or receives the event associated with “Receive Provider Data Updates in a Usable Manual Format”.
...
- **THEN** The requirement described by SR-37 is completed successfully so that I can manually add the information into the system. The Provider Directory maintains an auditable and governed record of the activity and any exceptions are clearly identified for follow-up.
...
- **AND** supporting participation may be provided by Provider Directory Administrator; Provider Directory; Integration Service
...
- **WHEN** The exported file structure aligns with the downstream system update process.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 10
- **WHEN** Field names are consistent and clearly labelled.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 11
- **WHEN** New, updated and unchanged records can be identified.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 12
- **WHEN** Field-level data-source information is available where required.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 13
- **WHEN** The exported data contains mandatory fields required by the downstream system.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state
...
- **GIVEN** The exported file structure aligns with the downstream system update process.
...
- **GIVEN** Field names are consistent and clearly labelled.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint

#### Scenario: Business or data control 3
- **GIVEN** New, updated and unchanged records can be identified.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint

#### Scenario: Business or data control 4
- **GIVEN** Field-level data-source information is available where required.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint

#### Scenario: Business or data control 5
- **GIVEN** The exported data contains mandatory fields required by the downstream system.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint
