# Archive Inactive Provider Records

## Purpose

historical provider relationships are maintained

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-28`
- **Source Scope:** Scope - Provider Status and Lifecycle Management
- **Primary Actor:** Records Management System
- **Supporting Actors:** Provider Directory
- **User Story:** Receive provider archive notifications so that historical provider relationships are maintained.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Archive Inactive Provider Records
Harmonia SHALL support **Archive Inactive Provider Records** so that historical provider relationships are maintained.

#### Scenario: Archive Inactive Provider Records - successful outcome
...
- **WHEN** The actor needs to perform the 'Archive Inactive Provider Records' activity, or an authorised business process initiates the activity.
- **THEN** Records Management System initiates the 'Archive Inactive Provider Records' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Records Management System enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Archive Inactive Provider Records' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Records Management System
