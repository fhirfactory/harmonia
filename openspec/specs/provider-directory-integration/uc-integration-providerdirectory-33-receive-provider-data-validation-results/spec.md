# Receive Provider Data Validation Results

## Purpose

data issues can be corrected

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-33`
- **Source Scope:** Scope - Governance, Quality and Audit
- **Primary Actor:** Source System
- **Supporting Actors:** Provider Directory
- **User Story:** Receive validation outcomes so that data issues can be corrected.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Provider Data Validation Results
Harmonia SHALL support **Receive Provider Data Validation Results** so that data issues can be corrected.

#### Scenario: Receive Provider Data Validation Results - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Provider Data Validation Results' activity, or an authorised business process initiates the activity.
- **THEN** Source System initiates the 'Receive Provider Data Validation Results' activity.
...
- **THEN** The 'Receive Provider Data Validation Results' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
