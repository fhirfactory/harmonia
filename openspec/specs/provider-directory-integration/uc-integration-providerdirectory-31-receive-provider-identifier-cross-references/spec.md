# Receive Provider Identifier Cross References

## Purpose

provider records can be linked across systems

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-31`
- **Source Scope:** Scope - Provider Identity and Matching
- **Primary Actor:** Integration Service / Integration Platform
- **Supporting Actors:** Provider Directory
- **User Story:** Receive mappings between local and enterprise provider identifiers so that provider records can be linked across systems.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Provider Identifier Cross References
Harmonia SHALL support **Receive Provider Identifier Cross References** so that provider records can be linked across systems.

#### Scenario: Receive Provider Identifier Cross References - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Provider Identifier Cross References' activity, or an authorised business process initiates the activity.
- **THEN** Integration Service / Integration Platform initiates the 'Receive Provider Identifier Cross References' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Integration Service / Integration Platform enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Receive Provider Identifier Cross References' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Integration Service / Integration Platform
