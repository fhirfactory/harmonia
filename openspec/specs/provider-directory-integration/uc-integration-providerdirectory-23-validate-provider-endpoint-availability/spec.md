# Validate Provider Endpoint Availability

## Purpose

failed communications are reduced

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-23`
...
- **User Story:** Validate provider endpoints before sending information so that failed communications are reduced.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Validate Provider Endpoint Availability
Harmonia SHALL support **Validate Provider Endpoint Availability** so that failed communications are reduced.

#### Scenario: Validate Provider Endpoint Availability - successful outcome
...
- **WHEN** The actor needs to perform the 'Validate Provider Endpoint Availability' activity, or an authorised business process initiates the activity.
- **THEN** Integration Service / Integration Platform initiates the 'Validate Provider Endpoint Availability' activity.
...
- **THEN** The 'Validate Provider Endpoint Availability' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
