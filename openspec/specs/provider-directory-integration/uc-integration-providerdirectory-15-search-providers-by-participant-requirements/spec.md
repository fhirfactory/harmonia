# Search Providers by Participant Requirements

## Purpose

appropriate providers can be identified

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-15`
- **Source Scope:** Scope - Provider Search and Discovery
- **Primary Actor:** Referral / Care Coordination System
- **Supporting Actors:** Provider Directory
- **User Story:** Search providers using participant requirements such as location, language, accessibility needs, or service preferences so that appropriate providers can be identified.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Search Providers by Participant Requirements
Harmonia SHALL support **Search Providers by Participant Requirements** so that appropriate providers can be identified.

#### Scenario: Search Providers by Participant Requirements - successful outcome
...
- **WHEN** The actor needs to perform the 'Search Providers by Participant Requirements' activity, or an authorised business process initiates the activity.
- **THEN** Referral / Care Coordination System initiates the 'Search Providers by Participant Requirements' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Referral / Care Coordination System enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Search Providers by Participant Requirements' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Referral / Care Coordination System
