# Audit Provider Information Exchange

## Purpose

provider data access and sharing can be monitored

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-34`
- **Source Scope:** Scope - Governance, Quality and Audit
- **Primary Actor:** Reporting / Audit Service
- **Supporting Actors:** Provider Directory
- **User Story:** Record provider information exchanges so that provider data access and sharing can be monitored.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Audit Provider Information Exchange
Harmonia SHALL support **Audit Provider Information Exchange** so that provider data access and sharing can be monitored.

#### Scenario: Audit Provider Information Exchange - successful outcome
...
- **WHEN** The actor needs to perform the 'Audit Provider Information Exchange' activity, or an authorised business process initiates the activity.
- **THEN** Reporting / Audit Service initiates the 'Audit Provider Information Exchange' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Reporting / Audit Service enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Audit Provider Information Exchange' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Reporting / Audit Service
