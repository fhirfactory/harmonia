# Synchronise Organisation Affiliations
...
- **Source Use Case:** `UC-Integration-ProviderDirectory-9`
...
- **User Story:** Exchange practitioner organisation affiliations so that provider relationships are maintained.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Synchronise Organisation Affiliations
Harmonia SHALL support **Synchronise Organisation Affiliations** so that provider relationships are maintained.

#### Scenario: Synchronise Organisation Affiliations - successful outcome
...
- **WHEN** The actor needs to perform the 'Synchronise Organisation Affiliations' activity, or an authorised business process initiates the activity.
- **THEN** Organisation / Location Management System initiates the 'Synchronise Organisation Affiliations' activity.
...
- **THEN** The 'Synchronise Organisation Affiliations' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
