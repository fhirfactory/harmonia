# Receive Clinician Status Changes

## Purpose

inactive or suspended providers are not presented as available

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-25`
...
- **User Story:** Receive practitioner status changes so that inactive or suspended providers are not presented as available.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Clinician Status Changes
Harmonia SHALL support **Receive Clinician Status Changes** so that inactive or suspended providers are not presented as available.

#### Scenario: Receive Clinician Status Changes - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Clinician Status Changes' activity, or an authorised business process initiates the activity.
- **THEN** Downstream Consumer System System initiates the 'Receive Clinician Status Changes' activity.
...
- **THEN** The 'Receive Clinician Status Changes' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
