...
incomplete or inconsistent records can be identified

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-32`
- **Source Scope:** Scope - Governance, Quality and Audit
- **Primary Actor:** Data Quality Service
- **Supporting Actors:** Provider Directory
- **User Story:** Assess provider data quality so that incomplete or inconsistent records can be identified.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Validate Provider Data Quality
Harmonia SHALL support **Validate Provider Data Quality** so that incomplete or inconsistent records can be identified.

#### Scenario: Validate Provider Data Quality - successful outcome
...
- **WHEN** The actor needs to perform the 'Validate Provider Data Quality' activity, or an authorised business process initiates the activity.
- **THEN** Data Quality Service initiates the 'Validate Provider Data Quality' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Data Quality Service enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Validate Provider Data Quality' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Data Quality Service
