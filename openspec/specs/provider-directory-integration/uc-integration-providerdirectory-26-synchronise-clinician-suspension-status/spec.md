# Synchronise Clinician Suspension Status

## Purpose

directory information remains accurate

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-26`
- **Source Scope:** Scope - Provider Status and Lifecycle Management
- **Primary Actor:** Credential / Workforce Management System
- **Supporting Actors:** Provider Directory
- **User Story:** Communicate practitioner suspension status so that directory information remains accurate.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Synchronise Clinician Suspension Status
Harmonia SHALL support **Synchronise Clinician Suspension Status** so that directory information remains accurate.

#### Scenario: Synchronise Clinician Suspension Status - successful outcome
...
- **WHEN** The actor needs to perform the 'Synchronise Clinician Suspension Status' activity, or an authorised business process initiates the activity.
- **THEN** Credential / Workforce Management System initiates the 'Synchronise Clinician Suspension Status' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Credential / Workforce Management System enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Synchronise Clinician Suspension Status' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Credential / Workforce Management System
