...
referrals are not sent to unavailable providers

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-20`
...
- **User Story:** Validate that a provider is active and eligible to receive referrals so that referrals are not sent to unavailable providers.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Validate Referral Recipient
Harmonia SHALL support **Validate Referral Recipient** so that referrals are not sent to unavailable providers.

#### Scenario: Validate Referral Recipient - successful outcome
...
- **WHEN** The actor needs to perform the 'Validate Referral Recipient' activity, or an authorised business process initiates the activity.
- **THEN** Referral / Care Coordination System initiates the 'Validate Referral Recipient' activity.
...
- **THEN** The 'Validate Referral Recipient' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
