# Receive Provider Registration Outcome

## Purpose

I know whether the provider was accepted, rejected, or requires further information

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-4`
- **Source Scope:** Scope - Provider Registration and Onboarding
- **Primary Actor:** Source System
- **Supporting Actors:** Provider Directory
- **User Story:** Receive the outcome of provider registration submissions so that I know whether the provider was accepted, rejected, or requires further information.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Provider Registration Outcome
Harmonia SHALL support **Receive Provider Registration Outcome** so that I know whether the provider was accepted, rejected, or requires further information.

#### Scenario: Receive Provider Registration Outcome - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Provider Registration Outcome' activity, or an authorised business process initiates the activity.
- **THEN** Source System initiates the 'Receive Provider Registration Outcome' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Source System enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Receive Provider Registration Outcome' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Source System
