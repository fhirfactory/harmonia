# Supply Provider Data to Systems via Integration

## Purpose

Enable the target-state Provider Directory to support the capability described by SR-32 so that current provider information is available for downstream consumers. The capability should operate as part of the governed Provider Directory service, with consistent identity, provenance, lifecycle, security, data-quality and audit controls applied irrespective of whether the activity is performed manually, through an API, or through system integration.

## Source Traceability

- **Source Use Case:** `SR-32`
- **Source Scope:** Additional Source Requirements – SR-26 to SR-58
- **Primary Actor:** Integration Administrator
- **Supporting Actors:** Downstream Consumer System System; Integration Service; Provider Directory
- **User Story:** As an Integration Administrator, I want the Provider Directory to supply provider data to systems via integration, so that current provider information is available for downstream consumers.
...
### Requirement: Supply Provider Data to Systems via Integration
Harmonia SHALL support **Supply Provider Data to Systems via Integration** so that Enable the target-state Provider Directory to support the capability described by SR-32 so that current provider information is available for downstream consumers. The capability should operate as part of the governed Provider Directory service, with consistent identity, provenance, lifecycle, security, data-quality and audit controls applied irrespective of whether the activity is performed manually, through an API, or through system integration.

#### Scenario: Supply Provider Data to Systems via Integration - successful outcome
...
- **WHEN** The Integration Administrator initiates the activity, a relevant provider or reference-data change occurs, or an authorised scheduled/event-driven process triggers the requirement described by SR-32.
- **THEN** 1. The Integration Administrator initiates or receives the event associated with “Supply Provider Data to Systems via Integration”.
...
- **THEN** The requirement described by SR-32 is completed successfully so that current provider information is available for downstream consumers. The Provider Directory maintains an auditable and governed record of the activity and any exceptions are clearly identified for follow-up.
...
- **AND** supporting participation may be provided by Downstream Consumer System System; Integration Service; Provider Directory
...
- **WHEN** Provider data can be sent via system integration.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 10
- **WHEN** Provider data can be sent using standard formats such as XML, JSON, REST APIs or HL7/FHIR messaging.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 11
- **WHEN** Outbound data uses an agreed data definition and structure.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 12
- **WHEN** Each outbound data-supply event is logged.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 13
- **WHEN** Data can be supplied based on defined Provider Directory change events.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 14
- **WHEN** Integrations can be scheduled or triggered at the time of the event.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state
...
- **GIVEN** Provider data can be sent via system integration.
...
- **GIVEN** Provider data can be sent using standard formats such as XML, JSON, REST APIs or HL7/FHIR messaging.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint

#### Scenario: Business or data control 3
- **GIVEN** Outbound data uses an agreed data definition and structure.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint

#### Scenario: Business or data control 4
- **GIVEN** Each outbound data-supply event is logged.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint

#### Scenario: Business or data control 5
- **GIVEN** Data can be supplied based on defined Provider Directory change events.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint

#### Scenario: Business or data control 6
- **GIVEN** Integrations can be scheduled or triggered at the time of the event.
- **WHEN** information is created, changed, validated, published, exchanged or consumed through this capability
- **THEN** Harmonia SHALL preserve the stated control as an observable business rule or constraint
