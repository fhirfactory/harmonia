# Search Providers by Healthcare Service

## Purpose

participants can be matched with appropriate care options

## Source Traceability

- **Source Use Case:** `UC-Integration-ProviderDirectory-13`
...
- **User Story:** Search providers by services offered so that participants can be matched with appropriate care options.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Search Providers by Healthcare Service
Harmonia SHALL support **Search Providers by Healthcare Service** so that participants can be matched with appropriate care options.

#### Scenario: Search Providers by Healthcare Service - successful outcome
...
- **WHEN** The actor needs to perform the 'Search Providers by Healthcare Service' activity, or an authorised business process initiates the activity.
- **THEN** Referral / Care Coordination System initiates the 'Search Providers by Healthcare Service' activity.
...
- **THEN** The 'Search Providers by Healthcare Service' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
