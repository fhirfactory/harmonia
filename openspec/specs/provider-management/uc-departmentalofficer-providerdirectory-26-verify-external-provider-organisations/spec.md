# Verify External Provider Organisations

## Purpose

directory information is trustworthy

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-26`
- **Source Scope:** Scope - Advanced Enterprise Provider Directory
- **Primary Actor:** Data Steward (Organisation Verification)
- **Supporting Actors:** Provider Directory
- **User Story:** Verify healthcare organisations before clinicians can be affiliated with them so that directory information is trustworthy.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Verify External Provider Organisations
Harmonia SHALL support **Verify External Provider Organisations** so that directory information is trustworthy.

#### Scenario: Verify External Provider Organisations - successful outcome
...
- **WHEN** The actor needs to perform the 'Verify External Provider Organisations' activity, or an authorised business process initiates the activity.
- **THEN** Data Steward (Organisation Verification) initiates the 'Verify External Provider Organisations' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Data Steward (Organisation Verification) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Verify External Provider Organisations' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Data Steward (Organisation Verification)
