...
publication complies with policy and privacy requirements

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-20`
- **Source Scope:** Scope - Publication and Visibility (Provider Directory)
- **Primary Actor:** Privacy Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Control the visibility of practitioner information so that publication complies with policy and privacy requirements.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Directory Visibility
Harmonia SHALL support **Manage Directory Visibility** so that publication complies with policy and privacy requirements.

#### Scenario: Manage Directory Visibility - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Directory Visibility' activity, or an authorised business process initiates the activity.
- **THEN** Privacy Officer initiates the 'Manage Directory Visibility' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Privacy Officer enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Manage Directory Visibility' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Privacy Officer
