# Publish Clinician Profiles

## Purpose

they are available to authorised users

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-19`
...
- **User Story:** Publish approved practitioner profiles so that they are available to authorised users.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Publish Clinician Profiles
Harmonia SHALL support **Publish Clinician Profiles** so that they are available to authorised users.

#### Scenario: Publish Clinician Profiles - successful outcome
...
- **WHEN** The actor needs to perform the 'Publish Clinician Profiles' activity, or an authorised business process initiates the activity.
- **THEN** Provider Directory Administrator initiates the 'Publish Clinician Profiles' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Provider Directory Administrator enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Publish Clinician Profiles' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
