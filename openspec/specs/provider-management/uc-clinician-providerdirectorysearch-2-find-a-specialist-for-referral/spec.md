# Find a Specialist for Referral

## Purpose

I can make an appropriate referral

## Source Traceability

- **Source Use Case:** `UC-Clinician-ProviderDirectorySearch-2`
...
- **User Story:** Find a specialist with expertise relevant to a participant's condition so that I can make an appropriate referral.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Find a Specialist for Referral
Harmonia SHALL support **Find a Specialist for Referral** so that I can make an appropriate referral.

#### Scenario: Find a Specialist for Referral - successful outcome
...
- **WHEN** The actor needs to perform the 'Find a Specialist for Referral' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Referring Clinician) initiates the 'Find a Specialist for Referral' activity.
...
- **THEN** The 'Find a Specialist for Referral' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
