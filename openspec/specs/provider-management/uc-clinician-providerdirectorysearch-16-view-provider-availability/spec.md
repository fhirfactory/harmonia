...
I can identify realistic referral options

## Source Traceability

- **Source Use Case:** `UC-Clinician-ProviderDirectorySearch-16`
...
- **User Story:** View provider availability information so that I can identify realistic referral options.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View Provider Availability
Harmonia SHALL support **View Provider Availability** so that I can identify realistic referral options.

#### Scenario: View Provider Availability - successful outcome
...
- **WHEN** The actor needs to perform the 'View Provider Availability' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Referring Clinician) initiates the 'View Provider Availability' activity.
...
- **THEN** The 'View Provider Availability' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
