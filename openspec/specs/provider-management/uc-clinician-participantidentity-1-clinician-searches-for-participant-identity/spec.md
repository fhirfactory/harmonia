# Clinician Searches for Participant Identity

## Purpose

Search for a given Participant's Identity using their name, date-of-birth and other demographic information

## Source Traceability

- **Source Use Case:** `UC-Clinician-ParticipantIdentity-1`
...
- **User Story:** Search for a given Participant's Identity using their name, date-of-birth and other demographic information.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Clinician Searches for Participant Identity
Harmonia SHALL support **Clinician Searches for Participant Identity** so that Search for a given Participant's Identity using their name, date-of-birth and other demographic information.

#### Scenario: Clinician Searches for Participant Identity - successful outcome
...
- **WHEN** The actor needs to perform the 'Clinician Searches for Participant Identity' activity, or an authorised business process initiates the activity.
- **THEN** Clinician initiates the 'Clinician Searches for Participant Identity' activity.
...
- **THEN** The 'Clinician Searches for Participant Identity' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
