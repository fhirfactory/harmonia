# Search Providers Accepting New Referrals

## Purpose

I can avoid referring participants to unavailable services

## Source Traceability

- **Source Use Case:** `UC-Clinician-ProviderDirectorySearch-15`
- **Source Scope:** Scope - Availability and Referral Suitability
- **Primary Actor:** Clinician (Referring Clinician)
- **Supporting Actors:** Provider Directory
- **User Story:** Find providers currently accepting referrals so that I can avoid referring participants to unavailable services.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Search Providers Accepting New Referrals
Harmonia SHALL support **Search Providers Accepting New Referrals** so that I can avoid referring participants to unavailable services.

#### Scenario: Search Providers Accepting New Referrals - successful outcome
...
- **WHEN** The actor needs to perform the 'Search Providers Accepting New Referrals' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Referring Clinician) initiates the 'Search Providers Accepting New Referrals' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Clinician (Referring Clinician) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Search Providers Accepting New Referrals' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Clinician (Referring Clinician)
