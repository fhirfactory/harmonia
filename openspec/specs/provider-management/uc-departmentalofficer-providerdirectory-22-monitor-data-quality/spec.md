...
directory quality is maintained

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-22`
- **Source Scope:** Scope – Provider Directory
- **Primary Actor:** Data Steward (Data Quality)
- **Supporting Actors:** Provider Directory
- **User Story:** Identify incomplete, inconsistent or duplicate practitioner records so that directory quality is maintained.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Monitor Data Quality
Harmonia SHALL support **Monitor Data Quality** so that directory quality is maintained.

#### Scenario: Monitor Data Quality - successful outcome
...
- **WHEN** The actor needs to perform the 'Monitor Data Quality' activity, or an authorised business process initiates the activity.
- **THEN** Data Steward (Data Quality) initiates the 'Monitor Data Quality' activity.
...
- **THEN** The 'Monitor Data Quality' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
