# Manage Organisation Affiliations

## Purpose

provider relationships remain accurate

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-9`
- **Source Scope:** Scope -	Organisation and Role Management
- **Primary Actor:** Provider Directory Administrator (Organisation)
- **Supporting Actors:** Provider Directory
- **User Story:** Manage the organisations with which a practitioner is affiliated so that provider relationships remain accurate.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Organisation Affiliations
Harmonia SHALL support **Manage Organisation Affiliations** so that provider relationships remain accurate.

#### Scenario: Manage Organisation Affiliations - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Organisation Affiliations' activity, or an authorised business process initiates the activity.
- **THEN** Provider Directory Administrator (Organisation) initiates the 'Manage Organisation Affiliations' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Provider Directory Administrator (Organisation) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Manage Organisation Affiliations' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Provider Directory Administrator (Organisation)
