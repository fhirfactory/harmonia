# Verify Electronic Endpoints

## Purpose

referring systems can communicate successfully

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-18`
- **Source Scope:** Scope - Electronic Services (Provider Directory)
- **Primary Actor:** Integration Administrator
- **Supporting Actors:** Provider Directory
- **User Story:** Verify electronic service endpoints before publication so that referring systems can communicate successfully.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Verify Electronic Endpoints
Harmonia SHALL support **Verify Electronic Endpoints** so that referring systems can communicate successfully.

#### Scenario: Verify Electronic Endpoints - successful outcome
...
- **WHEN** The actor needs to perform the 'Verify Electronic Endpoints' activity, or an authorised business process initiates the activity.
- **THEN** Integration Administrator initiates the 'Verify Electronic Endpoints' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Integration Administrator enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Verify Electronic Endpoints' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
