# Search Using Care Requirement

## Purpose

I can identify suitable services

## Source Traceability

- **Source Use Case:** `UC-Clinician-ProviderDirectorySearch-8`
...
- **User Story:** Search for providers based on a participant's care requirement so that I can identify suitable services.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Search Using Care Requirement
Harmonia SHALL support **Search Using Care Requirement** so that I can identify suitable services.

#### Scenario: Search Using Care Requirement - successful outcome
...
- **WHEN** The actor needs to perform the 'Search Using Care Requirement' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Care Coordinator) initiates the 'Search Using Care Requirement' activity.
...
- **THEN** The 'Search Using Care Requirement' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
