# Manage Clinician Roles

## Purpose

their responsibilities are correctly represented

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-10`
...
- **User Story:** Maintain a practitioner's clinical and administrative roles so that their responsibilities are correctly represented.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Clinician Roles
Harmonia SHALL support **Manage Clinician Roles** so that their responsibilities are correctly represented.

#### Scenario: Manage Clinician Roles - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Clinician Roles' activity, or an authorised business process initiates the activity.
- **THEN** Provider Directory Administrator (Workforce) initiates the 'Manage Clinician Roles' activity.
...
- **THEN** The 'Manage Clinician Roles' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
