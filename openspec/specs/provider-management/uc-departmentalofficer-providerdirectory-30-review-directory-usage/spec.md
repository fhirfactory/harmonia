...
directory services can be improved

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-30`
- **Source Scope:** Scope - Advanced Enterprise Provider Directory
- **Primary Actor:** Provider Directory Administrator (Service Management)
- **Supporting Actors:** Provider Directory
- **User Story:** Analyse Provider Directory usage and search patterns so that directory services can be improved.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Review Directory Usage
Harmonia SHALL support **Review Directory Usage** so that directory services can be improved.

#### Scenario: Review Directory Usage - successful outcome
...
- **WHEN** The actor needs to perform the 'Review Directory Usage' activity, or an authorised business process initiates the activity.
- **THEN** Provider Directory Administrator (Service Management) initiates the 'Review Directory Usage' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Provider Directory Administrator (Service Management) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Review Directory Usage' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Provider Directory Administrator (Service Management)
