# Search for Complex Care Expertise

## Purpose

participants receive appropriate support

## Source Traceability

- **Source Use Case:** `UC-Clinician-ProviderDirectorySearch-9`
- **Source Scope:** Scope - Problem-Based Provider Discovery
- **Primary Actor:** Clinician (Complex Care Coordinator)
- **Supporting Actors:** Provider Directory
- **User Story:** Identify providers experienced in managing complex conditions so that participants receive appropriate support.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Search for Complex Care Expertise
Harmonia SHALL support **Search for Complex Care Expertise** so that participants receive appropriate support.

#### Scenario: Search for Complex Care Expertise - successful outcome
...
- **WHEN** The actor needs to perform the 'Search for Complex Care Expertise' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Complex Care Coordinator) initiates the 'Search for Complex Care Expertise' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Clinician (Complex Care Coordinator) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Search for Complex Care Expertise' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Clinician (Complex Care Coordinator)
