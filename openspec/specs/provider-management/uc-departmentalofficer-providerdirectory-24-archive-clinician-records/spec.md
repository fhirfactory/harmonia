# Archive Clinician Records

## Purpose

historical information is retained in accordance with retention policies

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-24`
- **Source Scope:** Scope – Provider Directory
- **Primary Actor:** Records Management Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Archive practitioner records when they are no longer active so that historical information is retained in accordance with retention policies.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Archive Clinician Records
Harmonia SHALL support **Archive Clinician Records** so that historical information is retained in accordance with retention policies.

#### Scenario: Archive Clinician Records - successful outcome
...
- **WHEN** The actor needs to perform the 'Archive Clinician Records' activity, or an authorised business process initiates the activity.
- **THEN** Records Management Officer initiates the 'Archive Clinician Records' activity.
...
- **THEN** The 'Archive Clinician Records' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
