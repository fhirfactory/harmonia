# Search Providers by Clinical Capability

## Purpose

I can identify providers suitable for specific patient requirements

## Source Traceability

- **Source Use Case:** `UC-Clinician-ProviderDirectorySearch-5`
- **Source Scope:** Scope - Clinician Search (Provider Directory)
- **Primary Actor:** Clinician
- **Supporting Actors:** Provider Directory
- **User Story:** Search providers by their clinical capabilities and services offered so that I can identify providers suitable for specific patient requirements.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Search Providers by Clinical Capability
Harmonia SHALL support **Search Providers by Clinical Capability** so that I can identify providers suitable for specific patient requirements.

#### Scenario: Search Providers by Clinical Capability - successful outcome
...
- **WHEN** The actor needs to perform the 'Search Providers by Clinical Capability' activity, or an authorised business process initiates the activity.
- **THEN** Clinician initiates the 'Search Providers by Clinical Capability' activity.
...
- **THEN** The 'Search Providers by Clinical Capability' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
