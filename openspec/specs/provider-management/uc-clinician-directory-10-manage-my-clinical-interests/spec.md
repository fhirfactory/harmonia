# Manage My Clinical Interests

## Purpose

participants and referrers understand the services I provide

## Source Traceability

- **Source Use Case:** `UC-Clinician-Directory-10`
- **Source Scope:** Scope – Clinician Scope of Practice
- **User Story:** Describe my clinical interests so that participants and referrers understand the services I provide.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage My Clinical Interests
Harmonia SHALL support **Manage My Clinical Interests** so that participants and referrers understand the services I provide.

#### Scenario: Manage My Clinical Interests - successful outcome
...
- **GIVEN** Any prerequisite records or relationships exist.
- **WHEN** The actor needs to perform the 'Manage My Clinical Interests' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Specialist) initiates the 'Manage My Clinical Interests' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Clinician (Specialist) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Manage My Clinical Interests' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
