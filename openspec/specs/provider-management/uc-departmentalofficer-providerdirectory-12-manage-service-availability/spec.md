...
referrers have accurate information

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-12`
- **Source Scope:** Scope -	Organisation and Role Management
- **Primary Actor:** Provider Directory Administrator (Service)
- **Supporting Actors:** Provider Directory
- **User Story:** Update practitioner availability and referral status so that referrers have accurate information.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Service Availability
Harmonia SHALL support **Manage Service Availability** so that referrers have accurate information.

#### Scenario: Manage Service Availability - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Service Availability' activity, or an authorised business process initiates the activity.
- **THEN** Provider Directory Administrator (Service) initiates the 'Manage Service Availability' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Provider Directory Administrator (Service) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Manage Service Availability' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Provider Directory Administrator (Service)
