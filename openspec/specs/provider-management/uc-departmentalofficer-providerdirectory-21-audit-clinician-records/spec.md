# Audit Clinician Records

## Purpose

I can demonstrate compliance and investigate issues

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-21`
- **Source Scope:** Scope – Provider Directory
- **Primary Actor:** Reporting / Audit Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Review the history of changes made to practitioner records so that I can demonstrate compliance and investigate issues.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Audit Clinician Records
Harmonia SHALL support **Audit Clinician Records** so that I can demonstrate compliance and investigate issues.

#### Scenario: Audit Clinician Records - successful outcome
...
- **WHEN** The actor needs to perform the 'Audit Clinician Records' activity, or an authorised business process initiates the activity.
- **THEN** Reporting / Audit Officer initiates the 'Audit Clinician Records' activity.
...
- **THEN** The 'Audit Clinician Records' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
