# Maintain Clinician Profiles

## Purpose

directory information remains current

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-8`
- **Source Scope:** Scope - Profile Management
- **Primary Actor:** Provider Directory Administrator
- **Supporting Actors:** Provider Directory
- **User Story:** Update practitioner records on behalf of clinicians so that directory information remains current.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Maintain Clinician Profiles
Harmonia SHALL support **Maintain Clinician Profiles** so that directory information remains current.

#### Scenario: Maintain Clinician Profiles - successful outcome
...
- **WHEN** The actor needs to perform the 'Maintain Clinician Profiles' activity, or an authorised business process initiates the activity.
- **THEN** Provider Directory Administrator initiates the 'Maintain Clinician Profiles' activity.
...
- **THEN** The 'Maintain Clinician Profiles' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
