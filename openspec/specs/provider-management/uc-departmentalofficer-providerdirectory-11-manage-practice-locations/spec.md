...
participants can locate available services

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-11`
- **Source Scope:** Scope -	Organisation and Role Management
- **Primary Actor:** Provider Directory Administrator (Location)
- **Supporting Actors:** Provider Directory
- **User Story:** Assign clinicians to practice locations so that participants can locate available services.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Practice Locations
Harmonia SHALL support **Manage Practice Locations** so that participants can locate available services.

#### Scenario: Manage Practice Locations - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Practice Locations' activity, or an authorised business process initiates the activity.
- **THEN** Provider Directory Administrator (Location) initiates the 'Manage Practice Locations' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Provider Directory Administrator (Location) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Manage Practice Locations' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Provider Directory Administrator (Location)
