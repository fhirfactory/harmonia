# Search Using Procedure or Treatment Requirement

## Purpose

I can refer participants appropriately

## Source Traceability

- **Source Use Case:** `UC-Clinician-ProviderDirectorySearch-7`
...
- **User Story:** Search for providers who perform a required procedure or treatment so that I can refer participants appropriately.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Search Using Procedure or Treatment Requirement
Harmonia SHALL support **Search Using Procedure or Treatment Requirement** so that I can refer participants appropriately.

#### Scenario: Search Using Procedure or Treatment Requirement - successful outcome
...
- **WHEN** The actor needs to perform the 'Search Using Procedure or Treatment Requirement' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Treating Clinician) initiates the 'Search Using Procedure or Treatment Requirement' activity.
...
- **THEN** The 'Search Using Procedure or Treatment Requirement' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
