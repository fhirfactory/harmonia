...
credential information remains current

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-13`
- **Source Scope:** Scope - Credentials and Authorisations
- **Primary Actor:** Credentialing Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Maintain practitioner registrations, licences and certifications so that credential information remains current.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Professional Credentials
Harmonia SHALL support **Manage Professional Credentials** so that credential information remains current.

#### Scenario: Manage Professional Credentials - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Professional Credentials' activity, or an authorised business process initiates the activity.
- **THEN** Credentialing Officer initiates the 'Manage Professional Credentials' activity.
...
- **THEN** The 'Manage Professional Credentials' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
