...
updated practitioner information becomes available

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-6`
- **Source Scope:** Scope - Profile Management
- **Primary Actor:** Provider Directory Administrator
- **Supporting Actors:** Provider Directory
- **User Story:** Approve verified profile changes so that updated practitioner information becomes available.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Approve Profile Updates
Harmonia SHALL support **Approve Profile Updates** so that updated practitioner information becomes available.

#### Scenario: Approve Profile Updates - successful outcome
...
- **WHEN** The actor needs to perform the 'Approve Profile Updates' activity, or an authorised business process initiates the activity.
- **THEN** Provider Directory Administrator initiates the 'Approve Profile Updates' activity.
...
- **THEN** The 'Approve Profile Updates' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
