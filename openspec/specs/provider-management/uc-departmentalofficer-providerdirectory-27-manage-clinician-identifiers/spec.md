# Manage Clinician Identifiers

## Purpose

clinicians can be uniquely identified across healthcare systems

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-27`
- **Source Scope:** Scope - Advanced Enterprise Provider Directory
- **Primary Actor:** Data Steward (Identity Management)
- **Supporting Actors:** Provider Directory
- **User Story:** Manage national and local practitioner identifiers so that clinicians can be uniquely identified across healthcare systems.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Clinician Identifiers
Harmonia SHALL support **Manage Clinician Identifiers** so that clinicians can be uniquely identified across healthcare systems.

#### Scenario: Manage Clinician Identifiers - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Clinician Identifiers' activity, or an authorised business process initiates the activity.
- **THEN** Data Steward (Identity Management) initiates the 'Manage Clinician Identifiers' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Data Steward (Identity Management) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Manage Clinician Identifiers' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Data Steward (Identity Management)
