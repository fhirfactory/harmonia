# Search Providers by Service Delivery Mode

## Purpose

I can match services to participant preferences

## Source Traceability

- **Source Use Case:** `UC-Clinician-ProviderDirectorySearch-12`
- **Source Scope:** Scope - Location and Accessibility-Based Search
- **Primary Actor:** Clinician
- **Supporting Actors:** Provider Directory
- **User Story:** Search providers offering face-to-face, telehealth, outreach, or mobile services so that I can match services to participant preferences.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Search Providers by Service Delivery Mode
Harmonia SHALL support **Search Providers by Service Delivery Mode** so that I can match services to participant preferences.

#### Scenario: Search Providers by Service Delivery Mode - successful outcome
...
- **WHEN** The actor needs to perform the 'Search Providers by Service Delivery Mode' activity, or an authorised business process initiates the activity.
- **THEN** Clinician initiates the 'Search Providers by Service Delivery Mode' activity.
...
- **THEN** The 'Search Providers by Service Delivery Mode' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
