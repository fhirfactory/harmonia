# Generate Provider Directory Reports

## Purpose

operational performance and compliance can be monitored

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-25`
- **Source Scope:** Scope – Provider Directory
- **Primary Actor:** Reporting / Audit Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Produce reports on practitioner registrations, credentials, affiliations and data quality so that operational performance and compliance can be monitored.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Generate Provider Directory Reports
Harmonia SHALL support **Generate Provider Directory Reports** so that operational performance and compliance can be monitored.

#### Scenario: Generate Provider Directory Reports - successful outcome
...
- **WHEN** The actor needs to perform the 'Generate Provider Directory Reports' activity, or an authorised business process initiates the activity.
- **THEN** Reporting / Audit Officer initiates the 'Generate Provider Directory Reports' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Reporting / Audit Officer enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Generate Provider Directory Reports' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Reporting / Audit Officer
