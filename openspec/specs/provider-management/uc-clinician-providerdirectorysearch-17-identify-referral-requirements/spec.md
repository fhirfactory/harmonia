...
I can submit complete referrals

## Source Traceability

- **Source Use Case:** `UC-Clinician-ProviderDirectorySearch-17`
...
- **User Story:** Understand referral requirements for a provider so that I can submit complete referrals.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identify Referral Requirements
Harmonia SHALL support **Identify Referral Requirements** so that I can submit complete referrals.

#### Scenario: Identify Referral Requirements - successful outcome
...
- **WHEN** The actor needs to perform the 'Identify Referral Requirements' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Referring Clinician) initiates the 'Identify Referral Requirements' activity.
...
- **THEN** The 'Identify Referral Requirements' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
