# Record My Certifications

## Purpose

The Clinician’s certifications are available to authorised users.

## Source Traceability

- **Source Use Case:** `UC-Clinician-Directory-8`
- **Source Scope:** Scope - Professional Credentials
- **User Story:** Maintain certifications and accreditations relevant to my practice so that they are available to authorised users.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Record My Certifications
Harmonia SHALL support **Record My Certifications** so that The Clinician’s certifications are available to authorised users.

#### Scenario: Record My Certifications - successful outcome
...
- **WHEN** The actor needs to perform the 'Record My Certifications' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Registered) initiates the 'Record My Certifications' activity.
...
- **THEN** The 'Record My Certifications' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
