# Find an Allied Health Provider

## Purpose

I can coordinate multidisciplinary care

## Source Traceability

- **Source Use Case:** `UC-Clinician-ProviderDirectorySearch-3`
...
- **User Story:** Identify allied health providers who support a participant's needs so that I can coordinate multidisciplinary care.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Find an Allied Health Provider
Harmonia SHALL support **Find an Allied Health Provider** so that I can coordinate multidisciplinary care.

#### Scenario: Find an Allied Health Provider - successful outcome
...
- **WHEN** The actor needs to perform the 'Find an Allied Health Provider' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Treating Clinician) initiates the 'Find an Allied Health Provider' activity.
...
- **THEN** The 'Find an Allied Health Provider' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
