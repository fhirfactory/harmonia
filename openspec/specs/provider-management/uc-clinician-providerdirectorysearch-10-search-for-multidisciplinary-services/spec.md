# Search for Multidisciplinary Services

## Purpose

I can establish a coordinated care team

## Source Traceability

- **Source Use Case:** `UC-Clinician-ProviderDirectorySearch-10`
- **Source Scope:** Scope - Problem-Based Provider Discovery
- **Primary Actor:** Clinician (Care Team Member)
- **Supporting Actors:** Provider Directory
- **User Story:** Identify providers across multiple disciplines so that I can establish a coordinated care team.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Search for Multidisciplinary Services
Harmonia SHALL support **Search for Multidisciplinary Services** so that I can establish a coordinated care team.

#### Scenario: Search for Multidisciplinary Services - successful outcome
...
- **WHEN** The actor needs to perform the 'Search for Multidisciplinary Services' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Care Team Member) initiates the 'Search for Multidisciplinary Services' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Clinician (Care Team Member) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Search for Multidisciplinary Services' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Clinician (Care Team Member)
