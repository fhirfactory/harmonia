...
only authorised clinicians are published

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-3`
- **Source Scope:** Scope - Clinician Registration
- **Primary Actor:** Credentialing Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Verify a practitioner's professional registration and licence so that only authorised clinicians are published.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Verify Professional Registration
Harmonia SHALL support **Verify Professional Registration** so that only authorised clinicians are published.

#### Scenario: Verify Professional Registration - successful outcome
...
- **WHEN** The actor needs to perform the 'Verify Professional Registration' activity, or an authorised business process initiates the activity.
- **THEN** Credentialing Officer initiates the 'Verify Professional Registration' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Credentialing Officer enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Verify Professional Registration' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Credentialing Officer
