...
published data meets organisational standards

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ProviderDirectory-29`
- **Source Scope:** Scope - Advanced Enterprise Provider Directory
- **Primary Actor:** Data Governance Officer (Policy)
- **Supporting Actors:** Provider Directory
- **User Story:** Define verification rules for practitioner information so that published data meets organisational standards.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Verification Policies
Harmonia SHALL support **Manage Verification Policies** so that published data meets organisational standards.

#### Scenario: Manage Verification Policies - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Verification Policies' activity, or an authorised business process initiates the activity.
- **THEN** Data Governance Officer (Policy) initiates the 'Manage Verification Policies' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Data Governance Officer (Policy) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Manage Verification Policies' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Data Governance Officer (Policy)
