...
only authorised people may view it

## Source Traceability

- **Source Use Case:** `UC-Participant-Consent-11`
- **Source Scope:** Scope – Consent
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Restrict access to sensitive health information so that only authorised people may view it.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Restrict Sensitive Information
Harmonia SHALL support **Restrict Sensitive Information** so that only authorised people may view it.

#### Scenario: Restrict Sensitive Information - successful outcome
...
- **WHEN** The actor needs to perform the 'Restrict Sensitive Information' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Restrict Sensitive Information' activity.
...
- **THEN** The 'Restrict Sensitive Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
