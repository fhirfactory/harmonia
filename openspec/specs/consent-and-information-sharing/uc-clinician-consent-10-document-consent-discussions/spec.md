...
informed consent can be demonstrated

## Source Traceability

- **Source Use Case:** `UC-Clinician-Consent-10`
...
- **User Story:** Record the details of consent discussions so that informed consent can be demonstrated.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Document Consent Discussions
Harmonia SHALL support **Document Consent Discussions** so that informed consent can be demonstrated.

#### Scenario: Document Consent Discussions - successful outcome
...
- **WHEN** The actor needs to perform the 'Document Consent Discussions' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Treating Clinician) initiates the 'Document Consent Discussions' activity.
...
- **THEN** The 'Document Consent Discussions' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
