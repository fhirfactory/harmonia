# Receive Notification of Consent Changes

## Purpose

I understand how it affects my access

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-12`
...
- **User Story:** Be notified when a participant changes their consent preferences so that I understand how it affects my access.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Notification of Consent Changes
Harmonia SHALL support **Receive Notification of Consent Changes** so that I understand how it affects my access.

#### Scenario: Receive Notification of Consent Changes - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Notification of Consent Changes' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (General Practitioner) initiates the 'Receive Notification of Consent Changes' activity.
...
- **THEN** The 'Receive Notification of Consent Changes' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
