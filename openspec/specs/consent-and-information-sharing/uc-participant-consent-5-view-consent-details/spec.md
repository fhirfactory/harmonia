...
- **Source Use Case:** `UC-Participant-Consent-5`
- **Source Scope:** Scope – Consent
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** View the details of a consent so that I understand what I have agreed to.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View Consent Details
Harmonia SHALL support **View Consent Details** so that I understand what I have agreed to.

#### Scenario: View Consent Details - successful outcome
...
- **WHEN** The actor needs to perform the 'View Consent Details' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'View Consent Details' activity.
...
- **THEN** The 'View Consent Details' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
