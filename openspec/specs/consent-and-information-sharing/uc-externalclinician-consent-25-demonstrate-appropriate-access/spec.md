...
audit and regulatory requirements are met

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-25`
...
- **User Story:** Demonstrate that my access to participant information was consistent with the participant's consent so that audit and regulatory requirements are met.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Demonstrate Appropriate Access
Harmonia SHALL support **Demonstrate Appropriate Access** so that audit and regulatory requirements are met.

#### Scenario: Demonstrate Appropriate Access - successful outcome
...
- **WHEN** The actor needs to perform the 'Demonstrate Appropriate Access' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (General Practitioner) initiates the 'Demonstrate Appropriate Access' activity.
...
- **THEN** The 'Demonstrate Appropriate Access' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **WHEN** Actor – Departmental Officer
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state
