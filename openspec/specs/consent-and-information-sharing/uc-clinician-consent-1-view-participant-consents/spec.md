# View Participant Consents

## Purpose

I understand what activities have been authorised

## Source Traceability

- **Source Use Case:** `UC-Clinician-Consent-1`
...
- **User Story:** View a participant's current consent directives so that I understand what activities have been authorised.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View Participant Consents
Harmonia SHALL support **View Participant Consents** so that I understand what activities have been authorised.

#### Scenario: View Participant Consents - successful outcome
...
- **WHEN** The actor needs to perform the 'View Participant Consents' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Treating Clinician) initiates the 'View Participant Consents' activity.
...
- **THEN** The 'View Participant Consents' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
