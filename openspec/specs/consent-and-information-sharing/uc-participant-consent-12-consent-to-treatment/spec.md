...
my treatment preferences are formally recorded

## Source Traceability

- **Source Use Case:** `UC-Participant-Consent-12`
- **Source Scope:** Scope – Consent
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Provide consent for a treatment or procedure so that my treatment preferences are formally recorded.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Consent to Treatment
Harmonia SHALL support **Consent to Treatment** so that my treatment preferences are formally recorded.

#### Scenario: Consent to Treatment - successful outcome
...
- **WHEN** The actor needs to perform the 'Consent to Treatment' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Consent to Treatment' activity.
...
- **THEN** The 'Consent to Treatment' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
