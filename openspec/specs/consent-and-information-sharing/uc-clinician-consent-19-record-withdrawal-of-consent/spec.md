...
future activities respect their updated decision

## Source Traceability

- **Source Use Case:** `UC-Clinician-Consent-19`
...
- **User Story:** Record when a participant withdraws consent so that future activities respect their updated decision.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Record Withdrawal of Consent
Harmonia SHALL support **Record Withdrawal of Consent** so that future activities respect their updated decision.

#### Scenario: Record Withdrawal of Consent - successful outcome
...
- **WHEN** The actor needs to perform the 'Record Withdrawal of Consent' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Treating Clinician) initiates the 'Record Withdrawal of Consent' activity.
...
- **THEN** The 'Record Withdrawal of Consent' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
