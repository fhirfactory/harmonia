...
care is coordinated across organisations

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-9`
...
- **User Story:** Share clinical documents with the public health service where authorised so that care is coordinated across organisations.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Share Clinical Information
Harmonia SHALL support **Share Clinical Information** so that care is coordinated across organisations.

#### Scenario: Share Clinical Information - successful outcome
...
- **WHEN** The actor needs to perform the 'Share Clinical Information' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (General Practitioner) initiates the 'Share Clinical Information' activity.
...
- **THEN** The 'Share Clinical Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
