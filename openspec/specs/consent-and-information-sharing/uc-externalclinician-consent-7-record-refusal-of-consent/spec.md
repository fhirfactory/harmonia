...
- **Source Use Case:** `UC-ExternalClinician-Consent-7`
...
- **User Story:** Record when a participant declines access to their information so that their decision is respected.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Record Refusal of Consent
Harmonia SHALL support **Record Refusal of Consent** so that their decision is respected.

#### Scenario: Record Refusal of Consent - successful outcome
...
- **WHEN** The actor needs to perform the 'Record Refusal of Consent' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (General Practitioner) initiates the 'Record Refusal of Consent' activity.
...
- **THEN** The 'Record Refusal of Consent' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
