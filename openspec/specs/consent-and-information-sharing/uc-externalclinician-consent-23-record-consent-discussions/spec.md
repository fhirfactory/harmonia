# Record Consent Discussions

## Purpose

informed decision-making is recorded

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-23`
...
- **User Story:** Document discussions regarding participant consent so that informed decision-making is recorded.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Record Consent Discussions
Harmonia SHALL support **Record Consent Discussions** so that informed decision-making is recorded.

#### Scenario: Record Consent Discussions - successful outcome
...
- **WHEN** The actor needs to perform the 'Record Consent Discussions' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (General Practitioner) initiates the 'Record Consent Discussions' activity.
...
- **THEN** The 'Record Consent Discussions' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
