...
participants can trust that requests originate from a recognised provider

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-24`
- **Source Scope:** Scope - Governance and Compliance (Consent)
- **Primary Actor:** External Healthcare Provider Representative (Practice Manager)
- **Supporting Actors:** Provider Directory
- **User Story:** my organisation's authority to participate in information sharing to be verified so that participants can trust that requests originate from a recognised provider.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Confirm Organisational Authority
Harmonia SHALL support **Confirm Organisational Authority** so that participants can trust that requests originate from a recognised provider.

#### Scenario: Confirm Organisational Authority - successful outcome
...
- **WHEN** The actor needs to perform the 'Confirm Organisational Authority' activity, or an authorised business process initiates the activity.
- **THEN** External Healthcare Provider Representative (Practice Manager) initiates the 'Confirm Organisational Authority' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** External Healthcare Provider Representative (Practice Manager) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Confirm Organisational Authority' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is External Healthcare Provider Representative (Practice Manager)
