# Request Access to Participant Information

## Purpose

I can provide safe and informed care

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-1`
- **Source Scope:** Scope - Clinician Access to Participant Information
- **Primary Actor:** External ClinicianProvider (General Practitioner)
- **Supporting Actors:** Provider Directory
- **User Story:** Request access to a participant's health information so that I can provide safe and informed care.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Request Access to Participant Information
Harmonia SHALL support **Request Access to Participant Information** so that I can provide safe and informed care.

#### Scenario: Request Access to Participant Information - successful outcome
...
- **WHEN** The actor needs to perform the 'Request Access to Participant Information' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (General Practitioner) initiates the 'Request Access to Participant Information' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** External ClinicianProvider (General Practitioner) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Request Access to Participant Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is External ClinicianProvider (General Practitioner)
