...
- **Source Use Case:** `UC-Participant-Consent-13`
- **Source Scope:** Scope – Consent
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Provide or decline consent for my information to be used in research so that my preferences are respected.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Consent to Research
Harmonia SHALL support **Consent to Research** so that my preferences are respected.

#### Scenario: Consent to Research - successful outcome
...
- **WHEN** The actor needs to perform the 'Consent to Research' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Consent to Research' activity.
...
- **THEN** The 'Consent to Research' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
