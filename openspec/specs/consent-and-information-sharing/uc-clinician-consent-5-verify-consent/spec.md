...
I comply with legal and organisational requirements

## Source Traceability

- **Source Use Case:** `UC-Clinician-Consent-5`
...
- **User Story:** Verify that a valid consent exists before undertaking an activity so that I comply with legal and organisational requirements.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Verify Consent
Harmonia SHALL support **Verify Consent** so that I comply with legal and organisational requirements.

#### Scenario: Verify Consent - successful outcome
...
- **WHEN** The actor needs to perform the 'Verify Consent' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Treating Clinician) initiates the 'Verify Consent' activity.
...
- **THEN** The 'Verify Consent' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
