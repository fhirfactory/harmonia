# Authorise Specific Healthcare Providers

## Purpose

only nominated clinicians can view it

## Source Traceability

- **Source Use Case:** `UC-Participant-Consent-9`
- **Source Scope:** Scope – Consent
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Authorise individual healthcare providers to access my information so that only nominated clinicians can view it.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Authorise Specific Healthcare Providers
Harmonia SHALL support **Authorise Specific Healthcare Providers** so that only nominated clinicians can view it.

#### Scenario: Authorise Specific Healthcare Providers - successful outcome
...
- **WHEN** The actor needs to perform the 'Authorise Specific Healthcare Providers' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Authorise Specific Healthcare Providers' activity.
...
- **THEN** The 'Authorise Specific Healthcare Providers' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
