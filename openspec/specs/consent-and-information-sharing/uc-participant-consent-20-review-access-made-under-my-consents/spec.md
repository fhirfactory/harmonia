# Review Access Made Under My Consents

## Purpose

I can monitor how my information is being used

## Source Traceability

- **Source Use Case:** `UC-Participant-Consent-20`
- **Source Scope:** Scope – Consent
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** View when my information has been accessed under my consent so that I can monitor how my information is being used.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Review Access Made Under My Consents
Harmonia SHALL support **Review Access Made Under My Consents** so that I can monitor how my information is being used.

#### Scenario: Review Access Made Under My Consents - successful outcome
...
- **WHEN** The actor needs to perform the 'Review Access Made Under My Consents' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Review Access Made Under My Consents' activity.
...
- **THEN** The 'Review Access Made Under My Consents' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
