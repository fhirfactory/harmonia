# Authorise a Related Person

## Purpose

they can assist with my care

## Source Traceability

- **Source Use Case:** `UC-Participant-Consent-10`
- **Source Scope:** Scope – Consent
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Authorise a nominated representative, carer or guardian to access my information so that they can assist with my care.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Authorise a Related Person
Harmonia SHALL support **Authorise a Related Person** so that they can assist with my care.

#### Scenario: Authorise a Related Person - successful outcome
...
- **WHEN** The actor needs to perform the 'Authorise a Related Person' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Authorise a Related Person' activity.
...
- **THEN** The 'Authorise a Related Person' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
