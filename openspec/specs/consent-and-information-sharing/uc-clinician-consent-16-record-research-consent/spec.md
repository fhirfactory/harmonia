...
research activities comply with ethical approvals

## Source Traceability

- **Source Use Case:** `UC-Clinician-Consent-16`
- **Source Scope:** Scope - Consent – Internal Clinicians
- **Primary Actor:** Clinician (Research Investigator)
- **Supporting Actors:** Provider Directory
- **User Story:** Record a participant's consent to participate in research so that research activities comply with ethical approvals.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Record Research Consent
Harmonia SHALL support **Record Research Consent** so that research activities comply with ethical approvals.

#### Scenario: Record Research Consent - successful outcome
...
- **WHEN** The actor needs to perform the 'Record Research Consent' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Research Investigator) initiates the 'Record Research Consent' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Clinician (Research Investigator) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Record Research Consent' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Clinician (Research Investigator)
