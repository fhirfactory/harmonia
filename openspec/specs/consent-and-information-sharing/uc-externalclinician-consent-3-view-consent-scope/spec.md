...
I only view information within the approved scope

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-3`
...
- **User Story:** Understand what information the participant has authorised me to access so that I only view information within the approved scope.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View Consent Scope
Harmonia SHALL support **View Consent Scope** so that I only view information within the approved scope.

#### Scenario: View Consent Scope - successful outcome
...
- **WHEN** The actor needs to perform the 'View Consent Scope' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (Rehabilitation Clinician) initiates the 'View Consent Scope' activity.
...
- **THEN** The 'View Consent Scope' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
