...
it reflects my current preferences

## Source Traceability

- **Source Use Case:** `UC-Participant-Consent-4`
- **Source Scope:** Scope – Consent
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Modify an existing consent so that it reflects my current preferences.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Update My Consent Preferences
Harmonia SHALL support **Update My Consent Preferences** so that it reflects my current preferences.

#### Scenario: Update My Consent Preferences - successful outcome
...
- **WHEN** The actor needs to perform the 'Update My Consent Preferences' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Update My Consent Preferences' activity.
...
- **THEN** The 'Update My Consent Preferences' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
