# Verify Permission to Contribute Information

## Purpose

I comply with participant preferences

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-10`
- **Source Scope:** Scope - Information Sharing
- **Primary Actor:** External ClinicianProvider (Specialist)
- **Supporting Actors:** Provider Directory
- **User Story:** Confirm that I am authorised to contribute clinical information to the participant's shared record so that I comply with participant preferences.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Verify Permission to Contribute Information
Harmonia SHALL support **Verify Permission to Contribute Information** so that I comply with participant preferences.

#### Scenario: Verify Permission to Contribute Information - successful outcome
...
- **WHEN** The actor needs to perform the 'Verify Permission to Contribute Information' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (Specialist) initiates the 'Verify Permission to Contribute Information' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** External ClinicianProvider (Specialist) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Verify Permission to Contribute Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is External ClinicianProvider (Specialist)
