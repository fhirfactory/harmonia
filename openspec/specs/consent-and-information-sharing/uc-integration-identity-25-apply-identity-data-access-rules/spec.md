# Apply Identity Data Access Rules

## Purpose

only permitted identity information is exchanged

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-25`
...
- **User Story:** Apply identity data access rules so that only permitted identity information is exchanged.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Apply Identity Data Access Rules
Harmonia SHALL support **Apply Identity Data Access Rules** so that only permitted identity information is exchanged.

#### Scenario: Apply Identity Data Access Rules - successful outcome
...
- **WHEN** The actor needs to perform the 'Apply Identity Data Access Rules' activity, or an authorised business process initiates the activity.
- **THEN** Integration Service / Integration Platform initiates the 'Apply Identity Data Access Rules' activity.
...
- **THEN** The 'Apply Identity Data Access Rules' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
