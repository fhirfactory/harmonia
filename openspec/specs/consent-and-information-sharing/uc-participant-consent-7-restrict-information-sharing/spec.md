...
- **Source Use Case:** `UC-Participant-Consent-7`
- **Source Scope:** Scope – Consent
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Limit which information can be shared so that only appropriate information is disclosed.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Restrict Information Sharing
Harmonia SHALL support **Restrict Information Sharing** so that only appropriate information is disclosed.

#### Scenario: Restrict Information Sharing - successful outcome
...
- **WHEN** The actor needs to perform the 'Restrict Information Sharing' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Restrict Information Sharing' activity.
...
- **THEN** The 'Restrict Information Sharing' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
