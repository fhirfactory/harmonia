# Request Renewal of Consent

## Purpose

I can continue to provide care

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-8`
...
- **User Story:** Request renewal of an expiring consent so that I can continue to provide care.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Request Renewal of Consent
Harmonia SHALL support **Request Renewal of Consent** so that I can continue to provide care.

#### Scenario: Request Renewal of Consent - successful outcome
...
- **WHEN** The actor needs to perform the 'Request Renewal of Consent' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (Specialist) initiates the 'Request Renewal of Consent' activity.
...
- **THEN** The 'Request Renewal of Consent' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
