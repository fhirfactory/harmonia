# Receive Consent Alerts

## Purpose

I avoid unauthorised access

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-15`
...
- **User Story:** Receive alerts when I attempt to access information outside the participant's consent so that I avoid unauthorised access.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Consent Alerts
Harmonia SHALL support **Receive Consent Alerts** so that I avoid unauthorised access.

#### Scenario: Receive Consent Alerts - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Consent Alerts' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (General Practitioner) initiates the 'Receive Consent Alerts' activity.
...
- **THEN** The 'Receive Consent Alerts' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
