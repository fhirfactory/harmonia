...
I can support their ongoing care

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-5`
...
- **User Story:** Request the participant's consent to access their public health information so that I can support their ongoing care.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Request Participant Consent
Harmonia SHALL support **Request Participant Consent** so that I can support their ongoing care.

#### Scenario: Request Participant Consent - successful outcome
...
- **WHEN** The actor needs to perform the 'Request Participant Consent' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (General Practitioner) initiates the 'Request Participant Consent' activity.
...
- **THEN** The 'Request Participant Consent' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
