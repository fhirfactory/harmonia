...
ongoing care remains appropriately authorised

## Source Traceability

- **Source Use Case:** `UC-Clinician-Consent-13`
...
- **User Story:** Request renewal of an expiring consent so that ongoing care remains appropriately authorised.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Request Consent Renewal
Harmonia SHALL support **Request Consent Renewal** so that ongoing care remains appropriately authorised.

#### Scenario: Request Consent Renewal - successful outcome
...
- **WHEN** The actor needs to perform the 'Request Consent Renewal' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Treating Clinician) initiates the 'Request Consent Renewal' activity.
...
- **THEN** The 'Request Consent Renewal' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
