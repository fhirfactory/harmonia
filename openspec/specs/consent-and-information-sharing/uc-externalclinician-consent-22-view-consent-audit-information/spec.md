# View Consent Audit Information

## Purpose

I can demonstrate compliance with privacy obligations

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-22`
...
- **User Story:** View evidence that consent has been obtained so that I can demonstrate compliance with privacy obligations.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View Consent Audit Information
Harmonia SHALL support **View Consent Audit Information** so that I can demonstrate compliance with privacy obligations.

#### Scenario: View Consent Audit Information - successful outcome
...
- **WHEN** The actor needs to perform the 'View Consent Audit Information' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (General Practitioner) initiates the 'View Consent Audit Information' activity.
...
- **THEN** The 'View Consent Audit Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
