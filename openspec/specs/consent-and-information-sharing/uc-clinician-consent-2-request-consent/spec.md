...
care is delivered lawfully and ethically

## Source Traceability

- **Source Use Case:** `UC-Clinician-Consent-2`
...
- **User Story:** Request a participant's consent before providing treatment or disclosing information so that care is delivered lawfully and ethically.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Request Consent
Harmonia SHALL support **Request Consent** so that care is delivered lawfully and ethically.

#### Scenario: Request Consent - successful outcome
...
- **WHEN** The actor needs to perform the 'Request Consent' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Treating Clinician) initiates the 'Request Consent' activity.
...
- **THEN** The 'Request Consent' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
