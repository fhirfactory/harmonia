# Receive Consent Renewal Requests

## Purpose

I can renew or update it if required

## Source Traceability

- **Source Use Case:** `UC-Participant-Consent-17`
- **Source Scope:** Scope – Consent
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Be notified when a consent is about to expire so that I can renew or update it if required.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Consent Renewal Requests
Harmonia SHALL support **Receive Consent Renewal Requests** so that I can renew or update it if required.

#### Scenario: Receive Consent Renewal Requests - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Consent Renewal Requests' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Receive Consent Renewal Requests' activity.
...
- **THEN** The 'Receive Consent Renewal Requests' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
