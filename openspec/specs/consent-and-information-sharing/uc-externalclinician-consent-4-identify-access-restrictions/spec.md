...
I respect the participant's privacy preferences

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-4`
- **Source Scope:** Scope - Clinician Access to Participant Information
- **Primary Actor:** External ClinicianProvider (Community Health Clinician)
- **Supporting Actors:** Provider Directory
- **User Story:** Identify information that has been excluded from my access so that I respect the participant's privacy preferences.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identify Access Restrictions
Harmonia SHALL support **Identify Access Restrictions** so that I respect the participant's privacy preferences.

#### Scenario: Identify Access Restrictions - successful outcome
...
- **WHEN** The actor needs to perform the 'Identify Access Restrictions' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (Community Health Clinician) initiates the 'Identify Access Restrictions' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** External ClinicianProvider (Community Health Clinician) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Identify Access Restrictions' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is External ClinicianProvider (Community Health Clinician)
