# Verify Information Sharing Consent
...
- **Source Use Case:** `UC-Clinician-Consent-17`
...
- **User Story:** Confirm that information sharing is authorised before sending participant information to another organisation so that privacy obligations are met.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Verify Information Sharing Consent
Harmonia SHALL support **Verify Information Sharing Consent** so that privacy obligations are met.

#### Scenario: Verify Information Sharing Consent - successful outcome
...
- **WHEN** The actor needs to perform the 'Verify Information Sharing Consent' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Treating Clinician) initiates the 'Verify Information Sharing Consent' activity.
...
- **THEN** The 'Verify Information Sharing Consent' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
