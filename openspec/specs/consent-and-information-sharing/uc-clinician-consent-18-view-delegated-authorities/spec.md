# View Delegated Authorities

## Purpose

I engage the appropriate decision maker

## Source Traceability

- **Source Use Case:** `UC-Clinician-Consent-18`
...
- **User Story:** Identify participants who are authorised to make decisions on behalf of another participant so that I engage the appropriate decision maker.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View Delegated Authorities
Harmonia SHALL support **View Delegated Authorities** so that I engage the appropriate decision maker.

#### Scenario: View Delegated Authorities - successful outcome
...
- **WHEN** The actor needs to perform the 'View Delegated Authorities' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Treating Clinician) initiates the 'View Delegated Authorities' activity.
...
- **THEN** The 'View Delegated Authorities' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
