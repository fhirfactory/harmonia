# Mask Restricted Identity Information
...
- **Source Use Case:** `UC-Integration-Identity-26`
...
- **User Story:** Mask restricted identity attributes so that sensitive information is protected.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Mask Restricted Identity Information
Harmonia SHALL support **Mask Restricted Identity Information** so that sensitive information is protected.

#### Scenario: Mask Restricted Identity Information - successful outcome
...
- **WHEN** The actor needs to perform the 'Mask Restricted Identity Information' activity, or an authorised business process initiates the activity.
- **THEN** Integration Service / Integration Platform initiates the 'Mask Restricted Identity Information' activity.
...
- **THEN** The 'Mask Restricted Identity Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
