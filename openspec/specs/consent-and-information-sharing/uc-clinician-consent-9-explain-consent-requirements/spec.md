...
- **Source Use Case:** `UC-Clinician-Consent-9`
...
- **User Story:** Provide participants with information about a proposed treatment or information use so that they can make an informed decision.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Explain Consent Requirements
Harmonia SHALL support **Explain Consent Requirements** so that they can make an informed decision.

#### Scenario: Explain Consent Requirements - successful outcome
...
- **WHEN** The actor needs to perform the 'Explain Consent Requirements' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Treating Clinician) initiates the 'Explain Consent Requirements' activity.
...
- **THEN** The 'Explain Consent Requirements' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
