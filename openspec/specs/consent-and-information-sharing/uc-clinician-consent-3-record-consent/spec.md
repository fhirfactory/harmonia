...
their decision is available to other authorised healthcare providers

## Source Traceability

- **Source Use Case:** `UC-Clinician-Consent-3`
...
- **User Story:** Record a participant's consent so that their decision is available to other authorised healthcare providers.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Record Consent
Harmonia SHALL support **Record Consent** so that their decision is available to other authorised healthcare providers.

#### Scenario: Record Consent - successful outcome
...
- **WHEN** The actor needs to perform the 'Record Consent' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Treating Clinician) initiates the 'Record Consent' activity.
...
- **THEN** The 'Record Consent' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
