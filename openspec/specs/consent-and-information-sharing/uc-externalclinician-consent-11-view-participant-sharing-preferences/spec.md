# View Participant Sharing Preferences

## Purpose

I only disclose information as authorised

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-11`
- **Source Scope:** Scope - Information Sharing
- **Primary Actor:** External ClinicianProvider (Physiotherapist)
- **Supporting Actors:** Provider Directory
- **User Story:** Understand the participant's information sharing preferences so that I only disclose information as authorised.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View Participant Sharing Preferences
Harmonia SHALL support **View Participant Sharing Preferences** so that I only disclose information as authorised.

#### Scenario: View Participant Sharing Preferences - successful outcome
...
- **WHEN** The actor needs to perform the 'View Participant Sharing Preferences' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (Physiotherapist) initiates the 'View Participant Sharing Preferences' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** External ClinicianProvider (Physiotherapist) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'View Participant Sharing Preferences' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is External ClinicianProvider (Physiotherapist)
