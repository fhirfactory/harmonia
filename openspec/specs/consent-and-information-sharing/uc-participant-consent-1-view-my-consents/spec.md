...
I understand what I have authorised

## Source Traceability

- **Source Use Case:** `UC-Participant-Consent-1`
- **Source Scope:** Scope – Consent
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** View the consents that I have provided so that I understand what I have authorised.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View My Consents
Harmonia SHALL support **View My Consents** so that I understand what I have authorised.

#### Scenario: View My Consents - successful outcome
...
- **WHEN** The actor needs to perform the 'View My Consents' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'View My Consents' activity.
...
- **THEN** The 'View My Consents' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
