...
my care can be coordinated

## Source Traceability

- **Source Use Case:** `UC-Participant-Consent-14`
- **Source Scope:** Scope – Consent
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Provide consent for my information to be shared with other healthcare providers so that my care can be coordinated.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Consent to Information Sharing
Harmonia SHALL support **Consent to Information Sharing** so that my care can be coordinated.

#### Scenario: Consent to Information Sharing - successful outcome
...
- **WHEN** The actor needs to perform the 'Consent to Information Sharing' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Consent to Information Sharing' activity.
...
- **THEN** The 'Consent to Information Sharing' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
