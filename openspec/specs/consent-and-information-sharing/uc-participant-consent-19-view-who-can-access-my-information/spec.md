# View Who Can Access My Information

## Purpose

I understand who can view my records

## Source Traceability

- **Source Use Case:** `UC-Participant-Consent-19`
- **Source Scope:** Scope – Consent
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** See who is currently authorised to access my information so that I understand who can view my records.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View Who Can Access My Information
Harmonia SHALL support **View Who Can Access My Information** so that I understand who can view my records.

#### Scenario: View Who Can Access My Information - successful outcome
...
- **WHEN** The actor needs to perform the 'View Who Can Access My Information' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'View Who Can Access My Information' activity.
...
- **THEN** The 'View Who Can Access My Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
