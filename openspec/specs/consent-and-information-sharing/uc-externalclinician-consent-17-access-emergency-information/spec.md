...
I can safely treat the participant

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-17`
- **Source Scope:** Scope - Clinical Decision Support (Consent)
- **Primary Actor:** External ClinicianProvider (Urgent Care Clinician)
- **Supporting Actors:** Provider Directory
- **User Story:** Access essential emergency information where permitted so that I can safely treat the participant.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Access Emergency Information
Harmonia SHALL support **Access Emergency Information** so that I can safely treat the participant.

#### Scenario: Access Emergency Information - successful outcome
...
- **WHEN** The actor needs to perform the 'Access Emergency Information' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (Urgent Care Clinician) initiates the 'Access Emergency Information' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** External ClinicianProvider (Urgent Care Clinician) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Access Emergency Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is External ClinicianProvider (Urgent Care Clinician)
