# Understand Access Decisions

## Purpose

I know whether additional participant consent is required

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-16`
- **Source Scope:** Scope - Clinical Decision Support (Consent)
- **Primary Actor:** External ClinicianProvider (Rehabilitation Clinician)
- **Supporting Actors:** Provider Directory
- **User Story:** Understand why access to information has been denied so that I know whether additional participant consent is required.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Understand Access Decisions
Harmonia SHALL support **Understand Access Decisions** so that I know whether additional participant consent is required.

#### Scenario: Understand Access Decisions - successful outcome
...
- **WHEN** The actor needs to perform the 'Understand Access Decisions' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (Rehabilitation Clinician) initiates the 'Understand Access Decisions' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** External ClinicianProvider (Rehabilitation Clinician) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Understand Access Decisions' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is External ClinicianProvider (Rehabilitation Clinician)
