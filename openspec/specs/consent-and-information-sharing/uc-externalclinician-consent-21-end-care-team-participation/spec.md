# End Care Team Participation

## Purpose

my ongoing access can be reviewed

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-21`
- **Source Scope:** Scope - Care Coordination (Consent)
- **Primary Actor:** External ClinicianProvider (Rehabilitation Provider)
- **Supporting Actors:** Provider Directory
- **User Story:** Indicate that my involvement in the participant's care has concluded so that my ongoing access can be reviewed.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: End Care Team Participation
Harmonia SHALL support **End Care Team Participation** so that my ongoing access can be reviewed.

#### Scenario: End Care Team Participation - successful outcome
...
- **WHEN** The actor needs to perform the 'End Care Team Participation' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (Rehabilitation Provider) initiates the 'End Care Team Participation' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** External ClinicianProvider (Rehabilitation Provider) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'End Care Team Participation' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is External ClinicianProvider (Rehabilitation Provider)
