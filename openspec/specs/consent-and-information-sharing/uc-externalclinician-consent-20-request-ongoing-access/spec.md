...
repeated consent requests are minimised

## Source Traceability

- **Source Use Case:** `UC-ExternalClinician-Consent-20`
...
- **User Story:** Request ongoing access while I remain involved in the participant's care so that repeated consent requests are minimised.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Request Ongoing Access
Harmonia SHALL support **Request Ongoing Access** so that repeated consent requests are minimised.

#### Scenario: Request Ongoing Access - successful outcome
...
- **WHEN** The actor needs to perform the 'Request Ongoing Access' activity, or an authorised business process initiates the activity.
- **THEN** External ClinicianProvider (Specialist) initiates the 'Request Ongoing Access' activity.
...
- **THEN** The 'Request Ongoing Access' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
