# Identify Expired Consents

## Purpose

they can be renewed before care proceeds

## Source Traceability

- **Source Use Case:** `UC-Clinician-Consent-12`
...
- **User Story:** Identify consents that have expired or are about to expire so that they can be renewed before care proceeds.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identify Expired Consents
Harmonia SHALL support **Identify Expired Consents** so that they can be renewed before care proceeds.

#### Scenario: Identify Expired Consents - successful outcome
...
- **WHEN** The actor needs to perform the 'Identify Expired Consents' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Treating Clinician) initiates the 'Identify Expired Consents' activity.
...
- **THEN** The 'Identify Expired Consents' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
