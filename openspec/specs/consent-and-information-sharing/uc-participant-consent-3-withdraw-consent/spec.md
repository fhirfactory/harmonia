...
my information is no longer used for that purpose

## Source Traceability

- **Source Use Case:** `UC-Participant-Consent-3`
- **Source Scope:** Scope – Consent
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Withdraw a previously granted consent so that my information is no longer used for that purpose.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Withdraw Consent
Harmonia SHALL support **Withdraw Consent** so that my information is no longer used for that purpose.

#### Scenario: Withdraw Consent - successful outcome
...
- **WHEN** The actor needs to perform the 'Withdraw Consent' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Withdraw Consent' activity.
...
- **THEN** The 'Withdraw Consent' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
