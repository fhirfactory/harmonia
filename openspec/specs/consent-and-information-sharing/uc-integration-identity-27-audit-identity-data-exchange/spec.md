# Audit Identity Data Exchange

## Purpose

identity access and sharing can be monitored

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-27`
...
- **User Story:** Record identity data exchanges so that identity access and sharing can be monitored.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Audit Identity Data Exchange
Harmonia SHALL support **Audit Identity Data Exchange** so that identity access and sharing can be monitored.

#### Scenario: Audit Identity Data Exchange - successful outcome
...
- **WHEN** The actor needs to perform the 'Audit Identity Data Exchange' activity, or an authorised business process initiates the activity.
- **THEN** Reporting / Audit Service initiates the 'Audit Identity Data Exchange' activity.
...
- **THEN** The 'Audit Identity Data Exchange' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
