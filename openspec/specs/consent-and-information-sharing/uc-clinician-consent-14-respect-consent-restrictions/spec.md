...
I only access or disclose information as authorised

## Source Traceability

- **Source Use Case:** `UC-Clinician-Consent-14`
...
- **User Story:** the system to identify consent restrictions applicable to a participant so that I only access or disclose information as authorised.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Respect Consent Restrictions
Harmonia SHALL support **Respect Consent Restrictions** so that I only access or disclose information as authorised.

#### Scenario: Respect Consent Restrictions - successful outcome
...
- **WHEN** The actor needs to perform the 'Respect Consent Restrictions' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Treating Clinician) initiates the 'Respect Consent Restrictions' activity.
...
- **THEN** The 'Respect Consent Restrictions' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
