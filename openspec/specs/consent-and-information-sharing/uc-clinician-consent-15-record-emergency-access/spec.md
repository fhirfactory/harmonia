...
- **Source Use Case:** `UC-Clinician-Consent-15`
- **Source Scope:** Scope - Consent – Internal Clinicians
- **Primary Actor:** Clinician (Emergency Clinician)
- **Supporting Actors:** Provider Directory
- **User Story:** Document when emergency access overrides normal consent requirements so that the decision is transparent and auditable.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Record Emergency Access
Harmonia SHALL support **Record Emergency Access** so that the decision is transparent and auditable.
...
- **THEN** Clinician (Emergency Clinician) initiates the 'Record Emergency Access' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Clinician (Emergency Clinician) enters, selects, reviews or confirms the relevant information.
...
- **GIVEN** the primary actor is Clinician (Emergency Clinician)
