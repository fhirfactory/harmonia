# Maintain Data Ownership Information
...
- **Source Use Case:** `UC-DepartmentalOfficer-ReferenceData-10`
- **Source Scope:** Scope - Governance and Approval
- **Primary Actor:** Data Steward
- **Supporting Actors:** Provider Directory
- **User Story:** Record ownership and accountability for reference data sets so that responsibilities are clear.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Maintain Data Ownership Information
Harmonia SHALL support **Maintain Data Ownership Information** so that responsibilities are clear.

#### Scenario: Maintain Data Ownership Information - successful outcome
...
- **WHEN** The actor needs to perform the 'Maintain Data Ownership Information' activity, or an authorised business process initiates the activity.
- **THEN** Data Steward initiates the 'Maintain Data Ownership Information' activity.
...
- **THEN** The 'Maintain Data Ownership Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
