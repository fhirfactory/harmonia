# Identify Duplicate Reference Values
...
- **Source Use Case:** `UC-DepartmentalOfficer-ReferenceData-16`
- **Source Scope:** Scope - Data Quality and Compliance
- **Primary Actor:** Data Steward
- **Supporting Actors:** Provider Directory
- **User Story:** Identify duplicate reference values so that conflicting definitions are removed.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identify Duplicate Reference Values
Harmonia SHALL support **Identify Duplicate Reference Values** so that conflicting definitions are removed.

#### Scenario: Identify Duplicate Reference Values - successful outcome
...
- **WHEN** The actor needs to perform the 'Identify Duplicate Reference Values' activity, or an authorised business process initiates the activity.
- **THEN** Data Steward initiates the 'Identify Duplicate Reference Values' activity.
...
- **THEN** The 'Identify Duplicate Reference Values' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
