...
duplicate records can be reviewed and consolidated

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-6`
- **Source Scope:** Scope - Patient / Related Person Identity
- **Primary Actor:** Data Steward (Data Quality)
- **Supporting Actors:** Provider Directory
- **User Story:** Identify potential duplicate patient identities so that duplicate records can be reviewed and consolidated.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Duplicate Identity Detection
Harmonia SHALL support **Duplicate Identity Detection** so that duplicate records can be reviewed and consolidated.

#### Scenario: Duplicate Identity Detection - successful outcome
...
- **WHEN** The actor needs to perform the 'Duplicate Identity Detection' activity, or an authorised business process initiates the activity.
- **THEN** Data Steward (Data Quality) initiates the 'Duplicate Identity Detection' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Data Steward (Data Quality) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Duplicate Identity Detection' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Data Steward (Data Quality)
