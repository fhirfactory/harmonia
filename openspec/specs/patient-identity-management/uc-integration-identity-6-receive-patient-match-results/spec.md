# Receive Patient Match Results

## Purpose

I can associate my local record with the correct patient identity

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-6`
...
- **User Story:** Receive patient identity match results so that I can associate my local record with the correct patient identity.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Patient Match Results
Harmonia SHALL support **Receive Patient Match Results** so that I can associate my local record with the correct patient identity.

#### Scenario: Receive Patient Match Results - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Patient Match Results' activity, or an authorised business process initiates the activity.
- **THEN** Clinical / Healthcare Application initiates the 'Receive Patient Match Results' activity.
...
- **THEN** The 'Receive Patient Match Results' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
