...
the participant's record remains current

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-18`
...
- **User Story:** Relinquish my representative role when I am no longer authorised or willing to act so that the participant's record remains current.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Relinquish My Authority
Harmonia SHALL support **Relinquish My Authority** so that the participant's record remains current.

#### Scenario: Relinquish My Authority - successful outcome
...
- **WHEN** The actor needs to perform the 'Relinquish My Authority' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Power of Attorney) initiates the 'Relinquish My Authority' activity.
...
- **THEN** The 'Relinquish My Authority' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
