...
I can demonstrate compliance and investigate historical changes

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-12`
...
- **User Story:** Review the audit history of changes made to Patient identity records so that I can demonstrate compliance and investigate historical changes.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identity Audit Review
Harmonia SHALL support **Identity Audit Review** so that I can demonstrate compliance and investigate historical changes.

#### Scenario: Identity Audit Review - successful outcome
...
- **WHEN** The actor needs to perform the 'Identity Audit Review' activity, or an authorised business process initiates the activity.
- **THEN** Reporting / Audit Officer initiates the 'Identity Audit Review' activity.
...
- **THEN** The 'Identity Audit Review' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
