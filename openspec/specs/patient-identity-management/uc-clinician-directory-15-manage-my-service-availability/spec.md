# Manage My Service Availability

## Purpose

referrers understand my availability

## Source Traceability

- **Source Use Case:** `UC-Clinician-Directory-15`
- **Source Scope:** Scope - Clinician Relationships / Roles
- **Primary Actor:** Clinician (Registered)
- **Supporting Actors:** Provider Directory
- **User Story:** Indicate when I am accepting referrals or new participants so that referrers understand my availability.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage My Service Availability
Harmonia SHALL support **Manage My Service Availability** so that referrers understand my availability.

#### Scenario: Manage My Service Availability - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage My Service Availability' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Registered) initiates the 'Manage My Service Availability' activity.
...
- **THEN** The 'Manage My Service Availability' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
