# Complete My Demographic Profile

## Purpose

healthcare providers have the information needed to deliver appropriate services

## Source Traceability

- **Source Use Case:** `UC-Participant-Demographics-29`
- **Source Scope:** Scope – Participant Demographics
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Complete any missing demographic information so that healthcare providers have the information needed to deliver appropriate services.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Complete My Demographic Profile
Harmonia SHALL support **Complete My Demographic Profile** so that healthcare providers have the information needed to deliver appropriate services.

#### Scenario: Complete My Demographic Profile - successful outcome
...
- **WHEN** The actor needs to perform the 'Complete My Demographic Profile' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Complete My Demographic Profile' activity.
...
- **THEN** The 'Complete My Demographic Profile' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **WHEN** This section contains 20 use case(s) associated with the 'Patients' grouping in the source workbook.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state
