...
I receive information according to my preferences

## Source Traceability

- **Source Use Case:** `UC-Participant-Demographics-16`
- **Source Scope:** Scope – Participant Demographics
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Manage my communication preferences, including consent to receive electronic communications, so that I receive information according to my preferences.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage My Communication Preferences
Harmonia SHALL support **Manage My Communication Preferences** so that I receive information according to my preferences.
...
- **THEN** Participant / Patient initiates the 'Manage My Communication Preferences' activity.
