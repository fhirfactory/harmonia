...
healthcare providers can contact me when required

## Source Traceability

- **Source Use Case:** `UC-Participant-Identity-7`
- **Source Scope:** Scope - Identity
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Update my address, phone number and email so that healthcare providers can contact me when required.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Update Contact Information
Harmonia SHALL support **Update Contact Information** so that healthcare providers can contact me when required.

#### Scenario: Update Contact Information - successful outcome
...
- **WHEN** The actor needs to perform the 'Update Contact Information' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Update Contact Information' activity.
...
- **THEN** The 'Update Contact Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
