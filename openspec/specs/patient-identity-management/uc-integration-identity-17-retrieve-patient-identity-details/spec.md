# Retrieve Patient Identity Details

## Purpose

I can display or process accurate patient information

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-17`
...
- **User Story:** Retrieve patient identity details so that I can display or process accurate patient information.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Retrieve Patient Identity Details
Harmonia SHALL support **Retrieve Patient Identity Details** so that I can display or process accurate patient information.

#### Scenario: Retrieve Patient Identity Details - successful outcome
...
- **WHEN** The actor needs to perform the 'Retrieve Patient Identity Details' activity, or an authorised business process initiates the activity.
- **THEN** Downstream Consumer System System initiates the 'Retrieve Patient Identity Details' activity.
...
- **THEN** The 'Retrieve Patient Identity Details' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
