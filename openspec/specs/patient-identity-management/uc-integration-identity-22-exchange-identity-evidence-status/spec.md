# Exchange Identity Evidence Status

## Purpose

systems understand the level of identity assurance achieved

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-22`
- **Source Scope:** Scope - Identity Verification and Assurance
- **Primary Actor:** Provider Identity / Matching Service
- **Supporting Actors:** Provider Directory
- **User Story:** Exchange identity evidence status so that systems understand the level of identity assurance achieved.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Exchange Identity Evidence Status
Harmonia SHALL support **Exchange Identity Evidence Status** so that systems understand the level of identity assurance achieved.

#### Scenario: Exchange Identity Evidence Status - successful outcome
...
- **WHEN** The actor needs to perform the 'Exchange Identity Evidence Status' activity, or an authorised business process initiates the activity.
- **THEN** Provider Identity / Matching Service initiates the 'Exchange Identity Evidence Status' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Provider Identity / Matching Service enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Exchange Identity Evidence Status' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Provider Identity / Matching Service
