# Request a Relationship Update

## Purpose

it accurately reflects my current legal authority or responsibilities

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-5`
- **Source Scope:** Scope – Relationships
- **Primary Actor:** Related Person / Representative (Guardian)
- **Supporting Actors:** Provider Directory
- **User Story:** Request updates to my relationship information so that it accurately reflects my current legal authority or responsibilities.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Request a Relationship Update
Harmonia SHALL support **Request a Relationship Update** so that it accurately reflects my current legal authority or responsibilities.

#### Scenario: Request a Relationship Update - successful outcome
...
- **WHEN** The actor needs to perform the 'Request a Relationship Update' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Guardian) initiates the 'Request a Relationship Update' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Related Person / Representative (Guardian) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Request a Relationship Update' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Related Person / Representative (Guardian)
