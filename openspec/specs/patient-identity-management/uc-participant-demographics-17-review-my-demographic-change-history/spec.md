# Review My Demographic Change History

## Purpose

I can verify updates and identify any unauthorised changes

## Source Traceability

- **Source Use Case:** `UC-Participant-Demographics-17`
- **Source Scope:** Scope – Participant Demographics
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Review changes made to my demographic information so that I can verify updates and identify any unauthorised changes.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Review My Demographic Change History
Harmonia SHALL support **Review My Demographic Change History** so that I can verify updates and identify any unauthorised changes.

#### Scenario: Review My Demographic Change History - successful outcome
...
- **WHEN** The actor needs to perform the 'Review My Demographic Change History' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Review My Demographic Change History' activity.
...
- **THEN** The 'Review My Demographic Change History' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
