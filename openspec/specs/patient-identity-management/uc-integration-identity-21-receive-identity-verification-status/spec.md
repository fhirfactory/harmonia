# Receive Identity Verification Status

## Purpose

I can determine whether a patient can proceed through a workflow

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-21`
- **Source Scope:** Scope - Identity Verification and Assurance
- **Primary Actor:** Provider Registration System
- **Supporting Actors:** Provider Directory
- **User Story:** Receive identity verification status so that I can determine whether a patient can proceed through a workflow.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Identity Verification Status
Harmonia SHALL support **Receive Identity Verification Status** so that I can determine whether a patient can proceed through a workflow.

#### Scenario: Receive Identity Verification Status - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Identity Verification Status' activity, or an authorised business process initiates the activity.
- **THEN** Provider Registration System initiates the 'Receive Identity Verification Status' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Provider Registration System enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Receive Identity Verification Status' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Provider Registration System
