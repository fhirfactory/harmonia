...
patient information can be exchanged accurately across systems

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-19`
- **Source Scope:** Scope - Patient / Related Person Identity
- **Primary Actor:** Health Information Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Link a Patient identity with external healthcare identifiers where authorised so that patient information can be exchanged accurately across systems.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identity Linkage
Harmonia SHALL support **Identity Linkage** so that patient information can be exchanged accurately across systems.

#### Scenario: Identity Linkage - successful outcome
...
- **WHEN** The actor needs to perform the 'Identity Linkage' activity, or an authorised business process initiates the activity.
- **THEN** Health Information Officer initiates the 'Identity Linkage' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Health Information Officer enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Identity Linkage' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Health Information Officer
