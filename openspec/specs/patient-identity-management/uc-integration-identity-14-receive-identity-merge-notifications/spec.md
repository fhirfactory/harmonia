# Receive Identity Merge Notifications

## Purpose

duplicate records can be consolidated

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-14`
...
- **User Story:** Receive patient identity merge notifications so that duplicate records can be consolidated.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Identity Merge Notifications
Harmonia SHALL support **Receive Identity Merge Notifications** so that duplicate records can be consolidated.

#### Scenario: Receive Identity Merge Notifications - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Identity Merge Notifications' activity, or an authorised business process initiates the activity.
- **THEN** Clinical / Healthcare Application initiates the 'Receive Identity Merge Notifications' activity.
...
- **THEN** The 'Receive Identity Merge Notifications' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
