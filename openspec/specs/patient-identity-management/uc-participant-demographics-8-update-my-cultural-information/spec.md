# Update My Cultural Information

## Purpose

healthcare providers can deliver culturally appropriate services

## Source Traceability

- **Source Use Case:** `UC-Participant-Demographics-8`
- **Source Scope:** Scope – Participant Demographics
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Update my cultural and community information so that healthcare providers can deliver culturally appropriate services.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Update My Cultural Information
Harmonia SHALL support **Update My Cultural Information** so that healthcare providers can deliver culturally appropriate services.

#### Scenario: Update My Cultural Information - successful outcome
...
- **WHEN** The actor needs to perform the 'Update My Cultural Information' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Update My Cultural Information' activity.
...
- **THEN** The 'Update My Cultural Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
