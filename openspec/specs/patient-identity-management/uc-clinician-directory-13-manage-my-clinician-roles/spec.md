# Manage My Clinician Roles

## Purpose

my responsibilities are accurately represented

## Source Traceability

- **Source Use Case:** `UC-Clinician-Directory-13`
- **Source Scope:** Scope - Clinician Relationships / Roles
- **Primary Actor:** Clinician (Registered)
- **Supporting Actors:** Provider Directory
- **User Story:** Maintain my roles within each organisation so that my responsibilities are accurately represented.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage My Clinician Roles
Harmonia SHALL support **Manage My Clinician Roles** so that my responsibilities are accurately represented.

#### Scenario: Manage My Clinician Roles - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage My Clinician Roles' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Registered) initiates the 'Manage My Clinician Roles' activity.
...
- **THEN** The 'Manage My Clinician Roles' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
