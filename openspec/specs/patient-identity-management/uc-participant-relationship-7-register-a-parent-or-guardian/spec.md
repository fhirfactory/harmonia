...
appropriate decision-making authority is recognised

## Source Traceability

- **Source Use Case:** `UC-Participant-Relationship-7`
- **Source Scope:** Scope – Participant Relationships
- **Primary Actor:** Participant / Patient or Related Person / Representative
- **Supporting Actors:** Provider Directory
- **User Story:** Record a parent or legal guardian relationship so that appropriate decision-making authority is recognised.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Register a Parent or Guardian
Harmonia SHALL support **Register a Parent or Guardian** so that appropriate decision-making authority is recognised.

#### Scenario: Register a Parent or Guardian - successful outcome
...
- **WHEN** The actor needs to perform the 'Register a Parent or Guardian' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient or Related Person / Representative initiates the 'Register a Parent or Guardian' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Participant / Patient or Related Person / Representative enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Register a Parent or Guardian' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Participant / Patient or Related Person / Representative
