...
I can securely access services

## Source Traceability

- **Source Use Case:** `UC-Participant-Identity-3`
- **Source Scope:** Scope - Identity
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Complete identity verification using approved methods so that I can securely access services.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Confirm My Identity
Harmonia SHALL support **Confirm My Identity** so that I can securely access services.

#### Scenario: Confirm My Identity - successful outcome
...
- **WHEN** The actor needs to perform the 'Confirm My Identity' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Confirm My Identity' activity.
...
- **THEN** The 'Confirm My Identity' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
