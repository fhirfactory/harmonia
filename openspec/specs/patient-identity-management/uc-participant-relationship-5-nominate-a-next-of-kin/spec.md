# Nominate a Next of Kin

## Purpose

healthcare providers know who should be contacted when appropriate

## Source Traceability

- **Source Use Case:** `UC-Participant-Relationship-5`
- **Source Scope:** Scope – Participant Relationships
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Nominate my next of kin so that healthcare providers know who should be contacted when appropriate.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Nominate a Next of Kin
Harmonia SHALL support **Nominate a Next of Kin** so that healthcare providers know who should be contacted when appropriate.

#### Scenario: Nominate a Next of Kin - successful outcome
...
- **WHEN** The actor needs to perform the 'Nominate a Next of Kin' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Nominate a Next of Kin' activity.
...
- **THEN** The 'Nominate a Next of Kin' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
