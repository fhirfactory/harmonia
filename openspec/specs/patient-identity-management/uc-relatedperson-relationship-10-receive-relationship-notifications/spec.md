# Receive Relationship Notifications

## Purpose

I remain informed of my recognised role

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-10`
- **Source Scope:** Scope – Relationships
- **Primary Actor:** Related Person / Representative (Carer)
- **Supporting Actors:** Provider Directory
- **User Story:** Receive notifications when my relationship status changes so that I remain informed of my recognised role.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Relationship Notifications
Harmonia SHALL support **Receive Relationship Notifications** so that I remain informed of my recognised role.

#### Scenario: Receive Relationship Notifications - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Relationship Notifications' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Carer) initiates the 'Receive Relationship Notifications' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Related Person / Representative (Carer) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Receive Relationship Notifications' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Related Person / Representative (Carer)
