# Acknowledge My Responsibilities
...
- **Source Use Case:** `UC-RelatedPerson-Relationship-14`
- **Source Scope:** Scope – Relationships
- **Primary Actor:** Related Person / Representative (Guardian)
- **Supporting Actors:** Provider Directory
- **User Story:** Acknowledge my responsibilities associated with my role so that I understand my obligations.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Acknowledge My Responsibilities
Harmonia SHALL support **Acknowledge My Responsibilities** so that I understand my obligations.

#### Scenario: Acknowledge My Responsibilities - successful outcome
...
- **WHEN** The actor needs to perform the 'Acknowledge My Responsibilities' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Guardian) initiates the 'Acknowledge My Responsibilities' activity.
...
- **THEN** The 'Acknowledge My Responsibilities' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
