# Review Identity Change History

## Purpose

I understand what has been updated and when

## Source Traceability

- **Source Use Case:** `UC-Participant-Identity-14`
- **Source Scope:** Scope - Identity
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** View a history of changes made to my identity information so that I understand what has been updated and when.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Review Identity Change History
Harmonia SHALL support **Review Identity Change History** so that I understand what has been updated and when.

#### Scenario: Review Identity Change History - successful outcome
...
- **WHEN** The actor needs to perform the 'Review Identity Change History' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Review Identity Change History' activity.
...
- **THEN** The 'Review Identity Change History' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
