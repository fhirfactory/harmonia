# Publish Patient Identity Changes

## Purpose

subscribed systems can synchronise their records

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-11`
...
- **User Story:** Publish patient identity changes so that subscribed systems can synchronise their records.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Publish Patient Identity Changes
Harmonia SHALL support **Publish Patient Identity Changes** so that subscribed systems can synchronise their records.

#### Scenario: Publish Patient Identity Changes - successful outcome
...
- **WHEN** The actor needs to perform the 'Publish Patient Identity Changes' activity, or an authorised business process initiates the activity.
- **THEN** Provider Identity / Matching Service initiates the 'Publish Patient Identity Changes' activity.
...
- **THEN** The 'Publish Patient Identity Changes' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
