...
I am not associated with a participant without my consent

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-3`
- **Source Scope:** Scope – Relationships
- **Primary Actor:** Related Person / Representative (Nominated Representative)
- **Supporting Actors:** Provider Directory
- **User Story:** Decline a request to establish a relationship so that I am not associated with a participant without my consent.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Decline a Relationship Request
Harmonia SHALL support **Decline a Relationship Request** so that I am not associated with a participant without my consent.

#### Scenario: Decline a Relationship Request - successful outcome
...
- **WHEN** The actor needs to perform the 'Decline a Relationship Request' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Nominated Representative) initiates the 'Decline a Relationship Request' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Related Person / Representative (Nominated Representative) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Decline a Relationship Request' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Related Person / Representative (Nominated Representative)
