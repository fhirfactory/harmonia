...
I can ensure the patient record is accurate and complete before it is accepted

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-1`
- **Source Scope:** Scope - Patient / Related Person Identity
- **Primary Actor:** Provider Directory Administrator (Registration)
- **Supporting Actors:** Provider Directory
- **User Story:** Validate the identity details provided by a Patient during the registration process so that I can ensure the patient record is accurate and complete before it is accepted.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Patient Identity Validation
Harmonia SHALL support **Patient Identity Validation** so that I can ensure the patient record is accurate and complete before it is accepted.

#### Scenario: Patient Identity Validation - successful outcome
...
- **WHEN** The actor needs to perform the 'Patient Identity Validation' activity, or an authorised business process initiates the activity.
- **THEN** Provider Directory Administrator (Registration) initiates the 'Patient Identity Validation' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Provider Directory Administrator (Registration) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Patient Identity Validation' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Provider Directory Administrator (Registration)
