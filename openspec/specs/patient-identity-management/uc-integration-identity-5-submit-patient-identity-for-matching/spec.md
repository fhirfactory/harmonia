# Submit Patient Identity for Matching

## Purpose

an existing patient record can be identified

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-5`
...
- **User Story:** Submit patient demographic and identity attributes for matching so that an existing patient record can be identified.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Submit Patient Identity for Matching
Harmonia SHALL support **Submit Patient Identity for Matching** so that an existing patient record can be identified.

#### Scenario: Submit Patient Identity for Matching - successful outcome
...
- **WHEN** The actor needs to perform the 'Submit Patient Identity for Matching' activity, or an authorised business process initiates the activity.
- **THEN** Clinical / Healthcare Application initiates the 'Submit Patient Identity for Matching' activity.
...
- **THEN** The 'Submit Patient Identity for Matching' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
