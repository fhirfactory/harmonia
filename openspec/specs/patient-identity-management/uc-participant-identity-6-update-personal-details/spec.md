...
my information remains current

## Source Traceability

- **Source Use Case:** `UC-Participant-Identity-6`
- **Source Scope:** Scope - Identity
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Update my personal identity details, such as my name or date of birth, when my circumstances change so that my information remains current.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Update Personal Details
Harmonia SHALL support **Update Personal Details** so that my information remains current.

#### Scenario: Update Personal Details - successful outcome
...
- **WHEN** The actor needs to perform the 'Update Personal Details' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Update Personal Details' activity.
...
- **THEN** The 'Update Personal Details' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
