...
- **Source Use Case:** `UC-Participant-Identity-10`
- **Source Scope:** Scope - Identity
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** View the identity information held about me so that I can confirm it is accurate.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View My Identity Information
Harmonia SHALL support **View My Identity Information** so that I can confirm it is accurate.

#### Scenario: View My Identity Information - successful outcome
...
- **WHEN** The actor needs to perform the 'View My Identity Information' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'View My Identity Information' activity.
...
- **THEN** The 'View My Identity Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
