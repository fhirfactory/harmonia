# Receive Possible Duplicate Alerts

## Purpose

potential duplicate patient records can be reviewed

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-7`
...
- **User Story:** Receive duplicate identity alerts so that potential duplicate patient records can be reviewed.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Possible Duplicate Alerts
Harmonia SHALL support **Receive Possible Duplicate Alerts** so that potential duplicate patient records can be reviewed.

#### Scenario: Receive Possible Duplicate Alerts - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Possible Duplicate Alerts' activity, or an authorised business process initiates the activity.
- **THEN** Clinical / Healthcare Application initiates the 'Receive Possible Duplicate Alerts' activity.
...
- **THEN** The 'Receive Possible Duplicate Alerts' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
