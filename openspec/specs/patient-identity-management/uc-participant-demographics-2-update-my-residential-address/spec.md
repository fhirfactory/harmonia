...
correspondence and services are directed to the correct location

## Source Traceability

- **Source Use Case:** `UC-Participant-Demographics-2`
- **Source Scope:** Scope – Participant Demographics
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Update my residential address so that correspondence and services are directed to the correct location.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Update My Residential Address
Harmonia SHALL support **Update My Residential Address** so that correspondence and services are directed to the correct location.

#### Scenario: Update My Residential Address - successful outcome
...
- **WHEN** The actor needs to perform the 'Update My Residential Address' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Update My Residential Address' activity.
...
- **THEN** The 'Update My Residential Address' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
