...
I can determine whether it satisfies departmental identity requirements

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-3`
- **Source Scope:** Scope - Patient / Related Person Identity
- **Primary Actor:** Compliance Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Review identity evidence submitted by a Patient so that I can determine whether it satisfies departmental identity requirements.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identity Evidence Review
Harmonia SHALL support **Identity Evidence Review** so that I can determine whether it satisfies departmental identity requirements.

#### Scenario: Identity Evidence Review - successful outcome
...
- **WHEN** The actor needs to perform the 'Identity Evidence Review' activity, or an authorised business process initiates the activity.
- **THEN** Compliance Officer initiates the 'Identity Evidence Review' activity.
...
- **THEN** The 'Identity Evidence Review' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
