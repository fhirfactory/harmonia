...
identity issues can be resolved

## Source Traceability

- **Source Use Case:** `UC-Participant-Identity-8`
- **Source Scope:** Scope - Identity
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Provide additional supporting documentation when requested so that identity issues can be resolved.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Provide Supporting Documentation
Harmonia SHALL support **Provide Supporting Documentation** so that identity issues can be resolved.

#### Scenario: Provide Supporting Documentation - successful outcome
...
- **WHEN** The actor needs to perform the 'Provide Supporting Documentation' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Provide Supporting Documentation' activity.
...
- **THEN** The 'Provide Supporting Documentation' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
