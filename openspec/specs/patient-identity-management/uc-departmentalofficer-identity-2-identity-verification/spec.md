...
I can confirm the individual is who they claim to be

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-2`
- **Source Scope:** Scope - Patient / Related Person Identity
- **Primary Actor:** Data Steward (Identity Verification)
- **Supporting Actors:** Provider Directory
- **User Story:** Verify a Patient's identity against trusted identity sources so that I can confirm the individual is who they claim to be.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identity Verification
Harmonia SHALL support **Identity Verification** so that I can confirm the individual is who they claim to be.

#### Scenario: Identity Verification - successful outcome
...
- **WHEN** The actor needs to perform the 'Identity Verification' activity, or an authorised business process initiates the activity.
- **THEN** Data Steward (Identity Verification) initiates the 'Identity Verification' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Data Steward (Identity Verification) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Identity Verification' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Data Steward (Identity Verification)
