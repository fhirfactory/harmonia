...
I can review how my authorised relationships have changed over time

## Source Traceability

- **Source Use Case:** `UC-Participant-Relationship-20`
- **Source Scope:** Scope – Participant Relationships
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** View the history of relationship changes so that I can review how my authorised relationships have changed over time.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View Relationship History
Harmonia SHALL support **View Relationship History** so that I can review how my authorised relationships have changed over time.
...
- **THEN** Participant / Patient initiates the 'View Relationship History' activity.
...
- **WHEN** Actor – Participant (Related Persons)
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state

#### Scenario: Exception 7
- **WHEN** This section contains 20 use case(s) associated with the 'Related Persons' grouping in the source workbook.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state
