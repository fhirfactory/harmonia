# Receive Identity Risk Indicators

## Purpose

potentially fraudulent identities can be managed appropriately

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-23`
- **Source Scope:** Scope - Identity Verification and Assurance
- **Primary Actor:** Compliance / Fraud Detection Service
- **Supporting Actors:** Provider Directory
- **User Story:** Receive identity risk indicators so that potentially fraudulent identities can be managed appropriately.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Identity Risk Indicators
Harmonia SHALL support **Receive Identity Risk Indicators** so that potentially fraudulent identities can be managed appropriately.

#### Scenario: Receive Identity Risk Indicators - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Identity Risk Indicators' activity, or an authorised business process initiates the activity.
- **THEN** Compliance / Fraud Detection Service initiates the 'Receive Identity Risk Indicators' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Compliance / Fraud Detection Service enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Receive Identity Risk Indicators' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Compliance / Fraud Detection Service
