...
I remain informed throughout the process

## Source Traceability

- **Source Use Case:** `UC-Participant-Identity-11`
- **Source Scope:** Scope - Identity
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Receive notifications about the progress of my identity verification so that I remain informed throughout the process.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Verification Notifications
Harmonia SHALL support **Receive Verification Notifications** so that I remain informed throughout the process.

#### Scenario: Receive Verification Notifications - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Verification Notifications' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Receive Verification Notifications' activity.
...
- **THEN** The 'Receive Verification Notifications' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
