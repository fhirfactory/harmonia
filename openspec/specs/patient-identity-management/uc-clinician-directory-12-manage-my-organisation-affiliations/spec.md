# Manage My Organisation Affiliations

## Purpose

my workplace information is current

## Source Traceability

- **Source Use Case:** `UC-Clinician-Directory-12`
- **Source Scope:** Scope - Clinician Relationships / Roles
- **Primary Actor:** Clinician (Registered)
- **Supporting Actors:** Provider Directory
- **User Story:** Maintain the organisations where I practise so that my workplace information is current.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage My Organisation Affiliations
Harmonia SHALL support **Manage My Organisation Affiliations** so that my workplace information is current.

#### Scenario: Manage My Organisation Affiliations - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage My Organisation Affiliations' activity, or an authorised business process initiates the activity.
- **THEN** Clinician (Registered) initiates the 'Manage My Organisation Affiliations' activity.
...
- **THEN** The 'Manage My Organisation Affiliations' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
