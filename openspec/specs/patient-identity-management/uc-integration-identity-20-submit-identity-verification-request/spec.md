...
identity assurance checks can be performed

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-20`
...
- **User Story:** Request patient identity verification so that identity assurance checks can be performed.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Submit Identity Verification Request
Harmonia SHALL support **Submit Identity Verification Request** so that identity assurance checks can be performed.

#### Scenario: Submit Identity Verification Request - successful outcome
...
- **WHEN** The actor needs to perform the 'Submit Identity Verification Request' activity, or an authorised business process initiates the activity.
- **THEN** Provider Registration System initiates the 'Submit Identity Verification Request' activity.
...
- **THEN** The 'Submit Identity Verification Request' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
