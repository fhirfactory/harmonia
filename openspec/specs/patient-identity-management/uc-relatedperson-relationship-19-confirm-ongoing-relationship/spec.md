...
outdated relationships can be identified

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-19`
...
- **User Story:** Periodically confirm that my relationship with a participant remains current so that outdated relationships can be identified.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Confirm Ongoing Relationship
Harmonia SHALL support **Confirm Ongoing Relationship** so that outdated relationships can be identified.

#### Scenario: Confirm Ongoing Relationship - successful outcome
...
- **WHEN** The actor needs to perform the 'Confirm Ongoing Relationship' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Support Person) initiates the 'Confirm Ongoing Relationship' activity.
...
- **THEN** The 'Confirm Ongoing Relationship' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
