...
I can communicate effectively during my care

## Source Traceability

- **Source Use Case:** `UC-Participant-Demographics-7`
- **Source Scope:** Scope – Participant Demographics
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Indicate that I require an interpreter so that I can communicate effectively during my care.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Request Interpreter Services
Harmonia SHALL support **Request Interpreter Services** so that I can communicate effectively during my care.

#### Scenario: Request Interpreter Services - successful outcome
...
- **WHEN** The actor needs to perform the 'Request Interpreter Services' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Request Interpreter Services' activity.
...
- **THEN** The 'Request Interpreter Services' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
