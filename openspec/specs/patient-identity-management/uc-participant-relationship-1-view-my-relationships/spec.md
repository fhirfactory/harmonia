...
I understand who has recognised relationships with me

## Source Traceability

- **Source Use Case:** `UC-Participant-Relationship-1`
- **Source Scope:** Scope – Participant Relationships
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** View the people who are associated with my record so that I understand who has recognised relationships with me.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View My Relationships
Harmonia SHALL support **View My Relationships** so that I understand who has recognised relationships with me.
...
- **THEN** Participant / Patient initiates the 'View My Relationships' activity.
