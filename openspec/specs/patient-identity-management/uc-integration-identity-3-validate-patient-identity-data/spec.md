...
incomplete or invalid records are identified before processing

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-3`
...
- **User Story:** Validate patient identity data against defined rules so that incomplete or invalid records are identified before processing.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Validate Patient Identity Data
Harmonia SHALL support **Validate Patient Identity Data** so that incomplete or invalid records are identified before processing.

#### Scenario: Validate Patient Identity Data - successful outcome
...
- **WHEN** The actor needs to perform the 'Validate Patient Identity Data' activity, or an authorised business process initiates the activity.
- **THEN** Provider Identity / Matching Service initiates the 'Validate Patient Identity Data' activity.
...
- **THEN** The 'Validate Patient Identity Data' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
