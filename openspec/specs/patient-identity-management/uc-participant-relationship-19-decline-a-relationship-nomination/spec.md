# Decline a Relationship Nomination

## Purpose

I am not associated with another participant without my consent

## Source Traceability

- **Source Use Case:** `UC-Participant-Relationship-19`
- **Source Scope:** Scope – Participant Relationships
- **Primary Actor:** Related Person / Representative
- **Supporting Actors:** Provider Directory
- **User Story:** Decline a relationship request so that I am not associated with another participant without my consent.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Decline a Relationship Nomination
Harmonia SHALL support **Decline a Relationship Nomination** so that I am not associated with another participant without my consent.

#### Scenario: Decline a Relationship Nomination - successful outcome
...
- **WHEN** The actor needs to perform the 'Decline a Relationship Nomination' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative initiates the 'Decline a Relationship Nomination' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Related Person / Representative enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Decline a Relationship Nomination' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Related Person / Representative
