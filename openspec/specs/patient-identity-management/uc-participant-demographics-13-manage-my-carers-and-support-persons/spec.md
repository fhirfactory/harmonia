# Manage My Carers and Support Persons

## Purpose

they can be recognised in my care where appropriate

## Source Traceability

- **Source Use Case:** `UC-Participant-Demographics-13`
- **Source Scope:** Scope – Participant Demographics
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Record the details of my carers or support persons so that they can be recognised in my care where appropriate.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage My Carers and Support Persons
Harmonia SHALL support **Manage My Carers and Support Persons** so that they can be recognised in my care where appropriate.

#### Scenario: Manage My Carers and Support Persons - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage My Carers and Support Persons' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Manage My Carers and Support Persons' activity.
...
- **THEN** The 'Manage My Carers and Support Persons' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
