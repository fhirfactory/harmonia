# Update My Preferred Communication Method

## Purpose

I receive notifications and correspondence in the way that suits me best

## Source Traceability

- **Source Use Case:** `UC-Participant-Demographics-5`
- **Source Scope:** Scope – Participant Demographics
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Nominate my preferred communication method so that I receive notifications and correspondence in the way that suits me best.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Update My Preferred Communication Method
Harmonia SHALL support **Update My Preferred Communication Method** so that I receive notifications and correspondence in the way that suits me best.

#### Scenario: Update My Preferred Communication Method - successful outcome
...
- **WHEN** The actor needs to perform the 'Update My Preferred Communication Method' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Update My Preferred Communication Method' activity.
...
- **THEN** The 'Update My Preferred Communication Method' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
