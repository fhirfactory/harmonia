# Receive Identity Separation Notifications
...
- **Source Use Case:** `UC-Integration-Identity-15`
...
- **User Story:** Receive notifications when merged identities are separated so that records can be corrected.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Identity Separation Notifications
Harmonia SHALL support **Receive Identity Separation Notifications** so that records can be corrected.

#### Scenario: Receive Identity Separation Notifications - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Identity Separation Notifications' activity, or an authorised business process initiates the activity.
- **THEN** Clinical / Healthcare Application initiates the 'Receive Identity Separation Notifications' activity.
...
- **THEN** The 'Receive Identity Separation Notifications' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
