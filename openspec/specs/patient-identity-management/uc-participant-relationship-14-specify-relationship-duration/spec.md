# Specify Relationship Duration

## Purpose

temporary relationships are managed appropriately

## Source Traceability

- **Source Use Case:** `UC-Participant-Relationship-14`
- **Source Scope:** Scope – Participant Relationships
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Define when a relationship starts and ends so that temporary relationships are managed appropriately.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Specify Relationship Duration
Harmonia SHALL support **Specify Relationship Duration** so that temporary relationships are managed appropriately.

#### Scenario: Specify Relationship Duration - successful outcome
...
- **WHEN** The actor needs to perform the 'Specify Relationship Duration' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Specify Relationship Duration' activity.
...
- **THEN** The 'Specify Relationship Duration' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
