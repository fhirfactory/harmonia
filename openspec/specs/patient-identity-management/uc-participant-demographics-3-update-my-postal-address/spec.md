...
I receive mail at my preferred address

## Source Traceability

- **Source Use Case:** `UC-Participant-Demographics-3`
- **Source Scope:** Scope – Participant Demographics
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Update my postal address so that I receive mail at my preferred address.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Update My Postal Address
Harmonia SHALL support **Update My Postal Address** so that I receive mail at my preferred address.

#### Scenario: Update My Postal Address - successful outcome
...
- **WHEN** The actor needs to perform the 'Update My Postal Address' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Update My Postal Address' activity.
...
- **THEN** The 'Update My Postal Address' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
