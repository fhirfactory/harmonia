# Resolve External Patient Identifier

## Purpose

information is associated with the correct participant

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-19`
...
- **User Story:** Resolve an external patient identifier to the enterprise patient identifier so that information is associated with the correct participant.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Resolve External Patient Identifier
Harmonia SHALL support **Resolve External Patient Identifier** so that information is associated with the correct participant.

#### Scenario: Resolve External Patient Identifier - successful outcome
...
- **WHEN** The actor needs to perform the 'Resolve External Patient Identifier' activity, or an authorised business process initiates the activity.
- **THEN** Clinical / Healthcare Application initiates the 'Resolve External Patient Identifier' activity.
...
- **THEN** The 'Resolve External Patient Identifier' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
