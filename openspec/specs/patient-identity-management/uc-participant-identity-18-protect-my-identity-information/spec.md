...
my personal information is protected in accordance with privacy requirements

## Source Traceability

- **Source Use Case:** `UC-Participant-Identity-18`
- **Source Scope:** Scope - Identity
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Control who can view my identity information so that my personal information is protected in accordance with privacy requirements.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Protect My Identity Information
Harmonia SHALL support **Protect My Identity Information** so that my personal information is protected in accordance with privacy requirements.

#### Scenario: Protect My Identity Information - successful outcome
...
- **WHEN** The actor needs to perform the 'Protect My Identity Information' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Protect My Identity Information' activity.
...
- **THEN** The 'Protect My Identity Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
