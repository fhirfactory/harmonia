...
my nominated representative can be recognised

## Source Traceability

- **Source Use Case:** `UC-Participant-Relationship-15`
- **Source Scope:** Scope – Participant Relationships
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Provide supporting documents for legal relationships so that my nominated representative can be recognised.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Upload Supporting Documentation
Harmonia SHALL support **Upload Supporting Documentation** so that my nominated representative can be recognised.
...
- **THEN** Participant / Patient initiates the 'Upload Supporting Documentation' activity.
