...
I can locate the correct patient record efficiently

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-18`
...
- **User Story:** Search for Patients using multiple identity attributes so that I can locate the correct patient record efficiently.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identity Search
Harmonia SHALL support **Identity Search** so that I can locate the correct patient record efficiently.

#### Scenario: Identity Search - successful outcome
...
- **WHEN** The actor needs to perform the 'Identity Search' activity, or an authorised business process initiates the activity.
- **THEN** Patient Administration Officer initiates the 'Identity Search' activity.
...
- **THEN** The 'Identity Search' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
