# Manage Preferred Name

## Purpose

healthcare providers can address me appropriately while maintaining my legal identity

## Source Traceability

- **Source Use Case:** `UC-Participant-Identity-16`
- **Source Scope:** Scope - Identity
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Record my preferred name separately from my legal name so that healthcare providers can address me appropriately while maintaining my legal identity.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Preferred Name
Harmonia SHALL support **Manage Preferred Name** so that healthcare providers can address me appropriately while maintaining my legal identity.

#### Scenario: Manage Preferred Name - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Preferred Name' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Manage Preferred Name' activity.
...
- **THEN** The 'Manage Preferred Name' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
