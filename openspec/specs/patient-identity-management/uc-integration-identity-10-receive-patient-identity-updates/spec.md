# Receive Patient Identity Updates

## Purpose

my local patient information remains current

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-10`
...
- **User Story:** Receive patient identity updates so that my local patient information remains current.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive Patient Identity Updates
Harmonia SHALL support **Receive Patient Identity Updates** so that my local patient information remains current.

#### Scenario: Receive Patient Identity Updates - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive Patient Identity Updates' activity, or an authorised business process initiates the activity.
- **THEN** Clinical / Healthcare Application initiates the 'Receive Patient Identity Updates' activity.
...
- **THEN** The 'Receive Patient Identity Updates' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
