...
I can assist them with additional healthcare activities

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-17`
- **Source Scope:** Scope – Relationships
- **Primary Actor:** Related Person / Representative (Carer)
- **Supporting Actors:** Provider Directory
- **User Story:** Request additional permissions from a participant so that I can assist them with additional healthcare activities.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Request Additional Authority
Harmonia SHALL support **Request Additional Authority** so that I can assist them with additional healthcare activities.

#### Scenario: Request Additional Authority - successful outcome
...
- **WHEN** The actor needs to perform the 'Request Additional Authority' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Carer) initiates the 'Request Additional Authority' activity.
...
- **THEN** The 'Request Additional Authority' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
