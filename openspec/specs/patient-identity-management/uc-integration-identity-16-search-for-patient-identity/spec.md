# Search for Patient Identity

## Purpose

I can identify the correct participant

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-16`
...
- **User Story:** Search for a patient identity using available demographic attributes so that I can identify the correct participant.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Search for Patient Identity
Harmonia SHALL support **Search for Patient Identity** so that I can identify the correct participant.

#### Scenario: Search for Patient Identity - successful outcome
...
- **WHEN** The actor needs to perform the 'Search for Patient Identity' activity, or an authorised business process initiates the activity.
- **THEN** Clinical / Healthcare Application initiates the 'Search for Patient Identity' activity.
...
- **THEN** The 'Search for Patient Identity' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
