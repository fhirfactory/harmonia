...
operational and compliance performance can be monitored

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-20`
...
- **User Story:** Generate reports on patient identity verification, duplicate records, and outstanding identity exceptions so that operational and compliance performance can be monitored.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identity Reporting
Harmonia SHALL support **Identity Reporting** so that operational and compliance performance can be monitored.

#### Scenario: Identity Reporting - successful outcome
...
- **WHEN** The actor needs to perform the 'Identity Reporting' activity, or an authorised business process initiates the activity.
- **THEN** Reporting / Audit Officer initiates the 'Identity Reporting' activity.
...
- **THEN** The 'Identity Reporting' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
