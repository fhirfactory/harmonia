# View My Relationship Status

## Purpose

I know whether it is active

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-9`
- **Source Scope:** Scope – Relationships
- **Primary Actor:** Related Person / Representative (Next of Kin)
- **Supporting Actors:** Provider Directory
- **User Story:** View whether my relationship has been verified and approved so that I know whether it is active.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View My Relationship Status
Harmonia SHALL support **View My Relationship Status** so that I know whether it is active.

#### Scenario: View My Relationship Status - successful outcome
...
- **WHEN** The actor needs to perform the 'View My Relationship Status' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Next of Kin) initiates the 'View My Relationship Status' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Related Person / Representative (Next of Kin) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'View My Relationship Status' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Related Person / Representative (Next of Kin)
