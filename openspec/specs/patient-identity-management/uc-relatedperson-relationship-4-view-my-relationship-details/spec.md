# View My Relationship Details

## Purpose

I understand my recognised role and responsibilities

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-4`
- **Source Scope:** Scope – Relationships
- **Primary Actor:** Related Person / Representative (Parent)
- **Supporting Actors:** Provider Directory
- **User Story:** View the details of my relationship with a participant so that I understand my recognised role and responsibilities.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View My Relationship Details
Harmonia SHALL support **View My Relationship Details** so that I understand my recognised role and responsibilities.

#### Scenario: View My Relationship Details - successful outcome
...
- **WHEN** The actor needs to perform the 'View My Relationship Details' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Parent) initiates the 'View My Relationship Details' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Related Person / Representative (Parent) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'View My Relationship Details' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Related Person / Representative (Parent)
