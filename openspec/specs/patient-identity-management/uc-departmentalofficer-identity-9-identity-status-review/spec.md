...
I know whether additional action is required

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-9`
...
- **User Story:** Review the verification status of a Patient's identity so that I know whether additional action is required.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identity Status Review
Harmonia SHALL support **Identity Status Review** so that I know whether additional action is required.

#### Scenario: Identity Status Review - successful outcome
...
- **WHEN** The actor needs to perform the 'Identity Status Review' activity, or an authorised business process initiates the activity.
- **THEN** Provider Directory Administrator (Registration) initiates the 'Identity Status Review' activity.
...
- **THEN** The 'Identity Status Review' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
