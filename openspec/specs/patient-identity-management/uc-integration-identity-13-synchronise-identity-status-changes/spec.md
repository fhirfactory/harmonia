# Synchronise Identity Status Changes

## Purpose

I can respond appropriately to active, suspended, merged, or retired identities

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-13`
- **Source Scope:** Scope - Identity Data Synchronisation
- **Primary Actor:** Downstream Consumer System System
- **Supporting Actors:** Provider Directory
- **User Story:** Receive patient identity status changes so that I can respond appropriately to active, suspended, merged, or retired identities.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Synchronise Identity Status Changes
Harmonia SHALL support **Synchronise Identity Status Changes** so that I can respond appropriately to active, suspended, merged, or retired identities.

#### Scenario: Synchronise Identity Status Changes - successful outcome
...
- **WHEN** The actor needs to perform the 'Synchronise Identity Status Changes' activity, or an authorised business process initiates the activity.
- **THEN** Downstream Consumer System System initiates the 'Synchronise Identity Status Changes' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Downstream Consumer System System enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Synchronise Identity Status Changes' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
