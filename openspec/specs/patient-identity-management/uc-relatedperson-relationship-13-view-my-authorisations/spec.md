# View My Authorisations

## Purpose

I understand what actions I am authorised to perform

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-13`
- **Source Scope:** Scope – Relationships
- **Primary Actor:** Related Person / Representative (Medical Decision Maker)
- **Supporting Actors:** Provider Directory
- **User Story:** View the permissions associated with my relationship so that I understand what actions I am authorised to perform.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View My Authorisations
Harmonia SHALL support **View My Authorisations** so that I understand what actions I am authorised to perform.

#### Scenario: View My Authorisations - successful outcome
...
- **WHEN** The actor needs to perform the 'View My Authorisations' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Medical Decision Maker) initiates the 'View My Authorisations' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Related Person / Representative (Medical Decision Maker) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'View My Authorisations' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Related Person / Representative (Medical Decision Maker)
