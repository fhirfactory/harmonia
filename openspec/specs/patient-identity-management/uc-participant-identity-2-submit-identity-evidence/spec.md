...
- **Source Use Case:** `UC-Participant-Identity-2`
- **Source Scope:** Scope - Identity
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Upload or present identity documents so that my identity can be verified.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Submit Identity Evidence
Harmonia SHALL support **Submit Identity Evidence** so that my identity can be verified.

#### Scenario: Submit Identity Evidence - successful outcome
...
- **WHEN** The actor needs to perform the 'Submit Identity Evidence' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Submit Identity Evidence' activity.
...
- **THEN** The 'Submit Identity Evidence' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
