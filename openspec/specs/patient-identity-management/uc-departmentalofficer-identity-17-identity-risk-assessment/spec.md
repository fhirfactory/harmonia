...
higher-risk identities receive additional scrutiny

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-17`
- **Source Scope:** Scope - Patient / Related Person Identity
- **Primary Actor:** Compliance Officer (Fraud Prevention)
- **Supporting Actors:** Provider Directory
- **User Story:** Assess the risk associated with a Patient identity based on verification outcomes and behavioural indicators so that higher-risk identities receive additional scrutiny.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identity Risk Assessment
Harmonia SHALL support **Identity Risk Assessment** so that higher-risk identities receive additional scrutiny.

#### Scenario: Identity Risk Assessment - successful outcome
...
- **WHEN** The actor needs to perform the 'Identity Risk Assessment' activity, or an authorised business process initiates the activity.
- **THEN** Compliance Officer (Fraud Prevention) initiates the 'Identity Risk Assessment' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Compliance Officer (Fraud Prevention) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Identity Risk Assessment' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Compliance Officer (Fraud Prevention)
