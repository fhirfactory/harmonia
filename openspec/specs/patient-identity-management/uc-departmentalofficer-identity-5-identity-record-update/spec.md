...
patient records remain accurate and current

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-5`
- **Source Scope:** Scope - Patient / Related Person Identity
- **Primary Actor:** Patient Administration Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Update a Patient's identity information when supporting evidence is provided so that patient records remain accurate and current.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identity Record Update
Harmonia SHALL support **Identity Record Update** so that patient records remain accurate and current.

#### Scenario: Identity Record Update - successful outcome
...
- **WHEN** The actor needs to perform the 'Identity Record Update' activity, or an authorised business process initiates the activity.
- **THEN** Patient Administration Officer initiates the 'Identity Record Update' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Patient Administration Officer enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Identity Record Update' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Patient Administration Officer
