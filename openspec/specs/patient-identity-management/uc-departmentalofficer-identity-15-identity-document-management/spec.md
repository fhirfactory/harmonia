...
identity evidence is securely maintained throughout its retention period

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-15`
- **Source Scope:** Scope - Patient / Related Person Identity
- **Primary Actor:** Records Management Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Manage supporting identity documents associated with a Patient so that identity evidence is securely maintained throughout its retention period.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identity Document Management
Harmonia SHALL support **Identity Document Management** so that identity evidence is securely maintained throughout its retention period.

#### Scenario: Identity Document Management - successful outcome
...
- **WHEN** The actor needs to perform the 'Identity Document Management' activity, or an authorised business process initiates the activity.
- **THEN** Records Management Officer initiates the 'Identity Document Management' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Records Management Officer enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Identity Document Management' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Records Management Officer
