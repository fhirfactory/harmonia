...
my representative role can be verified

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-7`
- **Source Scope:** Scope – Relationships
- **Primary Actor:** Related Person / Representative (Power of Attorney)
- **Supporting Actors:** Provider Directory
- **User Story:** Provide documentation supporting my legal authority so that my representative role can be verified.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Upload Supporting Documentation
Harmonia SHALL support **Upload Supporting Documentation** so that my representative role can be verified.

#### Scenario: Upload Supporting Documentation - successful outcome
...
- **WHEN** The actor needs to perform the 'Upload Supporting Documentation' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Power of Attorney) initiates the 'Upload Supporting Documentation' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Related Person / Representative (Power of Attorney) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Upload Supporting Documentation' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Related Person / Representative (Power of Attorney)
