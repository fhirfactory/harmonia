...
my role is formally recognised

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-2`
...
- **User Story:** Accept a request to establish a relationship with a participant so that my role is formally recognised.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Accept a Relationship Request
Harmonia SHALL support **Accept a Relationship Request** so that my role is formally recognised.

#### Scenario: Accept a Relationship Request - successful outcome
...
- **WHEN** The actor needs to perform the 'Accept a Relationship Request' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Nominated Representative) initiates the 'Accept a Relationship Request' activity.
...
- **THEN** The 'Accept a Relationship Request' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
