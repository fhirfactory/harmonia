# Access Linked Participant Information

## Purpose

I can effectively support the participant

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-20`
- **Source Scope:** Scope – Relationships
- **Primary Actor:** Related Person / Representative (Authorised Representative)
- **Supporting Actors:** Provider Directory
- **User Story:** Access the participant information that I have been authorised to view so that I can effectively support the participant.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Access Linked Participant Information
Harmonia SHALL support **Access Linked Participant Information** so that I can effectively support the participant.

#### Scenario: Access Linked Participant Information - successful outcome
...
- **WHEN** The actor needs to perform the 'Access Linked Participant Information' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Authorised Representative) initiates the 'Access Linked Participant Information' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Related Person / Representative (Authorised Representative) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Access Linked Participant Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Related Person / Representative (Authorised Representative)
...
- **WHEN** This section contains 20 use case(s) associated with the 'Consent' grouping in the source workbook.
- **THEN** Harmonia SHALL prevent an invalid or unauthorised outcome and record or present the applicable correction, approval, reconciliation, escalation or failure state
