# Accept a Relationship Nomination

## Purpose

my relationship with another participant is formally recognised

## Source Traceability

- **Source Use Case:** `UC-Participant-Relationship-18`
...
- **User Story:** Accept a relationship request so that my relationship with another participant is formally recognised.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Accept a Relationship Nomination
Harmonia SHALL support **Accept a Relationship Nomination** so that my relationship with another participant is formally recognised.

#### Scenario: Accept a Relationship Nomination - successful outcome
...
- **WHEN** The actor needs to perform the 'Accept a Relationship Nomination' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative initiates the 'Accept a Relationship Nomination' activity.
...
- **THEN** The 'Accept a Relationship Nomination' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
