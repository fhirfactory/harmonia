# Receive New Patient Registration

## Purpose

newly created patient identities can be synchronised with connected systems

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-1`
- **Source Scope:** Scope - Identity Creation and Registration
- **Primary Actor:** Clinical / Healthcare Application
- **Supporting Actors:** Provider Directory
- **User Story:** Receive new patient registration events so that newly created patient identities can be synchronised with connected systems.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Receive New Patient Registration
Harmonia SHALL support **Receive New Patient Registration** so that newly created patient identities can be synchronised with connected systems.

#### Scenario: Receive New Patient Registration - successful outcome
...
- **WHEN** The actor needs to perform the 'Receive New Patient Registration' activity, or an authorised business process initiates the activity.
- **THEN** Clinical / Healthcare Application initiates the 'Receive New Patient Registration' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Clinical / Healthcare Application enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Receive New Patient Registration' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Clinical / Healthcare Application
