...
I receive communications in the way that best suits me

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-12`
- **Source Scope:** Scope – Relationships
- **Primary Actor:** Related Person / Representative (Support Person)
- **Supporting Actors:** Provider Directory
- **User Story:** Specify my preferred communication methods so that I receive communications in the way that best suits me.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage My Communication Preferences
Harmonia SHALL support **Manage My Communication Preferences** so that I receive communications in the way that best suits me.

#### Scenario: Manage My Communication Preferences - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage My Communication Preferences' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Support Person) initiates the 'Manage My Communication Preferences' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Related Person / Representative (Support Person) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Manage My Communication Preferences' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Related Person / Representative (Support Person)
