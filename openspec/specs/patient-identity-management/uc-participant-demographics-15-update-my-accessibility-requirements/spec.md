# Update My Accessibility Requirements

## Purpose

healthcare services can make appropriate accommodations

## Source Traceability

- **Source Use Case:** `UC-Participant-Demographics-15`
- **Source Scope:** Scope – Participant Demographics
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Record my accessibility requirements so that healthcare services can make appropriate accommodations.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Update My Accessibility Requirements
Harmonia SHALL support **Update My Accessibility Requirements** so that healthcare services can make appropriate accommodations.

#### Scenario: Update My Accessibility Requirements - successful outcome
...
- **WHEN** The actor needs to perform the 'Update My Accessibility Requirements' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Update My Accessibility Requirements' activity.
...
- **THEN** The 'Update My Accessibility Requirements' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
