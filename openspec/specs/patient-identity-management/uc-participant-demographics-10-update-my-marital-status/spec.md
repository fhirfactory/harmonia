...
my personal information remains current

## Source Traceability

- **Source Use Case:** `UC-Participant-Demographics-10`
- **Source Scope:** Scope – Participant Demographics
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Update my marital or relationship status so that my personal information remains current.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Update My Marital Status
Harmonia SHALL support **Update My Marital Status** so that my personal information remains current.

#### Scenario: Update My Marital Status - successful outcome
...
- **WHEN** The actor needs to perform the 'Update My Marital Status' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Update My Marital Status' activity.
...
- **THEN** The 'Update My Marital Status' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
