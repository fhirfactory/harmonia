...
I can support all of the people in my care

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-16`
- **Source Scope:** Scope – Relationships
- **Primary Actor:** Related Person / Representative (Carer)
- **Supporting Actors:** Provider Directory
- **User Story:** Manage relationships with multiple participants so that I can support all of the people in my care.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Multiple Relationships
Harmonia SHALL support **Manage Multiple Relationships** so that I can support all of the people in my care.

#### Scenario: Manage Multiple Relationships - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Multiple Relationships' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Carer) initiates the 'Manage Multiple Relationships' activity.
...
- **THEN** The 'Manage Multiple Relationships' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
