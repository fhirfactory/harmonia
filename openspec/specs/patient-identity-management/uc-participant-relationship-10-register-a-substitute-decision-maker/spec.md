# Register a Substitute Decision Maker

## Purpose

healthcare decisions can be made on my behalf if required

## Source Traceability

- **Source Use Case:** `UC-Participant-Relationship-10`
- **Source Scope:** Scope – Participant Relationships
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Nominate a substitute decision maker so that healthcare decisions can be made on my behalf if required.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Register a Substitute Decision Maker
Harmonia SHALL support **Register a Substitute Decision Maker** so that healthcare decisions can be made on my behalf if required.

#### Scenario: Register a Substitute Decision Maker - successful outcome
...
- **WHEN** The actor needs to perform the 'Register a Substitute Decision Maker' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Register a Substitute Decision Maker' activity.
...
- **THEN** The 'Register a Substitute Decision Maker' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
