...
access complies with privacy legislation and departmental policy

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-13`
- **Source Scope:** Scope - Patient / Related Person Identity
- **Primary Actor:** Privacy Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Approve requests to access sensitive patient identity information so that access complies with privacy legislation and departmental policy.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identity Access Approval
Harmonia SHALL support **Identity Access Approval** so that access complies with privacy legislation and departmental policy.

#### Scenario: Identity Access Approval - successful outcome
...
- **WHEN** The actor needs to perform the 'Identity Access Approval' activity, or an authorised business process initiates the activity.
- **THEN** Privacy Officer initiates the 'Identity Access Approval' activity.
...
- **THEN** The 'Identity Access Approval' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
