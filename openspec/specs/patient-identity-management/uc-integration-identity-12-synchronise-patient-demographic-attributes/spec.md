# Synchronise Patient Demographic Attributes

## Purpose

connected systems maintain consistent information

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-12`
...
- **User Story:** Synchronise patient demographic attributes so that connected systems maintain consistent information.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Synchronise Patient Demographic Attributes
Harmonia SHALL support **Synchronise Patient Demographic Attributes** so that connected systems maintain consistent information.

#### Scenario: Synchronise Patient Demographic Attributes - successful outcome
...
- **WHEN** The actor needs to perform the 'Synchronise Patient Demographic Attributes' activity, or an authorised business process initiates the activity.
- **THEN** Clinical / Healthcare Application initiates the 'Synchronise Patient Demographic Attributes' activity.
...
- **THEN** The 'Synchronise Patient Demographic Attributes' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
