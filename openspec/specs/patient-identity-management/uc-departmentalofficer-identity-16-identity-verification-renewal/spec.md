# Identity Verification Renewal

## Purpose

identity assurance remains current

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-16`
- **Source Scope:** Scope - Patient / Related Person Identity
- **Primary Actor:** Compliance Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Request re-verification of a Patient's identity when verification evidence expires or policy changes so that identity assurance remains current.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Identity Verification Renewal
Harmonia SHALL support **Identity Verification Renewal** so that identity assurance remains current.

#### Scenario: Identity Verification Renewal - successful outcome
...
- **WHEN** The actor needs to perform the 'Identity Verification Renewal' activity, or an authorised business process initiates the activity.
- **THEN** Compliance Officer initiates the 'Identity Verification Renewal' activity.
...
- **THEN** The 'Identity Verification Renewal' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
