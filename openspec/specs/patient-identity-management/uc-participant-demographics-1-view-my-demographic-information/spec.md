# View My Demographic Information

## Purpose

I can confirm it is accurate and complete

## Source Traceability

- **Source Use Case:** `UC-Participant-Demographics-1`
- **Source Scope:** Scope – Participant Demographics
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** View my demographic information so that I can confirm it is accurate and complete.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: View My Demographic Information
Harmonia SHALL support **View My Demographic Information** so that I can confirm it is accurate and complete.

#### Scenario: View My Demographic Information - successful outcome
...
- **WHEN** The actor needs to perform the 'View My Demographic Information' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'View My Demographic Information' activity.
...
- **THEN** The 'View My Demographic Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
