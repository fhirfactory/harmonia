# Manage Gender and Sex Information

## Purpose

my patient record accurately reflects my identity and supports appropriate clinical care

## Source Traceability

- **Source Use Case:** `UC-Participant-Identity-17`
- **Source Scope:** Scope - Identity
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Update my gender identity and sex information where permitted so that my patient record accurately reflects my identity and supports appropriate clinical care.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Gender and Sex Information
Harmonia SHALL support **Manage Gender and Sex Information** so that my patient record accurately reflects my identity and supports appropriate clinical care.

#### Scenario: Manage Gender and Sex Information - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Gender and Sex Information' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Manage Gender and Sex Information' activity.
...
- **THEN** The 'Manage Gender and Sex Information' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
