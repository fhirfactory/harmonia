...
the correct patient identity can be established

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Identity-4`
- **Source Scope:** Scope - Patient / Related Person Identity
- **Primary Actor:** Data Steward (Identity Resolution)
- **Supporting Actors:** Provider Directory
- **User Story:** Investigate and resolve discrepancies between submitted identity information and authoritative records so that the correct patient identity can be established.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Resolve Identity Discrepancies
Harmonia SHALL support **Resolve Identity Discrepancies** so that the correct patient identity can be established.

#### Scenario: Resolve Identity Discrepancies - successful outcome
...
- **WHEN** The actor needs to perform the 'Resolve Identity Discrepancies' activity, or an authorised business process initiates the activity.
- **THEN** Data Steward (Identity Resolution) initiates the 'Resolve Identity Discrepancies' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Data Steward (Identity Resolution) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Resolve Identity Discrepancies' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Data Steward (Identity Resolution)
