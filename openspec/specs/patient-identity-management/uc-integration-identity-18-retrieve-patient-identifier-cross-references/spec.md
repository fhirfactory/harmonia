# Retrieve Patient Identifier Cross References

## Purpose

records can be linked across systems

## Source Traceability

- **Source Use Case:** `UC-Integration-Identity-18`
- **Source Scope:** Scope - Identity Query and Retrieval
- **Primary Actor:** Integration Service / Integration Platform
- **Supporting Actors:** Provider Directory
- **User Story:** Retrieve mappings between local and enterprise patient identifiers so that records can be linked across systems.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Retrieve Patient Identifier Cross References
Harmonia SHALL support **Retrieve Patient Identifier Cross References** so that records can be linked across systems.

#### Scenario: Retrieve Patient Identifier Cross References - successful outcome
...
- **WHEN** The actor needs to perform the 'Retrieve Patient Identifier Cross References' activity, or an authorised business process initiates the activity.
- **THEN** Integration Service / Integration Platform initiates the 'Retrieve Patient Identifier Cross References' activity.
...
- **THEN** The 'Retrieve Patient Identifier Cross References' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
