# Manage My Contact Details

## Purpose

healthcare providers can contact me when necessary

## Source Traceability

- **Source Use Case:** `UC-RelatedPerson-Relationship-11`
- **Source Scope:** Scope – Relationships
- **Primary Actor:** Related Person / Representative (Emergency Contact)
- **Supporting Actors:** Provider Directory
- **User Story:** Maintain my own contact information so that healthcare providers can contact me when necessary.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage My Contact Details
Harmonia SHALL support **Manage My Contact Details** so that healthcare providers can contact me when necessary.

#### Scenario: Manage My Contact Details - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage My Contact Details' activity, or an authorised business process initiates the activity.
- **THEN** Related Person / Representative (Emergency Contact) initiates the 'Manage My Contact Details' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Related Person / Representative (Emergency Contact) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Manage My Contact Details' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Related Person / Representative (Emergency Contact)
