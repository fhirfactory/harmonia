...
my record remains accurate

## Source Traceability

- **Source Use Case:** `UC-Participant-Relationship-4`
- **Source Scope:** Scope – Participant Relationships
- **Primary Actor:** Participant / Patient
- **Supporting Actors:** Provider Directory
- **User Story:** Remove a relationship that is no longer valid so that my record remains accurate.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Remove a Relationship
Harmonia SHALL support **Remove a Relationship** so that my record remains accurate.

#### Scenario: Remove a Relationship - successful outcome
...
- **WHEN** The actor needs to perform the 'Remove a Relationship' activity, or an authorised business process initiates the activity.
- **THEN** Participant / Patient initiates the 'Remove a Relationship' activity.
...
- **THEN** The 'Remove a Relationship' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
