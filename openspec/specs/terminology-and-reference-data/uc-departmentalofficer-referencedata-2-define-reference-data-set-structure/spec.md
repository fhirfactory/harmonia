# Define Reference Data Set Structure
...
- **Source Use Case:** `UC-DepartmentalOfficer-ReferenceData-2`
- **Source Scope:** Scope - Reference Data Set Management
- **Primary Actor:** Data Governance Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Define the structure, attributes and metadata of a reference data set so that it can be managed consistently.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Define Reference Data Set Structure
Harmonia SHALL support **Define Reference Data Set Structure** so that it can be managed consistently.

#### Scenario: Define Reference Data Set Structure - successful outcome
...
- **WHEN** The actor needs to perform the 'Define Reference Data Set Structure' activity, or an authorised business process initiates the activity.
- **THEN** Data Governance Officer initiates the 'Define Reference Data Set Structure' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Data Governance Officer enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Define Reference Data Set Structure' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Data Governance Officer
