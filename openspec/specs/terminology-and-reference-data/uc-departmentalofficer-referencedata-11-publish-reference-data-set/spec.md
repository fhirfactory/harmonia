# Publish Reference Data Set

## Purpose

consuming systems can access current values

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ReferenceData-11`
...
- **User Story:** Publish approved reference data sets so that consuming systems can access current values.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Publish Reference Data Set
Harmonia SHALL support **Publish Reference Data Set** so that consuming systems can access current values.

#### Scenario: Publish Reference Data Set - successful outcome
...
- **WHEN** The actor needs to perform the 'Publish Reference Data Set' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator initiates the 'Publish Reference Data Set' activity.
...
- **THEN** The 'Publish Reference Data Set' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
