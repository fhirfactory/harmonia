...
- **Source Use Case:** `UC-DepartmentalOfficer-ReferenceData-9`
- **Source Scope:** Scope - Governance and Approval
- **Primary Actor:** Data Governance Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Reject inappropriate reference data changes so that data standards are maintained.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Reject Reference Data Changes
Harmonia SHALL support **Reject Reference Data Changes** so that data standards are maintained.

#### Scenario: Reject Reference Data Changes - successful outcome
...
- **WHEN** The actor needs to perform the 'Reject Reference Data Changes' activity, or an authorised business process initiates the activity.
- **THEN** Data Governance Officer initiates the 'Reject Reference Data Changes' activity.
...
- **THEN** The 'Reject Reference Data Changes' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
