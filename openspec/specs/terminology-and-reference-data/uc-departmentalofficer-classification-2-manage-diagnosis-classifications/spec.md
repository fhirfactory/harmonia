# Manage Diagnosis Classifications

## Purpose

clinical reporting remains consistent

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Classification-2`
...
- **User Story:** Manage diagnosis classification values so that clinical reporting remains consistent.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Diagnosis Classifications
Harmonia SHALL support **Manage Diagnosis Classifications** so that clinical reporting remains consistent.

#### Scenario: Manage Diagnosis Classifications - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Diagnosis Classifications' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator (Clinical Coding) initiates the 'Manage Diagnosis Classifications' activity.
...
- **THEN** The 'Manage Diagnosis Classifications' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
