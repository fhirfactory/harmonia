# Manage Code Set Members

## Purpose

only valid values are available

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-CodeSet-2`
...
- **User Story:** Manage the codes included in a code set so that only valid values are available.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Code Set Members
Harmonia SHALL support **Manage Code Set Members** so that only valid values are available.

#### Scenario: Manage Code Set Members - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Code Set Members' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator initiates the 'Manage Code Set Members' activity.
...
- **THEN** The 'Manage Code Set Members' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
