...
integrations remain synchronised

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ReferenceData-13`
...
- **User Story:** Notify consuming systems of reference data changes so that integrations remain synchronised.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Notify Consumers of Changes
Harmonia SHALL support **Notify Consumers of Changes** so that integrations remain synchronised.

#### Scenario: Notify Consumers of Changes - successful outcome
...
- **WHEN** The actor needs to perform the 'Notify Consumers of Changes' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator initiates the 'Notify Consumers of Changes' activity.
...
- **THEN** The 'Notify Consumers of Changes' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
