# Manage Terminology Versions

## Purpose

systems can use the appropriate version for a given timeframe

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Terminology-4`
...
- **User Story:** Manage terminology versions so that systems can use the appropriate version for a given timeframe.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Terminology Versions
Harmonia SHALL support **Manage Terminology Versions** so that systems can use the appropriate version for a given timeframe.

#### Scenario: Manage Terminology Versions - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Terminology Versions' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator initiates the 'Manage Terminology Versions' activity.
...
- **THEN** The 'Manage Terminology Versions' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
