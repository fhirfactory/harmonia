# Submit Reference Data Change Request

## Purpose

updates follow an approved process

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ReferenceData-6`
- **Source Scope:** Scope - Governance and Approval
- **Primary Actor:** Reference Data / Terminology Administrator
- **Supporting Actors:** Provider Directory
- **User Story:** Submit changes to governed reference data so that updates follow an approved process.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Submit Reference Data Change Request
Harmonia SHALL support **Submit Reference Data Change Request** so that updates follow an approved process.

#### Scenario: Submit Reference Data Change Request - successful outcome
...
- **WHEN** The actor needs to perform the 'Submit Reference Data Change Request' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator initiates the 'Submit Reference Data Change Request' activity.
...
- **THEN** The 'Submit Reference Data Change Request' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
