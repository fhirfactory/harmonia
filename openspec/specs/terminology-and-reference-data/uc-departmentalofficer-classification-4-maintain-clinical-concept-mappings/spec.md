# Maintain Clinical Concept Mappings

## Purpose

data can be exchanged and analysed consistently

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Classification-4`
- **Source Scope:** Scope - Clinical Classification Management
- **Primary Actor:** Reference Data / Terminology Administrator (Terminology Mapping)
- **Supporting Actors:** Provider Directory
- **User Story:** Maintain mappings between clinical concepts so that data can be exchanged and analysed consistently.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Maintain Clinical Concept Mappings
Harmonia SHALL support **Maintain Clinical Concept Mappings** so that data can be exchanged and analysed consistently.

#### Scenario: Maintain Clinical Concept Mappings - successful outcome
...
- **WHEN** The actor needs to perform the 'Maintain Clinical Concept Mappings' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator (Terminology Mapping) initiates the 'Maintain Clinical Concept Mappings' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Reference Data / Terminology Administrator (Terminology Mapping) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Maintain Clinical Concept Mappings' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Reference Data / Terminology Administrator (Terminology Mapping)
