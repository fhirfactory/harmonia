...
incorrect or incomplete values are identified

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ReferenceData-15`
...
- **User Story:** Assess reference data quality so that incorrect or incomplete values are identified.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Validate Reference Data Quality
Harmonia SHALL support **Validate Reference Data Quality** so that incorrect or incomplete values are identified.

#### Scenario: Validate Reference Data Quality - successful outcome
...
- **WHEN** The actor needs to perform the 'Validate Reference Data Quality' activity, or an authorised business process initiates the activity.
- **THEN** Data Steward (Data Quality) initiates the 'Validate Reference Data Quality' activity.
...
- **THEN** The 'Validate Reference Data Quality' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
