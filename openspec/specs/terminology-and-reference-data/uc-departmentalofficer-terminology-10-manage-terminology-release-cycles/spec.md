# Manage Terminology Release Cycles

## Purpose

downstream systems can adopt changes safely

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Terminology-10`
- **Source Scope:** Scope - Advanced Terminology Capabilities
- **Primary Actor:** Reference Data / Terminology Administrator (Release Management)
- **Supporting Actors:** Provider Directory
- **User Story:** Coordinate terminology releases so that downstream systems can adopt changes safely.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Terminology Release Cycles
Harmonia SHALL support **Manage Terminology Release Cycles** so that downstream systems can adopt changes safely.

#### Scenario: Manage Terminology Release Cycles - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Terminology Release Cycles' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator (Release Management) initiates the 'Manage Terminology Release Cycles' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Reference Data / Terminology Administrator (Release Management) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Manage Terminology Release Cycles' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Reference Data / Terminology Administrator (Release Management)
