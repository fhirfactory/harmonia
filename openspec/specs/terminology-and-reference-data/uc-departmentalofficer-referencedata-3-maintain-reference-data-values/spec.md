# Maintain Reference Data Values

## Purpose

controlled lists remain current

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ReferenceData-3`
...
- **User Story:** Add, update and retire reference data values so that controlled lists remain current.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Maintain Reference Data Values
Harmonia SHALL support **Maintain Reference Data Values** so that controlled lists remain current.

#### Scenario: Maintain Reference Data Values - successful outcome
...
- **WHEN** The actor needs to perform the 'Maintain Reference Data Values' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator initiates the 'Maintain Reference Data Values' activity.
...
- **THEN** The 'Maintain Reference Data Values' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
