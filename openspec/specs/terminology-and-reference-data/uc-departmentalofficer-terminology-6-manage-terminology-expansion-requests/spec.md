# Manage Terminology Expansion Requests

## Purpose

clinical requirements are supported

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Terminology-6`
- **Source Scope:** Scope - Advanced Terminology Capabilities
- **Primary Actor:** Data Governance Officer (Clinical Terminology)
- **Supporting Actors:** Provider Directory
- **User Story:** Assess requests for new terminology concepts so that clinical requirements are supported.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Terminology Expansion Requests
Harmonia SHALL support **Manage Terminology Expansion Requests** so that clinical requirements are supported.

#### Scenario: Manage Terminology Expansion Requests - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Terminology Expansion Requests' activity, or an authorised business process initiates the activity.
- **THEN** Data Governance Officer (Clinical Terminology) initiates the 'Manage Terminology Expansion Requests' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Data Governance Officer (Clinical Terminology) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Manage Terminology Expansion Requests' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Data Governance Officer (Clinical Terminology)
