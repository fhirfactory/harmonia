# Review Code System Changes

## Purpose

impacts to departmental systems can be assessed

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-CodeSet-5`
- **Source Scope:** Scope - Code Set and Value Set Management
- **Primary Actor:** Data Governance Officer (Terminology)
- **Supporting Actors:** Provider Directory
- **User Story:** Review changes to external code systems so that impacts to departmental systems can be assessed.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Review Code System Changes
Harmonia SHALL support **Review Code System Changes** so that impacts to departmental systems can be assessed.

#### Scenario: Review Code System Changes - successful outcome
...
- **WHEN** The actor needs to perform the 'Review Code System Changes' activity, or an authorised business process initiates the activity.
- **THEN** Data Governance Officer (Terminology) initiates the 'Review Code System Changes' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Data Governance Officer (Terminology) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Review Code System Changes' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Data Governance Officer (Terminology)
