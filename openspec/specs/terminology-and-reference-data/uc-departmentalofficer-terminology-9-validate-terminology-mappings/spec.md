...
exchanged information retains its meaning

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Terminology-9`
...
- **User Story:** Validate mappings between terminology systems so that exchanged information retains its meaning.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Validate Terminology Mappings
Harmonia SHALL support **Validate Terminology Mappings** so that exchanged information retains its meaning.

#### Scenario: Validate Terminology Mappings - successful outcome
...
- **WHEN** The actor needs to perform the 'Validate Terminology Mappings' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator (Terminology Mapping) initiates the 'Validate Terminology Mappings' activity.
...
- **THEN** The 'Validate Terminology Mappings' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
