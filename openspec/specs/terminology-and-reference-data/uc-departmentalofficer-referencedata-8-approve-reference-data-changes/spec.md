...
only authorised updates are published

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ReferenceData-8`
- **Source Scope:** Scope - Governance and Approval
- **Primary Actor:** Data Governance Officer (Governance Board)
- **Supporting Actors:** Provider Directory
- **User Story:** Approve reference data changes so that only authorised updates are published.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Approve Reference Data Changes
Harmonia SHALL support **Approve Reference Data Changes** so that only authorised updates are published.

#### Scenario: Approve Reference Data Changes - successful outcome
...
- **WHEN** The actor needs to perform the 'Approve Reference Data Changes' activity, or an authorised business process initiates the activity.
- **THEN** Data Governance Officer (Governance Board) initiates the 'Approve Reference Data Changes' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Data Governance Officer (Governance Board) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Approve Reference Data Changes' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Data Governance Officer (Governance Board)
