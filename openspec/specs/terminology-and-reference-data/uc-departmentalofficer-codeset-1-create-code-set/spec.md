...
systems can exchange consistent coded information

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-CodeSet-1`
...
- **User Story:** Create a controlled code set so that systems can exchange consistent coded information.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Create Code Set
Harmonia SHALL support **Create Code Set** so that systems can exchange consistent coded information.

#### Scenario: Create Code Set - successful outcome
...
- **WHEN** The actor needs to perform the 'Create Code Set' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator initiates the 'Create Code Set' activity.
...
- **THEN** The 'Create Code Set' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
