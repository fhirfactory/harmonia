# Validate Terminology Content

## Purpose

only approved concepts are available

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Terminology-3`
...
- **User Story:** Validate terminology content before publication so that only approved concepts are available.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Validate Terminology Content
Harmonia SHALL support **Validate Terminology Content** so that only approved concepts are available.

#### Scenario: Validate Terminology Content - successful outcome
...
- **WHEN** The actor needs to perform the 'Validate Terminology Content' activity, or an authorised business process initiates the activity.
- **THEN** Data Governance Officer (Clinical Terminology) initiates the 'Validate Terminology Content' activity.
...
- **THEN** The 'Validate Terminology Content' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
