# Manage Clinical Classifications

## Purpose

reporting and analysis use approved classifications

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Classification-1`
- **Source Scope:** Scope - Clinical Classification Management
- **Primary Actor:** Reference Data / Terminology Administrator (Clinical Coding)
- **Supporting Actors:** Provider Directory
- **User Story:** Maintain clinical classifications so that reporting and analysis use approved classifications.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Clinical Classifications
Harmonia SHALL support **Manage Clinical Classifications** so that reporting and analysis use approved classifications.

#### Scenario: Manage Clinical Classifications - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Clinical Classifications' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator (Clinical Coding) initiates the 'Manage Clinical Classifications' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Reference Data / Terminology Administrator (Clinical Coding) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Manage Clinical Classifications' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Reference Data / Terminology Administrator (Clinical Coding)
