...
standardised values can be used consistently across healthcare systems

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ReferenceData-1`
...
- **User Story:** Create a new reference data set so that standardised values can be used consistently across healthcare systems.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Create Reference Data Set
Harmonia SHALL support **Create Reference Data Set** so that standardised values can be used consistently across healthcare systems.

#### Scenario: Create Reference Data Set - successful outcome
...
- **WHEN** The actor needs to perform the 'Create Reference Data Set' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator initiates the 'Create Reference Data Set' activity.
...
- **THEN** The 'Create Reference Data Set' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
