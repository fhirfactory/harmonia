...
clinical data quality is improved

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-CodeSet-3`
- **Source Scope:** Scope - Code Set and Value Set Management
- **Primary Actor:** Data Governance Officer (Clinical Data)
- **Supporting Actors:** Provider Directory
- **User Story:** Define value sets that constrain allowable values so that clinical data quality is improved.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Define Value Sets
Harmonia SHALL support **Define Value Sets** so that clinical data quality is improved.

#### Scenario: Define Value Sets - successful outcome
...
- **WHEN** The actor needs to perform the 'Define Value Sets' activity, or an authorised business process initiates the activity.
- **THEN** Data Governance Officer (Clinical Data) initiates the 'Define Value Sets' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Data Governance Officer (Clinical Data) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Define Value Sets' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Data Governance Officer (Clinical Data)
