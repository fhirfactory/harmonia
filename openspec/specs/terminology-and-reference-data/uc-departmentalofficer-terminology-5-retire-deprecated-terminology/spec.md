# Retire Deprecated Terminology

## Purpose

outdated values are no longer used

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Terminology-5`
...
- **User Story:** Retire obsolete terminology concepts so that outdated values are no longer used.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Retire Deprecated Terminology
Harmonia SHALL support **Retire Deprecated Terminology** so that outdated values are no longer used.

#### Scenario: Retire Deprecated Terminology - successful outcome
...
- **WHEN** The actor needs to perform the 'Retire Deprecated Terminology' activity, or an authorised business process initiates the activity.
- **THEN** Data Governance Officer (Terminology) initiates the 'Retire Deprecated Terminology' activity.
...
- **THEN** The 'Retire Deprecated Terminology' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
