# Report Reference Data Usage

## Purpose

changes can be assessed before implementation

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ReferenceData-18`
- **Source Scope:** Scope - Data Quality and Compliance
- **Primary Actor:** Data Governance Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Understand where reference data sets are used so that changes can be assessed before implementation.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Report Reference Data Usage
Harmonia SHALL support **Report Reference Data Usage** so that changes can be assessed before implementation.

#### Scenario: Report Reference Data Usage - successful outcome
...
- **WHEN** The actor needs to perform the 'Report Reference Data Usage' activity, or an authorised business process initiates the activity.
- **THEN** Data Governance Officer initiates the 'Report Reference Data Usage' activity.
...
- **THEN** The 'Report Reference Data Usage' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
