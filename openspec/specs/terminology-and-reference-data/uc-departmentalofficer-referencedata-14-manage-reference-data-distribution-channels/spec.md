# Manage Reference Data Distribution Channels

## Purpose

systems receive data through approved channels

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ReferenceData-14`
- **Source Scope:** Scope - Publication and Distribution
- **Primary Actor:** Data Steward (Integration)
- **Supporting Actors:** Provider Directory
- **User Story:** Manage how reference data is distributed so that systems receive data through approved channels.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Reference Data Distribution Channels
Harmonia SHALL support **Manage Reference Data Distribution Channels** so that systems receive data through approved channels.

#### Scenario: Manage Reference Data Distribution Channels - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Reference Data Distribution Channels' activity, or an authorised business process initiates the activity.
- **THEN** Data Steward (Integration) initiates the 'Manage Reference Data Distribution Channels' activity.
- **THEN** The solution presents the information and/or controls required to perform the activity described by the user story.
- **THEN** Data Steward (Integration) enters, selects, reviews or confirms the relevant information.
...
- **THEN** The 'Manage Reference Data Distribution Channels' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
...
- **GIVEN** the primary actor is Data Steward (Integration)
