...
specialised requirements can be supported

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Terminology-7`
...
- **User Story:** Manage approved local terminology extensions so that specialised requirements can be supported.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Local Extensions
Harmonia SHALL support **Manage Local Extensions** so that specialised requirements can be supported.

#### Scenario: Manage Local Extensions - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Local Extensions' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator initiates the 'Manage Local Extensions' activity.
...
- **THEN** The 'Manage Local Extensions' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
