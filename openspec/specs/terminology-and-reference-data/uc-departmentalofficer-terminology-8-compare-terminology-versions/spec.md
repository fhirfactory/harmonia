# Compare Terminology Versions

## Purpose

impacts of updates can be understood

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Terminology-8`
...
- **User Story:** Compare terminology versions so that impacts of updates can be understood.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Compare Terminology Versions
Harmonia SHALL support **Compare Terminology Versions** so that impacts of updates can be understood.

#### Scenario: Compare Terminology Versions - successful outcome
...
- **WHEN** The actor needs to perform the 'Compare Terminology Versions' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator initiates the 'Compare Terminology Versions' activity.
...
- **THEN** The 'Compare Terminology Versions' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
