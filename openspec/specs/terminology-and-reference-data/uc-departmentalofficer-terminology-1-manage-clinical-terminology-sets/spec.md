# Manage Clinical Terminology Sets

## Purpose

healthcare systems use consistent clinical concepts

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Terminology-1`
...
- **User Story:** Manage clinical terminology sets so that healthcare systems use consistent clinical concepts.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Clinical Terminology Sets
Harmonia SHALL support **Manage Clinical Terminology Sets** so that healthcare systems use consistent clinical concepts.

#### Scenario: Manage Clinical Terminology Sets - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Clinical Terminology Sets' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator initiates the 'Manage Clinical Terminology Sets' activity.
...
- **THEN** The 'Manage Clinical Terminology Sets' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
