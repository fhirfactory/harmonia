# Manage Procedure Classifications

## Purpose

procedures can be accurately categorised

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-Classification-3`
...
- **User Story:** Manage procedure classification values so that procedures can be accurately categorised.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Manage Procedure Classifications
Harmonia SHALL support **Manage Procedure Classifications** so that procedures can be accurately categorised.

#### Scenario: Manage Procedure Classifications - successful outcome
...
- **WHEN** The actor needs to perform the 'Manage Procedure Classifications' activity, or an authorised business process initiates the activity.
- **THEN** Reference Data / Terminology Administrator (Clinical Coding) initiates the 'Manage Procedure Classifications' activity.
...
- **THEN** The 'Manage Procedure Classifications' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
