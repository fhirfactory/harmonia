# Review Reference Data Changes

## Purpose

impacts are understood before approval

## Source Traceability

- **Source Use Case:** `UC-DepartmentalOfficer-ReferenceData-7`
- **Source Scope:** Scope - Governance and Approval
- **Primary Actor:** Data Governance Officer
- **Supporting Actors:** Provider Directory
- **User Story:** Review proposed reference data changes so that impacts are understood before approval.
- **Related Use Cases:** None identified.

## Requirements

### Requirement: Review Reference Data Changes
Harmonia SHALL support **Review Reference Data Changes** so that impacts are understood before approval.

#### Scenario: Review Reference Data Changes - successful outcome
...
- **WHEN** The actor needs to perform the 'Review Reference Data Changes' activity, or an authorised business process initiates the activity.
- **THEN** Data Governance Officer initiates the 'Review Reference Data Changes' activity.
...
- **THEN** The 'Review Reference Data Changes' activity is completed successfully, or a clear validation, approval, exception or escalation outcome is recorded.
