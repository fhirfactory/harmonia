...
/**
 * Exception thrown when a Matrix Client-Server REST call returns an error or fails.
 */
public class MatrixRestException extends RuntimeException {

    private final int httpStatus;
    private final String errcode;
    private final String error;

    public MatrixRestException(String message) {
        super(message);
        this.httpStatus = 0;
        this.errcode = null;
        this.error = null;
    ...
    public MatrixRestException(String message, Throwable cause) {
        super(message, cause);
        this.httpStatus = 0;
        this.errcode = null;
        this.error = null;
    ...
    private static String formatMessage(int httpStatus, String errcode, String error, String message) {
        ...
        sb.append("Matrix Client-Server API error [HTTP ").append(httpStatus).append("]");
