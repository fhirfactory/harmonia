...
package net.fhirfactory.harmonia.paradeigma.emr.config;
...
@Configuration
@ConfigurationProperties(prefix = "paradeigma.emr")
public class EmrConfig {

    private int inboundAdtPort = 2201; // PD-05 EMR-ADT-OUT (inbound listener for EMR)
    private String harmoniaHost = "localhost";
    private int harmoniaOrmPort = 2104; // PD-04 EMR-ORM-IN (outbound target)

    private boolean timerEnabled = false;
    private String timerMode = "FIXED"; // FIXED or RANDOM_RANGE
    private long fixedIntervalMs = 7000L;
    private long minIntervalMs = 3000L;
    ...
    public int getHarmoniaOrmPort() {
        return harmoniaOrmPort;
    }

    public void setHarmoniaOrmPort(int harmoniaOrmPort) {
        this.harmoniaOrmPort = harmoniaOrmPort;
    }
