...
public class AuditEventResource {
    ...
    public Response search(
        ...
        Bundle bundle = cacheService.searchAsBundle("AuditEvent", id, name, identifier);
    ...
    public Response read(@PathParam("id") String id) {
        String json = cacheService.getResourceJson("AuditEvent", id);
        if (json == null) {
            return Response.status(Response.Status.NOT_FOUND)
                    .entity("{\"resourceType\":\"OperationOutcome\",\"issue\":[{\"severity\":\"error\",\"code\":\"not-found\",\"diagnostics\":\"AuditEvent/" + id + " not found\"}]}")
                    .build();
        }
        return Response.ok(json).build();
    }
    ...
    public Response create(String payload) {
        ...
        AuditEvent resource = parser.parseResource(AuditEvent.class, payload);
        AuditEvent saved = cacheService.saveResource(resource);
        String json = parser.encodeResourceToString(saved);
        return Response.created(URI.create("/api/fhir/AuditEvent/" + saved.getIdElement().getIdPart()))
                .entity(json)
                .build();
    }
    ...
    public Response delete(@PathParam("id") String id) {
        boolean deleted = cacheService.deleteResource("AuditEvent", id);
        if (deleted) {
