...
public class ProvenanceResource {
    ...
    public Response search(
        ...
        Bundle bundle = cacheService.searchAsBundle("Provenance", id, name, identifier);
    ...
    public Response read(@PathParam("id") String id) {
        String json = cacheService.getResourceJson("Provenance", id);
        if (json == null) {
            return Response.status(Response.Status.NOT_FOUND)
                    .entity("{\"resourceType\":\"OperationOutcome\",\"issue\":[{\"severity\":\"error\",\"code\":\"not-found\",\"diagnostics\":\"Provenance/" + id + " not found\"}]}")
                    .build();
        }
        return Response.ok(json).build();
    }
    ...
    public Response create(String payload) {
        ...
        Provenance resource = parser.parseResource(Provenance.class, payload);
        Provenance saved = cacheService.saveResource(resource);
        String json = parser.encodeResourceToString(saved);
        return Response.created(URI.create("/api/fhir/Provenance/" + saved.getIdElement().getIdPart()))
                .entity(json)
                .build();
    }
    ...
    public Response delete(@PathParam("id") String id) {
        boolean deleted = cacheService.deleteResource("Provenance", id);
        if (deleted) {
